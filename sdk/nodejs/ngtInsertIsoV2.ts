...
export class NgtInsertIsoV2 extends pulumi.CustomResource {
     ...
     */
    public readonly isConfigOnly!: pulumi.Output<boolean>;
    /**
    ...
    constructor(name: string, argsOrState?: NgtInsertIsoV2Args | NgtInsertIsoV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["isConfigOnly"] = state ? state.isConfigOnly : undefined;
            ...
            resourceInputs["isConfigOnly"] = args ? args.isConfigOnly : undefined;
