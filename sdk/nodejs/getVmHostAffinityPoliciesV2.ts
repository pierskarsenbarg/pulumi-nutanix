 ...
 * ```
 */
export function getVmHostAffinityPoliciesV2(args?: GetVmHostAffinityPoliciesV2Args, opts?: pulumi.InvokeOptions): Promise<GetVmHostAffinityPoliciesV2Result> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("nutanix:index/getVmHostAffinityPoliciesV2:getVmHostAffinityPoliciesV2", {
        "filter": args.filter,
        "limit": args.limit,
 ...
 */
export interface GetVmHostAffinityPoliciesV2Args {
    /**
 ...
 */
export interface GetVmHostAffinityPoliciesV2Result {
     ...
     */
    readonly policies: outputs.GetVmHostAffinityPoliciesV2Policy[];
}
/**
 * List VM-Host Affinity policies details with support for pagination, filtering, and sorting.
 *
 ...
 * ```
 */
export function getVmHostAffinityPoliciesV2Output(args?: GetVmHostAffinityPoliciesV2OutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVmHostAffinityPoliciesV2Result> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("nutanix:index/getVmHostAffinityPoliciesV2:getVmHostAffinityPoliciesV2", {
        "filter": args.filter,
        "limit": args.limit,
        "orderBy": args.orderBy,
        "page": args.page,
 ...
 * A collection of arguments for invoking getVmHostAffinityPoliciesV2.
 */
export interface GetVmHostAffinityPoliciesV2OutputArgs {
    /**
     * A URL query parameter that allows clients to filter a collection of resources. The expression specified with $filter is evaluated for each resource in the collection, and only items where the expression evaluates to true are included in the response. Expression specified with the $filter must conform to the OData V4.01 URL conventions. For example, `$filter=name eq 'my-policy'` would filter the result on policy name 'my-policy', `$filter=startswith(name, 'prod-')` would filter on policy names starting with 'prod-'. The filter can be applied to the following fields:
     */
