...
def get_vpc_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: vpc UUID
    """
    __args__ = dict()
...
def get_vpc_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
