...
class VpcArgs:
    def __init__(__self__, *,
                 ...
                 external_subnet_reference_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 external_subnet_reference_uuids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_subnet_reference_names: List of external subnets name attached to this VPC. Should not be used with external_subnet_reference_uuid.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_subnet_reference_uuids: List of external subnets uuid attached to this VPC. Should not be used with external_subnet_reference_name.
        ...
        :param pulumi.Input[builtins.str] name: The name for the VPC.
        """
    ...
    def external_subnet_reference_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def external_subnet_reference_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "external_subnet_reference_names", value)

    @property
    @pulumi.getter(name="externalSubnetReferenceUuids")
    def external_subnet_reference_uuids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def external_subnet_reference_uuids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _VpcState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_subnet_reference_uuids: List of external subnets uuid attached to this VPC. Should not be used with external_subnet_reference_name.
        :param pulumi.Input[Sequence[pulumi.Input['VpcExternallyRoutablePrefixListArgs']]] externally_routable_prefix_lists: List Externally Routable IP Addresses. Required when external subnet with NoNAT is used.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The vpc kind metadata.
        :param pulumi.Input[builtins.str] name: The name for the VPC.
        """
        if api_version is not None:
            pulumi.set(__self__, "api_version", api_version)
...
class Vpc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            externally_routable_prefix_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpcExternallyRoutablePrefixListArgs', 'VpcExternallyRoutablePrefixListArgsDict']]]]] = None,
            metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Vpc':
        """
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceNames")
    def external_subnet_reference_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of external subnets name attached to this VPC. Should not be used with external_subnet_reference_uuid.
        """
        return pulumi.get(self, "external_subnet_reference_names")
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceUuids")
    def external_subnet_reference_uuids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of external subnets uuid attached to this VPC. Should not be used with external_subnet_reference_name.
        """
        return pulumi.get(self, "external_subnet_reference_uuids")
