...
class KarbonClusterArgs:
    def __init__(__self__, *,
                 ...
                 wait_timeout_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] version: - (Required) K8s version of the cluster. **Note:** Updates to this attribute forces new resource creation.
        ...
        :param pulumi.Input[builtins.str] name: - (Required) The name for the k8s cluster. **Note:** Updates to this attribute forces new resource creation.
        ...
        :param pulumi.Input[builtins.int] wait_timeout_minutes: - (Optional) Maximum wait time for the Karbon cluster to provision.
        """
    ...
    def wait_timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def wait_timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _KarbonClusterState:
    def __init__(__self__, *,
                 ...
                 external_lb_config: Optional[pulumi.Input['KarbonClusterExternalLbConfigArgs']] = None,
                 kubeapi_server_ipv4_address: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def kubeapi_server_ipv4_address(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "kubeapi_server_ipv4_address")

    @kubeapi_server_ipv4_address.setter
    def kubeapi_server_ipv4_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KarbonCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="kubeapiServerIpv4Address")
    def kubeapi_server_ipv4_address(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "kubeapi_server_ipv4_address")
    ...
    @pulumi.getter(name="waitTimeoutMinutes")
    @_utilities.deprecated("""use timeouts instead""")
    def wait_timeout_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        - (Optional) Maximum wait time for the Karbon cluster to provision.
        """
        return pulumi.get(self, "wait_timeout_minutes")
