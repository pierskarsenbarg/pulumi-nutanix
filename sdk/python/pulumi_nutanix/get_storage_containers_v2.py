...
def get_storage_containers_v2(apply: Optional[builtins.str] = None,
...
def get_storage_containers_v2_output(apply: Optional[pulumi.Input[Optional[builtins.str]]] = None,
