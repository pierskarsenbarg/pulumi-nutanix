...
class GetPcV2Result:
    ...
    def hosting_cluster_ext_id(self) -> builtins.str:
        """
    ...
    def is_registered_with_hosting_cluster(self) -> builtins.bool:
        """
    ...
    def node_ext_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def should_enable_high_availability(self) -> Optional[builtins.bool]:
        """
...
def get_pc_v2(ext_id: Optional[builtins.str] = None,
              should_enable_high_availability: Optional[builtins.bool] = None,
    ...
    :param builtins.str ext_id: -(Required) The external identifier of the domain manager (Prism Central) entity.
    :param builtins.bool should_enable_high_availability: - This configuration enables Prism Central to be deployed in scale-out mode.
    """
    __args__ = dict()
...
def get_pc_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
                     should_enable_high_availability: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
