...
class _NdbProfileState:
    ...
    def assoc_databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def assoc_db_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def latest_version_id(self, value: Optional[pulumi.Input[str]]):
