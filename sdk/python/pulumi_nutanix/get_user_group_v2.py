...
def get_user_group_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: - (Required) The External Identifier of the User Group.
    """
    __args__ = dict()
...
def get_user_group_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
