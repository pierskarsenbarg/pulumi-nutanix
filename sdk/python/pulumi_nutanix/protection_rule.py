...
class ProtectionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: A description for protection rule.
        :param pulumi.Input[builtins.str] name: The name for the protection rule.
        """
...
class ProtectionRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_reference: Optional[pulumi.Input[Union['ProtectionRuleProjectReferenceArgs', 'ProtectionRuleProjectReferenceArgsDict']]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'ProtectionRule':
        """
