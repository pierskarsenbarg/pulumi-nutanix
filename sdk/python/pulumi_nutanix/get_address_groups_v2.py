...
__all__ = [
    'GetAddressGroupsV2Result',
    'AwaitableGetAddressGroupsV2Result',
    'get_address_groups_v2',
    'get_address_groups_v2_output',
]

@pulumi.output_type
class GetAddressGroupsV2Result:
    """
    A collection of values returned by getAddressGroupsV2.
    """
    def __init__(__self__, address_groups=None, filter=None, id=None, limit=None, order_by=None, page=None, select=None):
...
class AwaitableGetAddressGroupsV2Result(GetAddressGroupsV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAddressGroupsV2Result(
...
def get_address_groups_v2(filter: Optional[builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAddressGroupsV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getAddressGroupsV2:getAddressGroupsV2', __args__, opts=opts, typ=GetAddressGroupsV2Result).value

    return AwaitableGetAddressGroupsV2Result(
...
def get_address_groups_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getAddressGroupsV2:getAddressGroupsV2', __args__, opts=opts, typ=GetAddressGroupsV2Result)
    return __ret__.apply(lambda __response__: GetAddressGroupsV2Result(
