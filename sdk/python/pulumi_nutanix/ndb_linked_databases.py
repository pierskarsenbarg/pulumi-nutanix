...
class _NdbLinkedDatabasesState:
    def __init__(__self__, *,
                 ...
                 parent_linked_database_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def parent_linked_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "parent_linked_database_id")

    @parent_linked_database_id.setter
    def parent_linked_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NdbLinkedDatabases(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None) -> 'NdbLinkedDatabases':
        """
    ...
    @property
    @pulumi.getter(name="parentLinkedDatabaseId")
    def parent_linked_database_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "parent_linked_database_id")
