...
class GetLcmStatusV2Result:
    ...
    def is_cancel_intent_set(self) -> builtins.bool:
        """
    ...
    def upload_task_uuid(self) -> builtins.str:
        """
        Upload task UUID.
        """
...
def get_lcm_status_v2(x_cluster_id: Optional[builtins.str] = None,
...
def get_lcm_status_v2_output(x_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
