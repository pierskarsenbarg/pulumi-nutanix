...
def get_ndb_databases(database_type: Optional[builtins.str] = None,
...
def get_ndb_databases_output(database_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
