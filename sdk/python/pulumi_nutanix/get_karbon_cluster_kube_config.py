...
def get_karbon_cluster_kube_config(karbon_cluster_id: Optional[builtins.str] = None,
...
def get_karbon_cluster_kube_config_output(karbon_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
