...
class GetNdbTmsCapabilityResult:
    ...
    def capability_reset_time(self) -> builtins.str:
    ...
    def heal_with_reset_capability(self) -> builtins.bool:
    ...
    def last_continuous_snapshot_time(self) -> builtins.str:
    ...
    def output_time_zone(self) -> builtins.str:
        return pulumi.get(self, "output_time_zone")

    @property
    @pulumi.getter(name="overallContinuousRangeEndTime")
    def overall_continuous_range_end_time(self) -> builtins.str:
...
def get_ndb_tms_capability(time_machine_id: Optional[builtins.str] = None,
...
def get_ndb_tms_capability_output(time_machine_id: Optional[pulumi.Input[builtins.str]] = None,
