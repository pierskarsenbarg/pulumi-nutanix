...
class FloatingIpV2Args:
    def __init__(__self__, *,
                 ...
                 external_subnet_reference: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 load_balancer_session_reference: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 vm_nic_reference: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Description for the Floating IP.
        :param pulumi.Input[builtins.str] external_subnet_reference: External subnet reference for the Floating IP to be allocated in on-prem only.
        ...
        :param pulumi.Input[builtins.str] vm_nic_reference: VM NIC reference.
        :param pulumi.Input[Sequence[pulumi.Input['FloatingIpV2VmNicArgs']]] vm_nics: Virtual NIC for projections
        :param pulumi.Input[builtins.str] vpc_reference: VPC reference UUID
    ...
    def external_subnet_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_subnet_reference(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def load_balancer_session_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "load_balancer_session_reference")

    @load_balancer_session_reference.setter
    def load_balancer_session_reference(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vm_nic_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        VM NIC reference.
        """
    ...
    def vm_nic_reference(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FloatingIpV2State:
    def __init__(__self__, *,
                 ...
                 external_subnet_reference: Optional[pulumi.Input[builtins.str]] = None,
                 external_subnets: Optional[pulumi.Input[Sequence[pulumi.Input['FloatingIpV2ExternalSubnetArgs']]]] = None,
                 floating_ip_value: Optional[pulumi.Input[builtins.str]] = None,
                 floating_ips: Optional[pulumi.Input[Sequence[pulumi.Input['FloatingIpV2FloatingIpArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] association_status: Association status of floating IP.
        :param pulumi.Input[Sequence[pulumi.Input['FloatingIpV2AssociationArgs']]] associations: Association of the Floating IP with either NIC or Private IP
        :param pulumi.Input[builtins.str] description: Description for the Floating IP.
        :param pulumi.Input[builtins.str] external_subnet_reference: External subnet reference for the Floating IP to be allocated in on-prem only.
        :param pulumi.Input[Sequence[pulumi.Input['FloatingIpV2ExternalSubnetArgs']]] external_subnets: Networking common base object
    ...
    def floating_ip_value(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "floating_ip_value")

    @floating_ip_value.setter
    def floating_ip_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FloatingIpV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="externalSubnetReference")
    def external_subnet_reference(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        External subnet reference for the Floating IP to be allocated in on-prem only.
        """
        return pulumi.get(self, "external_subnet_reference")
    ...
    @property
    @pulumi.getter(name="floatingIpValue")
    def floating_ip_value(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "floating_ip_value")
    ...
    @property
    @pulumi.getter(name="loadBalancerSessionReference")
    def load_balancer_session_reference(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "load_balancer_session_reference")
    ...
    @property
    @pulumi.getter(name="vmNicReference")
    def vm_nic_reference(self) -> pulumi.Output[builtins.str]:
        """
        VM NIC reference.
        """
        return pulumi.get(self, "vm_nic_reference")
