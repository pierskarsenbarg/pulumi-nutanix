...
def get_pc_backup_targets_v2(domain_manager_ext_id: Optional[builtins.str] = None,
...
def get_pc_backup_targets_v2_output(domain_manager_ext_id: Optional[pulumi.Input[builtins.str]] = None,
