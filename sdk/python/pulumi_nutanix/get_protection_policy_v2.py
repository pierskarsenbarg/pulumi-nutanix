...
class GetProtectionPolicyV2Result:
    ...
    def category_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def is_approval_policy_needed(self) -> builtins.bool:
        """
...
def get_protection_policy_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: -(Required) The external identifier of the protection policy.
    """
    __args__ = dict()
...
def get_protection_policy_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
