...
class PcRestoreV2Args:
    def __init__(__self__, *,
                 ...
                 restorable_domain_manager_ext_id: pulumi.Input[builtins.str],
                 restore_source_ext_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] ext_id: -(Required) Restore point ID for the backup created in cluster/object store.
        :param pulumi.Input[builtins.str] restorable_domain_manager_ext_id: -(Required) A unique identifier for the domain manager.
        :param pulumi.Input[builtins.str] restore_source_ext_id: -(Required) A unique identifier obtained from the restore source API that corresponds to the details provided for the restore source.
        """
    ...
    def restorable_domain_manager_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def restorable_domain_manager_ext_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "restorable_domain_manager_ext_id", value)

    @property
    @pulumi.getter(name="restoreSourceExtId")
    def restore_source_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def restore_source_ext_id(self, value: pulumi.Input[builtins.str]):
...
class _PcRestoreV2State:
    def __init__(__self__, *,
                 ...
                 restorable_domain_manager_ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 restore_source_ext_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="restorableDomainManagerExtId")
    def restorable_domain_manager_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) A unique identifier for the domain manager.
        """
        return pulumi.get(self, "restorable_domain_manager_ext_id")
    ...
    @restorable_domain_manager_ext_id.setter
    def restorable_domain_manager_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restorable_domain_manager_ext_id", value)

    @property
    @pulumi.getter(name="restoreSourceExtId")
    def restore_source_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) A unique identifier obtained from the restore source API that corresponds to the details provided for the restore source.
        """
        return pulumi.get(self, "restore_source_ext_id")
    ...
    @restore_source_ext_id.setter
    def restore_source_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_source_ext_id", value)
...
class PcRestoreV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ext_id: Optional[pulumi.Input[builtins.str]] = None,
            restorable_domain_manager_ext_id: Optional[pulumi.Input[builtins.str]] = None,
            restore_source_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PcRestoreV2':
        """
    ...
    @property
    @pulumi.getter(name="restorableDomainManagerExtId")
    def restorable_domain_manager_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) A unique identifier for the domain manager.
        """
        return pulumi.get(self, "restorable_domain_manager_ext_id")
    ...
    @property
    @pulumi.getter(name="restoreSourceExtId")
    def restore_source_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) A unique identifier obtained from the restore source API that corresponds to the details provided for the restore source.
        """
        return pulumi.get(self, "restore_source_ext_id")
