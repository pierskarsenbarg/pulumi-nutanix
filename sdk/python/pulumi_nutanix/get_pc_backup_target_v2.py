...
class GetPcBackupTargetV2Result:
    ...
    def backup_pause_reason(self) -> builtins.str:
        """
    ...
    def domain_manager_ext_id(self) -> builtins.str:
    ...
    def is_backup_paused(self) -> builtins.bool:
        """
...
def get_pc_backup_target_v2(domain_manager_ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_manager_ext_id: -(Required) A unique identifier for the domain manager.
    :param builtins.str ext_id: -(Required) A globally unique identifier of an instance that is suitable for external consumption.
    """
    __args__ = dict()
...
def get_pc_backup_target_v2_output(domain_manager_ext_id: Optional[pulumi.Input[builtins.str]] = None,
