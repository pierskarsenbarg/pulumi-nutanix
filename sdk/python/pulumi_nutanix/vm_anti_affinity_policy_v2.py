...
class VmAntiAffinityPolicyV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] categories: List of VM category external IDs (`ext_id`) that this policy applies to. VMs with these categories will be spread across different hosts according to the anti-affinity rules.
    ...
    def categories(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        List of VM category external IDs (`ext_id`) that this policy applies to. VMs with these categories will be spread across different hosts according to the anti-affinity rules.
        """
