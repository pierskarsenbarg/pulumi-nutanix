...
class NdbMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 week_of_month: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a NdbMaintenanceWindow resource.
        :param pulumi.Input[builtins.str] recurrence: Supported values [ MONTHLY, WEEKLY ]
        :param pulumi.Input[builtins.str] start_time: start time for maintenance window to trigger
        :param pulumi.Input[builtins.str] day_of_week: Day of the week to trigger maintenance window. Supports [ MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY ]
        :param pulumi.Input[builtins.str] description: Description for maintenance window
        :param pulumi.Input[builtins.int] duration: duration in hours. Default is 2
        :param pulumi.Input[builtins.str] name: Name for the maintenance window.
        :param pulumi.Input[Sequence[pulumi.Input['NdbMaintenanceWindowTagArgs']]] tags: tags of maintenance window
        :param pulumi.Input[builtins.str] timezone: timezone . Default is Asia/Calcutta .
        :param pulumi.Input[builtins.int] week_of_month: week of the month. Supports [1, 2, 3, 4] .
        """
    ...
    def week_of_month(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def week_of_month(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _NdbMaintenanceWindowState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 next_run_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_level: access level
        :param pulumi.Input[builtins.str] date_created: created date of maintenance window
        :param pulumi.Input[builtins.str] date_modified: modified date of maintenance window
        :param pulumi.Input[builtins.str] day_of_week: Day of the week to trigger maintenance window. Supports [ MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY ]
        :param pulumi.Input[builtins.str] description: Description for maintenance window
        :param pulumi.Input[builtins.int] duration: duration in hours. Default is 2
        ...
        :param pulumi.Input[builtins.str] name: Name for the maintenance window.
        :param pulumi.Input[builtins.str] next_run_time: next run time for maintenance window to trigger
        :param pulumi.Input[builtins.str] owner_id: owner id of maintenance window
        ...
        :param pulumi.Input[builtins.str] start_time: start time for maintenance window to trigger
        :param pulumi.Input[builtins.str] status: status of maintennace window
        :param pulumi.Input[Sequence[pulumi.Input['NdbMaintenanceWindowTagArgs']]] tags: tags of maintenance window
        :param pulumi.Input[builtins.str] timezone: timezone . Default is Asia/Calcutta .
        :param pulumi.Input[builtins.int] week_of_month: week of the month. Supports [1, 2, 3, 4] .
        """
    ...
    def next_run_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def next_run_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NdbMaintenanceWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NdbMaintenanceWindowTagArgs', 'NdbMaintenanceWindowTagArgsDict']]]]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            week_of_month: Optional[pulumi.Input[builtins.int]] = None) -> 'NdbMaintenanceWindow':
        """
    ...
    @property
    @pulumi.getter(name="dayOfWeek")
    def day_of_week(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Day of the week to trigger maintenance window. Supports [ MONDAY, TUESDAY, WEDNESDAY, THURSDAY, FRIDAY, SATURDAY, SUNDAY ]
        """
        return pulumi.get(self, "day_of_week")
    ...
    @property
    @pulumi.getter(name="nextRunTime")
    def next_run_time(self) -> pulumi.Output[builtins.str]:
        """
        next run time for maintenance window to trigger
        """
        return pulumi.get(self, "next_run_time")
    ...
    @property
    @pulumi.getter(name="weekOfMonth")
    def week_of_month(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        week of the month. Supports [1, 2, 3, 4] .
        """
        return pulumi.get(self, "week_of_month")
