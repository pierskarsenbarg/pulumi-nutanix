...
class GetNdbDbserverResult:
    ...
    def associated_time_machine_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def dbserver_cluster_id(self) -> builtins.str:
        return pulumi.get(self, "dbserver_cluster_id")

    @property
    @pulumi.getter(name="dbserverInvalidEaState")
    def dbserver_invalid_ea_state(self) -> builtins.bool:
        """
    ...
    def era_drive_id(self) -> builtins.str:
        """
        era drive id
        """
    ...
    def era_version(self) -> builtins.str:
        """
        era version
        """
    ...
    def is_server_driven(self) -> builtins.bool:
        """
    ...
    def mac_addresses(self) -> Sequence[builtins.str]:
        """
    ...
    def nx_cluster_id(self) -> Optional[builtins.str]:
    ...
    def protection_domain_id(self) -> builtins.str:
        """
    ...
    def query_count(self) -> builtins.int:
        """
        query count
        """
    ...
    def valid_diagnostic_bundle_state(self) -> builtins.bool:
        """
    ...
    def vm_cluster_name(self) -> builtins.str:
        return pulumi.get(self, "vm_cluster_name")

    @property
    @pulumi.getter(name="vmClusterUuid")
    def vm_cluster_uuid(self) -> builtins.str:
        """
    ...
    def vm_timezone(self) -> builtins.str:
        """
    ...
    def windows_db_server(self) -> builtins.bool:
        """
        window db server
        """
...
def get_ndb_dbserver(dbserver_cluster_id: Optional[builtins.str] = None,
                     id: Optional[builtins.str] = None,
                     ip: Optional[builtins.str] = None,
                     name: Optional[builtins.str] = None,
                     nx_cluster_id: Optional[builtins.str] = None,
                     ...
                     vm_cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str id: id of database server vm
    :param builtins.str ip: ip of database server vm
    :param builtins.str name: name of database server vm
    :param Sequence[Union['GetNdbDbserverTagArgs', 'GetNdbDbserverTagArgsDict']] tags: tags for db server vm
    :param builtins.str vm_cluster_id: vm cluster id of database server
    :param builtins.str vm_cluster_name: vm cluster name of database server
    """
    __args__ = dict()
...
def get_ndb_dbserver_output(dbserver_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            nx_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            vm_cluster_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
