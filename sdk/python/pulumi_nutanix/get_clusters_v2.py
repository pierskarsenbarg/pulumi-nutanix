...
__all__ = [
    'GetClustersV2Result',
    'AwaitableGetClustersV2Result',
    'get_clusters_v2',
    'get_clusters_v2_output',
]

@pulumi.output_type
class GetClustersV2Result:
    """
    A collection of values returned by getClustersV2.
    """
    def __init__(__self__, apply=None, cluster_entities=None, expand=None, filter=None, id=None, limit=None, order_by=None, page=None, select=None):
        if apply and not isinstance(apply, str):
            raise TypeError("Expected argument 'apply' to be a str")
        pulumi.set(__self__, "apply", apply)
        if cluster_entities and not isinstance(cluster_entities, list):
            raise TypeError("Expected argument 'cluster_entities' to be a list")
        pulumi.set(__self__, "cluster_entities", cluster_entities)
    ...
    @property
    @pulumi.getter
    def apply(self) -> Optional[builtins.str]:
...
class AwaitableGetClustersV2Result(GetClustersV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClustersV2Result(
            apply=self.apply,
            cluster_entities=self.cluster_entities,
            expand=self.expand,
            filter=self.filter,
            id=self.id,
            limit=self.limit,
...
def get_clusters_v2(apply: Optional[builtins.str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClustersV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getClustersV2:getClustersV2', __args__, opts=opts, typ=GetClustersV2Result).value

    return AwaitableGetClustersV2Result(
        apply=pulumi.get(__ret__, 'apply'),
        cluster_entities=pulumi.get(__ret__, 'cluster_entities'),
...
def get_clusters_v2_output(apply: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getClustersV2:getClustersV2', __args__, opts=opts, typ=GetClustersV2Result)
    return __ret__.apply(lambda __response__: GetClustersV2Result(
        apply=pulumi.get(__response__, 'apply'),
        cluster_entities=pulumi.get(__response__, 'cluster_entities'),
