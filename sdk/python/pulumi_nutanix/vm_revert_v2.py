...
class VmRevertV2Args:
    def __init__(__self__, *,
                 ...
                 vm_recovery_point_ext_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a VmRevertV2 resource.
        :param pulumi.Input[builtins.str] ext_id: -(Required) The globally unique identifier of a VM. It should be of type UUID.
        :param pulumi.Input[builtins.str] vm_recovery_point_ext_id: -(Required) The external identifier of the VM Recovery Point.
        """
    ...
    def vm_recovery_point_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vm_recovery_point_ext_id(self, value: pulumi.Input[builtins.str]):
...
class _VmRevertV2State:
    def __init__(__self__, *,
                 ...
                 vm_recovery_point_ext_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering VmRevertV2 resources.
        :param pulumi.Input[builtins.str] ext_id: -(Required) The globally unique identifier of a VM. It should be of type UUID.
        :param pulumi.Input[builtins.str] status: - The status of the Revert operation.
        :param pulumi.Input[builtins.str] vm_recovery_point_ext_id: -(Required) The external identifier of the VM Recovery Point.
        """
    ...
    @property
    @pulumi.getter(name="vmRecoveryPointExtId")
    def vm_recovery_point_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) The external identifier of the VM Recovery Point.
        """
        return pulumi.get(self, "vm_recovery_point_ext_id")
    ...
    @vm_recovery_point_ext_id.setter
    def vm_recovery_point_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vm_recovery_point_ext_id", value)
...
class VmRevertV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ext_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            vm_recovery_point_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VmRevertV2':
        """
    ...
    @property
    @pulumi.getter(name="vmRecoveryPointExtId")
    def vm_recovery_point_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) The external identifier of the VM Recovery Point.
        """
        return pulumi.get(self, "vm_recovery_point_ext_id")
