...
class SelfServiceAppProvisionArgs:
    def __init__(__self__, *,
                 ...
                 bp_name: Optional[pulumi.Input[builtins.str]] = None,
                 bp_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 runtime_editables: Optional[pulumi.Input[Sequence[pulumi.Input['SelfServiceAppProvisionRuntimeEditableArgs']]]] = None,
                 soft_delete: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SelfServiceAppProvision resource.
        :param pulumi.Input[builtins.str] app_name: - (Required) The name of the application you want to set.
        :param pulumi.Input[builtins.str] action: - (Optional) System action to trigger after provisioning. Valid values: ["start", "stop", "restart"]
        :param pulumi.Input[builtins.str] app_description: - (Optional) The description of application.
               
               Both are `bp_name` and `bp_uuid` are optional but atleast one of them to be provided for this resource to work.
        :param pulumi.Input[builtins.str] bp_name: - (Optional) The name of the blueprint to launch.
        :param pulumi.Input[builtins.str] bp_uuid: - (Optional) The UUID of the blueprint to launch.
        :param pulumi.Input[builtins.bool] soft_delete: - (Optional, Default: false) If true, the application is soft-deleted when the resource is destroyed.
        """
    ...
    def bp_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bp_name.setter
    def bp_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bp_name", value)

    @property
    @pulumi.getter(name="bpUuid")
    def bp_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bp_uuid.setter
    def bp_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def soft_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @soft_delete.setter
    def soft_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SelfServiceAppProvisionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: - (Optional) System action to trigger after provisioning. Valid values: ["start", "stop", "restart"]
        :param pulumi.Input[builtins.str] api_version: - (Computed) API version used.
        :param pulumi.Input[builtins.str] app_description: - (Optional) The description of application.
        ...
        :param pulumi.Input[builtins.str] bp_uuid: - (Optional) The UUID of the blueprint to launch.
        :param pulumi.Input[builtins.bool] soft_delete: - (Optional, Default: false) If true, the application is soft-deleted when the resource is destroyed.
        :param pulumi.Input[builtins.str] spec: - (Computed) Application specification (JSON string).
        :param pulumi.Input[builtins.str] state: - (Computed) state of the application (e.g. running, stopped)
        :param pulumi.Input[builtins.str] status: - (Computed) Application status coming as response from server.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
...
class SelfServiceAppProvision(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bpName")
    def bp_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        - (Optional) The name of the blueprint to launch.
        """
        return pulumi.get(self, "bp_name")
    ...
    @property
    @pulumi.getter(name="bpUuid")
    def bp_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        - (Optional) The UUID of the blueprint to launch.
        """
        return pulumi.get(self, "bp_uuid")
    ...
    @property
    @pulumi.getter(name="softDelete")
    def soft_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional, Default: false) If true, the application is soft-deleted when the resource is destroyed.
        """
        return pulumi.get(self, "soft_delete")
