...
class KarbonWorkerNodepoolArgs:
    def __init__(__self__, *,
                 ...
                 node_os_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a KarbonWorkerNodepool resource.
        :param pulumi.Input[builtins.str] cluster_name: Kubernetes cluster name
        :param pulumi.Input[builtins.int] num_instances: number of node instances
        :param pulumi.Input['KarbonWorkerNodepoolAhvConfigArgs'] ahv_config: VM configuration in AHV.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: labels of node
        :param pulumi.Input[builtins.str] name: unique worker nodepool name
        :param pulumi.Input[builtins.str] node_os_version: The version of the node OS image
        """
    ...
    def node_os_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_os_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KarbonWorkerNodepool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            num_instances: Optional[pulumi.Input[builtins.int]] = None) -> 'KarbonWorkerNodepool':
        """
    ...
    @property
    @pulumi.getter(name="nodeOsVersion")
    def node_os_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the node OS image
        """
        return pulumi.get(self, "node_os_version")
