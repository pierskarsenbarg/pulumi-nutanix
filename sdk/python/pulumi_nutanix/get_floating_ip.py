...
class GetFloatingIpResult:
    ...
    def floating_ip_uuid(self) -> builtins.str:
...
def get_floating_ip(floating_ip_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str floating_ip_uuid: Floating IP UUID
    """
    __args__ = dict()
...
def get_floating_ip_output(floating_ip_uuid: Optional[pulumi.Input[builtins.str]] = None,
