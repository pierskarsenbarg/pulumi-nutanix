...
def get_service_group_v2(ext_id: Optional[builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetServiceGroupV2Result:
    """
    Get an service Group by ExtID


    :param builtins.str ext_id: service group UUID.
    """
    __args__ = dict()
...
def get_service_group_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
