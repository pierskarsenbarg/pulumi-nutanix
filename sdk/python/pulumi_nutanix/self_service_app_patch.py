...
class SelfServiceAppPatchArgs:
    def __init__(__self__, *,
                 app_uuid: pulumi.Input[builtins.str],
                 config_name: pulumi.Input[builtins.str],
                 patch_name: pulumi.Input[builtins.str],
                 ...
                 runlog_uuid: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_uuid: - (Required) The UUID of the application.
        :param pulumi.Input[builtins.str] config_name: - (Required) The name of the patch configuration. (<b>Same as patch_name for SINGLE VM)</b>
        :param pulumi.Input[builtins.str] patch_name: - (Required) The name of the patch to be applied. This is used to identify the action name which needs to be executed to update an application.
        :param pulumi.Input[builtins.str] runlog_uuid: - (Computed) The UUID of the runlog that records the patch operation's execution details.
        """
    ...
    def app_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @app_uuid.setter
    def app_uuid(self, value: pulumi.Input[builtins.str]):
    ...
    def patch_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @patch_name.setter
    def patch_name(self, value: pulumi.Input[builtins.str]):
    ...
    def runlog_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @runlog_uuid.setter
    def runlog_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SelfServiceAppPatch(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appUuid")
    def app_uuid(self) -> pulumi.Output[builtins.str]:
        """
        - (Required) The UUID of the application.
        """
        return pulumi.get(self, "app_uuid")
    ...
    @property
    @pulumi.getter(name="patchName")
    def patch_name(self) -> pulumi.Output[builtins.str]:
        """
        - (Required) The name of the patch to be applied. This is used to identify the action name which needs to be executed to update an application.
        """
        return pulumi.get(self, "patch_name")
    ...
    @property
    @pulumi.getter(name="runlogUuid")
    def runlog_uuid(self) -> pulumi.Output[builtins.str]:
        """
        - (Computed) The UUID of the runlog that records the patch operation's execution details.
        """
        return pulumi.get(self, "runlog_uuid")
