...
def get_ndb_tag(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: tag id. Conflicts with  name.
    :param builtins.str name: tag name. Conflicts with id.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_ndb_tag_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
