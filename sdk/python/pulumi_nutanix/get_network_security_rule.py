...
class GetNetworkSecurityRuleResult:
    ...
    def ad_rule_action(self) -> builtins.str:
        """
    ...
    def ad_rule_target_group_default_internal_policy(self) -> builtins.str:
        """
    ...
    def ad_rule_target_group_filter_kind_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def ad_rule_target_group_filter_type(self) -> builtins.str:
        """
    ...
    def ad_rule_target_group_peer_specification_type(self) -> builtins.str:
        """
    ...
    def allow_ipv6_traffic(self) -> builtins.bool:
    ...
    def app_rule_action(self) -> builtins.str:
        """
        - These rules govern what flows are allowed. Target group is a required attribute. Empty inbound_allow_list will not anything into target group. Empty outbound_allow_list will allow everything from target group.
        """
    ...
    def app_rule_target_group_default_internal_policy(self) -> builtins.str:
        """
        - Default policy for communication within target group.
        """
    ...
    def app_rule_target_group_filter_kind_lists(self) -> Sequence[builtins.str]:
        """
        - List of kinds associated with this filter.
        """
    ...
    def app_rule_target_group_filter_type(self) -> builtins.str:
        """
        - The type of the filter being used.
        """
    ...
    def app_rule_target_group_peer_specification_type(self) -> builtins.str:
        """
        - Way to identify the object for which rule is applied.
        """
    ...
    def is_policy_hitlog_enabled(self) -> builtins.bool:
        return pulumi.get(self, "is_policy_hitlog_enabled")

    @property
    @pulumi.getter(name="isolationRuleAction")
    def isolation_rule_action(self) -> builtins.str:
        """
    ...
    def isolation_rule_first_entity_filter_kind_lists(self) -> Sequence[builtins.str]:
        """
        - List of kinds associated with this filter.
        """
    ...
    def isolation_rule_first_entity_filter_type(self) -> builtins.str:
        """
        - The type of the filter being used.
        """
    ...
    def isolation_rule_second_entity_filter_kind_lists(self) -> Sequence[builtins.str]:
        """
        - List of kinds associated with this filter.
        """
    ...
    def isolation_rule_second_entity_filter_type(self) -> builtins.str:
        """
        - The type of the filter being used.
        """
    ...
    def network_security_rule_id(self) -> builtins.str:
        """
    ...
    def quarantine_rule_action(self) -> builtins.str:
        """
    ...
    def quarantine_rule_target_group_default_internal_policy(self) -> builtins.str:
        """
        - Default policy for communication within target group.
        """
    ...
    def quarantine_rule_target_group_filter_kind_lists(self) -> Sequence[builtins.str]:
        """
        - List of kinds associated with this filter.
        """
    ...
    def quarantine_rule_target_group_filter_type(self) -> builtins.str:
        """
        - The type of the filter being used.
        """
    ...
    def quarantine_rule_target_group_peer_specification_type(self) -> builtins.str:
        """
        - Way to identify the object for which rule is applied.
        """
...
def get_network_security_rule(categories: Optional[Sequence[Union['GetNetworkSecurityRuleCategoryArgs', 'GetNetworkSecurityRuleCategoryArgsDict']]] = None,
                              network_security_rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str network_security_rule_id: Represents network security rule UUID
    """
    __args__ = dict()
...
def get_network_security_rule_output(categories: Optional[pulumi.Input[Optional[Sequence[Union['GetNetworkSecurityRuleCategoryArgs', 'GetNetworkSecurityRuleCategoryArgsDict']]]]] = None,
                                     network_security_rule_id: Optional[pulumi.Input[builtins.str]] = None,
