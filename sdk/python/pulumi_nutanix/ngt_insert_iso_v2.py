...
class NgtInsertIsoV2Args:
    def __init__(__self__, *,
                 ...
                 is_config_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] is_config_only: Indicates that the Nutanix Guest Tools are already installed on the guest VM, and the ISO is being inserted to update the configuration of these tools.
        """
    ...
    def is_config_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_config_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class NgtInsertIsoV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_vm_mobility_drivers_installed: Optional[pulumi.Input[builtins.bool]] = None,
            is_vss_snapshot_capable: Optional[pulumi.Input[builtins.bool]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'NgtInsertIsoV2':
        """
    ...
    @property
    @pulumi.getter(name="isConfigOnly")
    def is_config_only(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates that the Nutanix Guest Tools are already installed on the guest VM, and the ISO is being inserted to update the configuration of these tools.
        """
        return pulumi.get(self, "is_config_only")
