...
def get_template_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: The identifier of a Template.
    """
    __args__ = dict()
...
def get_template_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
