...
class GetNdbCloneResult:
    ...
    def clone_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "clone_id")

    @property
    @pulumi.getter(name="cloneName")
    def clone_name(self) -> Optional[builtins.str]:
    ...
    def parent_source_database_id(self) -> builtins.str:
        """
    ...
    def parent_time_machine_id(self) -> builtins.str:
        """
...
def get_ndb_clone(clone_id: Optional[builtins.str] = None,
                  clone_name: Optional[builtins.str] = None,
    ...
    :param builtins.str clone_id: Clone id
    :param builtins.str clone_name: Clone Name
...
def get_ndb_clone_output(clone_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         clone_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
