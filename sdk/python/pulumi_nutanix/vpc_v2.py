...
class VpcV2Args:
    def __init__(__self__, *,
                 ...
                 vpc_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: Description of the VPC.
        ...
        :param pulumi.Input[builtins.str] name: Name of the VPC.
        :param pulumi.Input[builtins.str] vpc_type: Type of VPC. Acceptable values are "REGULAR" , "TRANSIT".
        """
    ...
    def vpc_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vpc_type.setter
    def vpc_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VpcV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VpcV2CommonDhcpOptionArgs']]] common_dhcp_options: List of DHCP options to be configured.
        :param pulumi.Input[builtins.str] description: Description of the VPC.
        :param pulumi.Input[builtins.str] ext_id: the vpc uuid.
        :param pulumi.Input[builtins.str] external_routing_domain_reference: External routing domain associated with this route table
        :param pulumi.Input[Sequence[pulumi.Input['VpcV2ExternalSubnetArgs']]] external_subnets: List of external subnets that the VPC is attached to.
        :param pulumi.Input[Sequence[pulumi.Input['VpcV2ExternallyRoutablePrefixArgs']]] externally_routable_prefixes: CIDR blocks from the VPC which can talk externally without performing NAT. This is applicable when connecting to external subnets which have disabled NAT.
...
class VpcV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_type: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcV2':
        """
    ...
    @property
    @pulumi.getter(name="vpcType")
    def vpc_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of VPC. Acceptable values are "REGULAR" , "TRANSIT".
        """
        return pulumi.get(self, "vpc_type")
