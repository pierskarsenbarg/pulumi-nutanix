...
def get_recovery_points_v2(apply: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: Cluster type from which recovery points must be fetched.
           * supported values:
           * `AOS` (Default)
           * `MST`
...
def get_recovery_points_v2_output(apply: Optional[pulumi.Input[Optional[builtins.str]]] = None,
