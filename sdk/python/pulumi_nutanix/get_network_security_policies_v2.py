...
def get_network_security_policies_v2(filter: Optional[builtins.str] = None,
...
def get_network_security_policies_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
