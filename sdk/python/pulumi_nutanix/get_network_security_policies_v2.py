...
__all__ = [
    'GetNetworkSecurityPoliciesV2Result',
    'AwaitableGetNetworkSecurityPoliciesV2Result',
    'get_network_security_policies_v2',
    'get_network_security_policies_v2_output',
]

@pulumi.output_type
class GetNetworkSecurityPoliciesV2Result:
    """
    A collection of values returned by getNetworkSecurityPoliciesV2.
    """
    def __init__(__self__, filter=None, id=None, limit=None, network_policies=None, order_by=None, page=None, select=None):
    ...
    def network_policies(self) -> Sequence['outputs.GetNetworkSecurityPoliciesV2NetworkPolicyResult']:
...
class AwaitableGetNetworkSecurityPoliciesV2Result(GetNetworkSecurityPoliciesV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNetworkSecurityPoliciesV2Result(
            filter=self.filter,
            id=self.id,
            limit=self.limit,
...
def get_network_security_policies_v2(filter: Optional[_builtins.str] = None,
                                     limit: Optional[_builtins.int] = None,
                                     order_by: Optional[_builtins.str] = None,
                                     page: Optional[_builtins.int] = None,
                                     select: Optional[_builtins.str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkSecurityPoliciesV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getNetworkSecurityPoliciesV2:getNetworkSecurityPoliciesV2', __args__, opts=opts, typ=GetNetworkSecurityPoliciesV2Result).value

    return AwaitableGetNetworkSecurityPoliciesV2Result(
...
def get_network_security_policies_v2_output(filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkSecurityPoliciesV2Result]:
    """
    Gets a list of Network Security Policies.
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getNetworkSecurityPoliciesV2:getNetworkSecurityPoliciesV2', __args__, opts=opts, typ=GetNetworkSecurityPoliciesV2Result)
    return __ret__.apply(lambda __response__: GetNetworkSecurityPoliciesV2Result(
