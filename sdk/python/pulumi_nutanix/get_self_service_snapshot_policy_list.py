...
class GetSelfServiceSnapshotPolicyListResult:
    ...
    def bp_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "bp_name")

    @property
    @pulumi.getter(name="bpUuid")
    def bp_uuid(self) -> Optional[builtins.str]:
...
def get_self_service_snapshot_policy_list(bp_name: Optional[builtins.str] = None,
                                          bp_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str bp_name: - (Optional) The UUID of the blueprint for which snapshot policies should be listed.
    :param builtins.str bp_uuid: - (Optional) The name of the blueprint for which snapshot policies should be listed.
           
           Both (`bp_name` and `bp_uuid`) are optional but atleast one of them to be provided for this data source to work.
    :param builtins.int length: - (Required) The number of snapshot policy records to return.
    :param builtins.int offset: - (Required) The index of the first snapshot policy to return Used for pagination. Default value: 0
    """
    __args__ = dict()
...
def get_self_service_snapshot_policy_list_output(bp_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                 bp_uuid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
