...
class GetNetworkSecurityPolicyV2Result:
    ...
    def is_hitlog_enabled(self) -> builtins.bool:
        """
    ...
    def is_ipv6_traffic_allowed(self) -> builtins.bool:
        """
    ...
    def secured_groups(self) -> Sequence[builtins.str]:
        """
    ...
    def vpc_references(self) -> Sequence[builtins.str]:
        """
...
def get_network_security_policy_v2(ext_id: Optional[builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNetworkSecurityPolicyV2Result:
    """
    Get a Network Security Policy by ExtID


    :param builtins.str ext_id: Network security policy UUID.
    """
    __args__ = dict()
...
def get_network_security_policy_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
