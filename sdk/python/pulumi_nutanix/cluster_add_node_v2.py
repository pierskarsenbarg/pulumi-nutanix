...
class ClusterAddNodeV2Args:
    def __init__(__self__, *,
                 ...
                 should_skip_add_node: Optional[pulumi.Input[builtins.bool]] = None,
                 should_skip_pre_expand_checks: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] should_skip_add_node: -(Optional) Indicates if node addition can be skipped.
        :param pulumi.Input[builtins.bool] should_skip_pre_expand_checks: -(Optional) Indicates if pre-expand checks can be skipped for node addition.
        """
    ...
    def should_skip_add_node(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def should_skip_add_node(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "should_skip_add_node", value)

    @property
    @pulumi.getter(name="shouldSkipPreExpandChecks")
    def should_skip_pre_expand_checks(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def should_skip_pre_expand_checks(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ClusterAddNodeV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remove_node_params: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ClusterAddNodeV2RemoveNodeParamArgs', 'ClusterAddNodeV2RemoveNodeParamArgsDict']]]]] = None,
            should_skip_add_node: Optional[pulumi.Input[builtins.bool]] = None,
            should_skip_pre_expand_checks: Optional[pulumi.Input[builtins.bool]] = None) -> 'ClusterAddNodeV2':
        """
    ...
    @property
    @pulumi.getter(name="shouldSkipAddNode")
    def should_skip_add_node(self) -> pulumi.Output[builtins.bool]:
        """
        -(Optional) Indicates if node addition can be skipped.
        """
        return pulumi.get(self, "should_skip_add_node")
    ...
    @property
    @pulumi.getter(name="shouldSkipPreExpandChecks")
    def should_skip_pre_expand_checks(self) -> pulumi.Output[builtins.bool]:
        """
        -(Optional) Indicates if pre-expand checks can be skipped for node addition.
        """
        return pulumi.get(self, "should_skip_pre_expand_checks")
