...
class FoundationImageArgs:
    def __init__(__self__, *,
                 ...
                 installer_type: pulumi.Input[builtins.str],
                 source: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a FoundationImage resource.
        :param pulumi.Input[builtins.str] filename: - (Required) Name of installer file to be kept in foundation vm.
        :param pulumi.Input[builtins.str] installer_type: - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        :param pulumi.Input[builtins.str] source: - (Required) Complete path to the file in machine where the .tf  files runs.
        """
    ...
    def installer_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def installer_type(self, value: pulumi.Input[builtins.str]):
...
class _FoundationImageState:
    def __init__(__self__, *,
                 ...
                 in_whitelist: Optional[pulumi.Input[builtins.bool]] = None,
                 installer_type: Optional[pulumi.Input[builtins.str]] = None,
                 md5sum: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering FoundationImage resources.
        :param pulumi.Input[builtins.str] filename: - (Required) Name of installer file to be kept in foundation vm.
        :param pulumi.Input[builtins.bool] in_whitelist: - If hypervisor ISO is in whitelist.
        :param pulumi.Input[builtins.str] installer_type: - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        :param pulumi.Input[builtins.str] md5sum: - md5sum of the ISO.
        :param pulumi.Input[builtins.str] name: - file location in foundation vm
        :param pulumi.Input[builtins.str] source: - (Required) Complete path to the file in machine where the .tf  files runs.
        """
    ...
    def in_whitelist(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @in_whitelist.setter
    def in_whitelist(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "in_whitelist", value)

    @property
    @pulumi.getter(name="installerType")
    def installer_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        """
        return pulumi.get(self, "installer_type")
    ...
    @installer_type.setter
    def installer_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "installer_type", value)

    @property
    @pulumi.getter
    def md5sum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        - md5sum of the ISO.
        """
    ...
    @md5sum.setter
    def md5sum(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FoundationImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            md5sum: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None) -> 'FoundationImage':
        """
    ...
    @property
    @pulumi.getter(name="inWhitelist")
    def in_whitelist(self) -> pulumi.Output[builtins.bool]:
        """
        - If hypervisor ISO is in whitelist.
        """
        return pulumi.get(self, "in_whitelist")
    ...
    @property
    @pulumi.getter(name="installerType")
    def installer_type(self) -> pulumi.Output[builtins.str]:
        """
        - (Required) One of "kvm", "esx", "hyperv", "xen", or "nos".
        """
        return pulumi.get(self, "installer_type")
    ...
    @property
    @pulumi.getter
    def md5sum(self) -> pulumi.Output[builtins.str]:
        """
        - md5sum of the ISO.
        """
        return pulumi.get(self, "md5sum")
