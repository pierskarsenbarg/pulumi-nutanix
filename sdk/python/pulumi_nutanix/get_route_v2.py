...
class GetRouteV2Result:
    ...
    def external_routing_domain_reference(self) -> builtins.str:
        """
    ...
    def route_table_reference(self) -> builtins.str:
        """
...
def get_route_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: Route UUID.
...
def get_route_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
