...
def get_pc_restore_points_v2(filter: Optional[builtins.str] = None,
...
def get_pc_restore_points_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
