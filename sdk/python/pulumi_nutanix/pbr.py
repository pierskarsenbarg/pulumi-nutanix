...
class PbrArgs:
    def __init__(__self__, *,
                 ...
                 is_bidirectional: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] action: Routing policy action. Must be one of {DENY, PERMIT, REROUTE} .
        :param pulumi.Input[builtins.int] priority: priority of policy
        :param pulumi.Input[builtins.str] protocol_type: Protocol type of policy based routing. Must be one of {TCP, UDP, ICMP, PROTOCOL_NUMBER, ALL} .
        :param pulumi.Input[builtins.str] api_version: The version of the API.
        :param pulumi.Input[builtins.bool] is_bidirectional: Additionally create Policy in reverse direction. Should be used with {TCP, UDP with start and end port ranges and ICMP with icmp code and type}. Supported with 2022.x.
        :param pulumi.Input[builtins.str] name: name of policy
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_ip_lists: IP addresses of network services. This field is valid only when action is REROUTE.
        :param pulumi.Input[builtins.str] vpc_name: The reference to a vpc. Should not be used with {vpc_reference_uuid}
        :param pulumi.Input[builtins.str] vpc_reference_uuid: The reference to a vpc . Should not be used with {vpc_name} .
        """
    ...
    def is_bidirectional(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_bidirectional(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PbrState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_version: The version of the API.
        :param pulumi.Input[builtins.bool] is_bidirectional: Additionally create Policy in reverse direction. Should be used with {TCP, UDP with start and end port ranges and ICMP with icmp code and type}. Supported with 2022.x.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The routing policies kind metadata.
        :param pulumi.Input[builtins.str] name: name of policy
        :param pulumi.Input[builtins.int] priority: priority of policy
        :param pulumi.Input[builtins.str] protocol_type: Protocol type of policy based routing. Must be one of {TCP, UDP, ICMP, PROTOCOL_NUMBER, ALL} .
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] service_ip_lists: IP addresses of network services. This field is valid only when action is REROUTE.
...
class Pbr(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[Union['PbrSourceArgs', 'PbrSourceArgsDict']]] = None,
            vpc_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_reference_uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'Pbr':
        """
    ...
    @property
    @pulumi.getter(name="isBidirectional")
    def is_bidirectional(self) -> pulumi.Output[builtins.bool]:
        """
        Additionally create Policy in reverse direction. Should be used with {TCP, UDP with start and end port ranges and ICMP with icmp code and type}. Supported with 2022.x.
        """
        return pulumi.get(self, "is_bidirectional")
