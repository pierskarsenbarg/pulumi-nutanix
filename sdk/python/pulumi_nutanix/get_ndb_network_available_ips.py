...
def get_ndb_network_available_ips(profile_id: Optional[builtins.str] = None,
    ...
    :param builtins.str profile_id: (Required) Network Profile id.
    """
    __args__ = dict()
...
def get_ndb_network_available_ips_output(profile_id: Optional[pulumi.Input[builtins.str]] = None,
