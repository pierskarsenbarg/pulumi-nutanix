...
class SubnetV2Args:
    def __init__(__self__, *,
                 ...
                 bridge_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 virtual_switch_reference: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_switches: Optional[pulumi.Input[Sequence[pulumi.Input['SubnetV2VirtualSwitchArgs']]]] = None,
                 vpc_reference: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def bridge_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bridge_name")

    @bridge_name.setter
    def bridge_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ip_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ip_prefix")

    @ip_prefix.setter
    def ip_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_advanced_networking(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "is_advanced_networking")

    @is_advanced_networking.setter
    def is_advanced_networking(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def network_function_chain_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "network_function_chain_reference")

    @network_function_chain_reference.setter
    def network_function_chain_reference(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def virtual_switch_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "virtual_switch_reference")

    @virtual_switch_reference.setter
    def virtual_switch_reference(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vpc_reference(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "vpc_reference")

    @vpc_reference.setter
    def vpc_reference(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SubnetV2State:
    def __init__(__self__, *,
                 ...
                 migration_state: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_function_chain_reference: Optional[pulumi.Input[builtins.str]] = None,
                 network_id: Optional[pulumi.Input[builtins.int]] = None,
                 reserved_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input['SubnetV2ReservedIpAddressArgs']]]] = None,
    ...
    def migration_state(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "migration_state")

    @migration_state.setter
    def migration_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SubnetV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bridgeName")
    def bridge_name(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "bridge_name")
    ...
    @property
    @pulumi.getter(name="isAdvancedNetworking")
    def is_advanced_networking(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "is_advanced_networking")
    ...
    @property
    @pulumi.getter(name="isNatEnabled")
    def is_nat_enabled(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "is_nat_enabled")
    ...
    @property
    @pulumi.getter(name="migrationState")
    def migration_state(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "migration_state")
    ...
    @property
    @pulumi.getter(name="networkFunctionChainReference")
    def network_function_chain_reference(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "network_function_chain_reference")
    ...
    @property
    @pulumi.getter(name="virtualSwitchReference")
    def virtual_switch_reference(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "virtual_switch_reference")
    ...
    @property
    @pulumi.getter(name="vpcReference")
    def vpc_reference(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "vpc_reference")
