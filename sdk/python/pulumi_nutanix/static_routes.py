...
class StaticRoutesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_name: vpc Name. Should not be used with vpc_uuid.
        :param pulumi.Input[builtins.str] vpc_uuid: Reference to a VPC UUID. Should not be used with vpc_name.
        """
...
class _StaticRoutesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_version: The version of the API.
        :param pulumi.Input[Sequence[pulumi.Input['StaticRoutesDefaultRouteNexthopArgs']]] default_route_nexthops: Default Route
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The vpc_route_table kind metadata.
        :param pulumi.Input[Sequence[pulumi.Input['StaticRoutesStaticRoutesListArgs']]] static_routes_lists: Static Routes.
        :param pulumi.Input[builtins.str] vpc_name: vpc Name. Should not be used with vpc_uuid.
        :param pulumi.Input[builtins.str] vpc_uuid: Reference to a VPC UUID. Should not be used with vpc_name.
        """
...
class StaticRoutes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            static_routes_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['StaticRoutesStaticRoutesListArgs', 'StaticRoutesStaticRoutesListArgsDict']]]]] = None,
            vpc_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'StaticRoutes':
        """
    ...
    @property
    @pulumi.getter(name="vpcName")
    def vpc_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        vpc Name. Should not be used with vpc_uuid.
        """
        return pulumi.get(self, "vpc_name")
