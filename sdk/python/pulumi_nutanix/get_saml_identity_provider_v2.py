...
class GetSamlIdentityProviderV2Result:
    ...
    def custom_attributes(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "custom_attributes")

    @property
    @pulumi.getter(name="emailAttribute")
    def email_attribute(self) -> builtins.str:
        return pulumi.get(self, "email_attribute")

    @property
    @pulumi.getter(name="entityIssuer")
    def entity_issuer(self) -> builtins.str:
    ...
    def groups_delim(self) -> builtins.str:
    ...
    def is_signed_authn_req_enabled(self) -> builtins.bool:
    ...
    def username_attribute(self) -> builtins.str:
...
def get_saml_identity_provider_v2(ext_id: Optional[builtins.str] = None,
...
def get_saml_identity_provider_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
