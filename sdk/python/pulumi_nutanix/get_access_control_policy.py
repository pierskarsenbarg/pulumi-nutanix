...
class GetAccessControlPolicyResult:
    ...
    def access_control_policy_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "access_control_policy_id")

    @property
    @pulumi.getter(name="accessControlPolicyName")
    def access_control_policy_name(self) -> Optional[builtins.str]:
...
def get_access_control_policy(access_control_policy_id: Optional[builtins.str] = None,
                              access_control_policy_name: Optional[builtins.str] = None,
    ...
    :param builtins.str access_control_policy_id: - (Required) The UUID of an access control policy.
...
def get_access_control_policy_output(access_control_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     access_control_policy_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
