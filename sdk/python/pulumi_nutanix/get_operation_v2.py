...
class GetOperationV2Result:
    ...
    def related_operation_lists(self) -> Sequence[builtins.str]:
        """
...
def get_operation_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: ExtId of the Operation.
    """
    __args__ = dict()
...
def get_operation_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
