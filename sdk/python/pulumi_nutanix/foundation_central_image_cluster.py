...
class FoundationCentralImageClusterArgs:
    def __init__(__self__, *,
                 aos_package_sha256sum: Optional[pulumi.Input[builtins.str]] = None,
                 aos_package_url: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_external_ip: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 skip_cluster_creation: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FoundationCentralImageCluster resource.
        :param pulumi.Input[builtins.str] aos_package_sha256sum: Sha256sum of AOS package.
        :param pulumi.Input[builtins.str] aos_package_url: URL to download AOS package. Required only if imaging is needed.
        :param pulumi.Input[builtins.str] cluster_external_ip: External management ip of the cluster.
    ...
    def aos_package_sha256sum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aos_package_sha256sum(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aos_package_sha256sum", value)

    @property
    @pulumi.getter(name="aosPackageUrl")
    def aos_package_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def aos_package_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aos_package_url", value)

    @property
    @pulumi.getter(name="clusterExternalIp")
    def cluster_external_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_external_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def image_cluster_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "image_cluster_uuid")

    @image_cluster_uuid.setter
    def image_cluster_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def redundancy_factor(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def redundancy_factor(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "redundancy_factor", value)

    @property
    @pulumi.getter(name="skipClusterCreation")
    def skip_cluster_creation(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "skip_cluster_creation")

    @skip_cluster_creation.setter
    def skip_cluster_creation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_cluster_creation", value)

    @property
    @pulumi.getter(name="storageNodeCount")
    def storage_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def storage_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _FoundationCentralImageClusterState:
    def __init__(__self__, *,
                 ...
                 storage_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 workflow_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def foundation_init_node_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "foundation_init_node_uuid")

    @foundation_init_node_uuid.setter
    def foundation_init_node_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def imaged_cluster_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def imaged_cluster_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "imaged_cluster_uuid", value)

    @property
    @pulumi.getter(name="imagedNodeUuidLists")
    def imaged_node_uuid_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "imaged_node_uuid_lists")

    @imaged_node_uuid_lists.setter
    def imaged_node_uuid_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def workflow_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "workflow_type")

    @workflow_type.setter
    def workflow_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FoundationCentralImageCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_node_count: Optional[pulumi.Input[builtins.int]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            workflow_type: Optional[pulumi.Input[builtins.str]] = None) -> 'FoundationCentralImageCluster':
        """
    ...
    @property
    @pulumi.getter(name="aosPackageSha256sum")
    def aos_package_sha256sum(self) -> pulumi.Output[builtins.str]:
        """
        Sha256sum of AOS package.
        """
        return pulumi.get(self, "aos_package_sha256sum")
    ...
    @property
    @pulumi.getter(name="aosPackageUrl")
    def aos_package_url(self) -> pulumi.Output[builtins.str]:
        """
        URL to download AOS package. Required only if imaging is needed.
        """
        return pulumi.get(self, "aos_package_url")
    ...
    @property
    @pulumi.getter
    def archived(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "archived")

    @property
    @pulumi.getter(name="clusterExternalIp")
    def cluster_external_ip(self) -> pulumi.Output[builtins.str]:
        """
        External management ip of the cluster.
        """
        return pulumi.get(self, "cluster_external_ip")
    ...
    @property
    @pulumi.getter(name="currentTime")
    def current_time(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "current_time")
    ...
    @property
    @pulumi.getter(name="foundationInitNodeUuid")
    def foundation_init_node_uuid(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "foundation_init_node_uuid")
    ...
    @property
    @pulumi.getter(name="imageClusterUuid")
    def image_cluster_uuid(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "image_cluster_uuid")

    @property
    @pulumi.getter(name="imagedClusterUuid")
    def imaged_cluster_uuid(self) -> pulumi.Output[builtins.str]:
        """
        Unique id of the cluster.
        """
        return pulumi.get(self, "imaged_cluster_uuid")
    ...
    @property
    @pulumi.getter(name="imagedNodeUuidLists")
    def imaged_node_uuid_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "imaged_node_uuid_lists")
    ...
    @property
    @pulumi.getter(name="redundancyFactor")
    def redundancy_factor(self) -> pulumi.Output[builtins.int]:
        """
        Redundancy factor of the cluster.
        """
        return pulumi.get(self, "redundancy_factor")
    ...
    @property
    @pulumi.getter(name="skipClusterCreation")
    def skip_cluster_creation(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "skip_cluster_creation")

    @property
    @pulumi.getter(name="storageNodeCount")
    def storage_node_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of storage only nodes in the cluster. AHV iso for storage node will be taken from aos package.
        """
        return pulumi.get(self, "storage_node_count")
    ...
    @property
    @pulumi.getter(name="workflowType")
    def workflow_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "workflow_type")
