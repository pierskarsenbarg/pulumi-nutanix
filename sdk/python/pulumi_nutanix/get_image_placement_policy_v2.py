...
def get_image_placement_policy_v2(ext_id: Optional[builtins.str] = None,
...
def get_image_placement_policy_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
