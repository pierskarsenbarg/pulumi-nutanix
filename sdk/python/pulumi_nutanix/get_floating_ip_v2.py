...
class GetFloatingIpV2Result:
    ...
    def external_subnet_reference(self) -> builtins.str:
        """
    ...
    def floating_ip_value(self) -> builtins.str:
        """
    ...
    def vm_nic_reference(self) -> builtins.str:
        """
        VM NIC reference.
        """
...
def get_floating_ip_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: Floating IP UUID
    """
    __args__ = dict()
