...
class NdbRegisterDbserverArgs:
    ...
    def forced_install(self, value: Optional[pulumi.Input[bool]]):
    ...
    @nxcluster_id.setter
    def nxcluster_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def update_name_description_in_cluster(self, value: Optional[pulumi.Input[bool]]):
...
class NdbRegisterDbserver(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vm_ip: Optional[pulumi.Input[str]] = None,
            vm_timezone: Optional[pulumi.Input[str]] = None,
            working_directory: Optional[pulumi.Input[str]] = None) -> 'NdbRegisterDbserver':
        """
    ...
    @property
    @pulumi.getter(name="eraCreated")
    def era_created(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "era_created")
