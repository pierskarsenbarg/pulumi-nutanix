...
class GetDirectoryServiceV2Result:
    ...
    def group_search_type(self) -> builtins.str:
        """
    ...
    def secondary_urls(self) -> Sequence[builtins.str]:
        """
    ...
    def white_listed_groups(self) -> Sequence[builtins.str]:
        """
...
def get_directory_service_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: -(Required) External identifier of the Directory Service.
    """
    __args__ = dict()
...
def get_directory_service_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
