...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 boot_device_disk_address: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 boot_device_mac_address: Optional[pulumi.Input[str]] = None,
                 boot_device_order_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 cloud_init_cdrom_uuid: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 disk_lists: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineDiskListArgs']]]] = None,
                 enable_cpu_passthrough: Optional[pulumi.Input[bool]] = None,
                 enable_script_exec: Optional[pulumi.Input[bool]] = None,
                 gpu_lists: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineGpuListArgs']]]] = None,
                 guest_customization_cloud_init_custom_key_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 guest_customization_cloud_init_meta_data: Optional[pulumi.Input[str]] = None,
                 guest_customization_cloud_init_user_data: Optional[pulumi.Input[str]] = None,
                 guest_customization_is_overridable: Optional[pulumi.Input[bool]] = None,
                 guest_customization_sysprep: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 guest_customization_sysprep_custom_key_values: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 guest_os_id: Optional[pulumi.Input[str]] = None,
                 hardware_clock_timezone: Optional[pulumi.Input[str]] = None,
                 is_vcpu_hard_pinned: Optional[pulumi.Input[bool]] = None,
                 machine_type: Optional[pulumi.Input[str]] = None,
                 memory_size_mib: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 ngt_credentials: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ngt_enabled_capability_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 num_vcpus_per_socket: Optional[pulumi.Input[int]] = None,
                 num_vnuma_nodes: Optional[pulumi.Input[int]] = None,
                 nutanix_guest_tools: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 owner_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 parent_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 power_state_mechanism: Optional[pulumi.Input[str]] = None,
                 ...
                 use_hot_add: Optional[pulumi.Input[bool]] = None,
                 vga_console_enabled: Optional[pulumi.Input[bool]] = None):
        """
        ...
        :param pulumi.Input[str] description: - (Optional) A description for vm.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineDiskListArgs']]] disk_lists: Disks attached to the VM.
        :param pulumi.Input[bool] enable_cpu_passthrough: - (Optional) Add true to enable CPU passthrough.
    ...
    def availability_zone_reference(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    def availability_zone_reference(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
        pulumi.set(self, "availability_zone_reference", value)

    @property
    @pulumi.getter(name="bootDeviceDiskAddress")
    def boot_device_disk_address(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    def boot_device_disk_address(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
        pulumi.set(self, "boot_device_disk_address", value)

    @property
    @pulumi.getter(name="bootDeviceMacAddress")
    def boot_device_mac_address(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def boot_device_mac_address(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "boot_device_mac_address", value)

    @property
    @pulumi.getter(name="bootDeviceOrderLists")
    def boot_device_order_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def boot_device_order_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def cloud_init_cdrom_uuid(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "cloud_init_cdrom_uuid")

    @cloud_init_cdrom_uuid.setter
    def cloud_init_cdrom_uuid(self, value: Optional[pulumi.Input[str]]):
    ...
    def enable_cpu_passthrough(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enable_cpu_passthrough(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "enable_cpu_passthrough", value)

    @property
    @pulumi.getter(name="enableScriptExec")
    def enable_script_exec(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def enable_script_exec(self, value: Optional[pulumi.Input[bool]]):
    ...
    def guest_customization_cloud_init_custom_key_values(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    def guest_customization_cloud_init_custom_key_values(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
    ...
    def guest_customization_cloud_init_meta_data(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def guest_customization_cloud_init_meta_data(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "guest_customization_cloud_init_meta_data", value)

    @property
    @pulumi.getter(name="guestCustomizationCloudInitUserData")
    def guest_customization_cloud_init_user_data(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def guest_customization_cloud_init_user_data(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "guest_customization_cloud_init_user_data", value)

    @property
    @pulumi.getter(name="guestCustomizationIsOverridable")
    def guest_customization_is_overridable(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def guest_customization_is_overridable(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "guest_customization_is_overridable", value)

    @property
    @pulumi.getter(name="guestCustomizationSysprep")
    def guest_customization_sysprep(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
        - (Optional) VM guests may be customized at boot time using one of several different methods. Currently, cloud-init w/ ConfigDriveV2 (for Linux VMs) and Sysprep (for Windows VMs) are supported. Only ONE OF sysprep or cloud_init should be provided. Note that guest customization can currently only be set during VM creation. Attempting to change it after creation will result in an error. Additional properties can be specified. For example - in the context of VM template creation if \\"override_script\\" is set to \\"True\\" then the deployer can upload their own custom script.
        """
    ...
    def guest_os_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @guest_os_id.setter
    def guest_os_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def is_vcpu_hard_pinned(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def is_vcpu_hard_pinned(self, value: Optional[pulumi.Input[bool]]):
    ...
    def ngt_credentials(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        """
    ...
    def ngt_credentials(self, value: Optional[pulumi.Input[Mapping[str, Any]]]):
        pulumi.set(self, "ngt_credentials", value)

    @property
    @pulumi.getter(name="ngtEnabledCapabilityLists")
    def ngt_enabled_capability_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def ngt_enabled_capability_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
    ...
    def num_vcpus_per_socket(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def num_vcpus_per_socket(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "num_vcpus_per_socket", value)

    @property
    @pulumi.getter(name="numVnumaNodes")
    def num_vnuma_nodes(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def num_vnuma_nodes(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "num_vnuma_nodes", value)

    @property
    @pulumi.getter(name="nutanixGuestTools")
    def nutanix_guest_tools(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
    ...
    def nutanix_guest_tools(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
    ...
    def power_state_mechanism(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def power_state_mechanism(self, value: Optional[pulumi.Input[str]]):
    ...
    def use_hot_add(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @use_hot_add.setter
    def use_hot_add(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "use_hot_add", value)

    @property
    @pulumi.getter(name="vgaConsoleEnabled")
    def vga_console_enabled(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def vga_console_enabled(self, value: Optional[pulumi.Input[bool]]):
...
class _VirtualMachineState:
    def __init__(__self__, *,
                 ...
                 guest_os_id: Optional[pulumi.Input[str]] = None,
                 hardware_clock_timezone: Optional[pulumi.Input[str]] = None,
                 host_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
    ...
    def host_reference(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
        - Reference to a host.
        """
    ...
    def host_reference(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 boot_device_order_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 boot_type: Optional[pulumi.Input[str]] = None,
                 categories: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineCategoryArgs']]]]] = None,
                 cloud_init_cdrom_uuid: Optional[pulumi.Input[str]] = None,
                 cluster_uuid: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 disk_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineDiskListArgs']]]]] = None,
                 enable_cpu_passthrough: Optional[pulumi.Input[bool]] = None,
                 enable_script_exec: Optional[pulumi.Input[bool]] = None,
                 gpu_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineGpuListArgs']]]]] = None,
                 guest_customization_cloud_init_custom_key_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 guest_customization_cloud_init_meta_data: Optional[pulumi.Input[str]] = None,
                 guest_customization_cloud_init_user_data: Optional[pulumi.Input[str]] = None,
                 guest_customization_is_overridable: Optional[pulumi.Input[bool]] = None,
                 ...
                 ngt_credentials: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 ngt_enabled_capability_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 nic_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineNicListArgs']]]]] = None,
                 num_sockets: Optional[pulumi.Input[int]] = None,
                 num_vcpus_per_socket: Optional[pulumi.Input[int]] = None,
                 num_vnuma_nodes: Optional[pulumi.Input[int]] = None,
                 nutanix_guest_tools: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 ...
                 power_state_mechanism: Optional[pulumi.Input[str]] = None,
                 project_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 serial_port_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineSerialPortListArgs']]]]] = None,
                 should_fail_on_script_failure: Optional[pulumi.Input[bool]] = None,
                 use_hot_add: Optional[pulumi.Input[bool]] = None,
                 vga_console_enabled: Optional[pulumi.Input[bool]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] boot_device_order_lists: - (Optional) Indicates the order of device types in which VM should try to boot from. If boot device order is not provided the system will decide appropriate boot device order.
        :param pulumi.Input[str] boot_type: - (Optional) Indicates whether the VM should use Secure boot, UEFI boot or Legacy boot.If UEFI or; Secure boot is enabled then other legacy boot options (like boot_device and; boot_device_order_list) are ignored. Secure boot depends on UEFI boot, i.e. enabling; Secure boot means that UEFI boot is also enabled. The possible value are: UEFI", "LEGACY", "SECURE_BOOT".
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineCategoryArgs']]]] categories: - (Optional) Categories for the vm.
        :param pulumi.Input[str] cluster_uuid: - (Required) The UUID of the cluster.
        :param pulumi.Input[str] description: - (Optional) A description for vm.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineDiskListArgs']]]] disk_lists: Disks attached to the VM.
        :param pulumi.Input[bool] enable_cpu_passthrough: - (Optional) Add true to enable CPU passthrough.
        :param pulumi.Input[bool] enable_script_exec: - (Optional) Extra configs related to power state transition. Indicates whether to execute set script before ngt shutdown/reboot.
    ...
    def get(resource_name: str,
            ...
            ngt_credentials: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            ngt_enabled_capability_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            nic_list_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineNicListStatusArgs']]]]] = None,
            nic_lists: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VirtualMachineNicListArgs']]]]] = None,
            num_sockets: Optional[pulumi.Input[int]] = None,
            num_vcpus_per_socket: Optional[pulumi.Input[int]] = None,
            num_vnuma_nodes: Optional[pulumi.Input[int]] = None,
            ...
            state: Optional[pulumi.Input[str]] = None,
            use_hot_add: Optional[pulumi.Input[bool]] = None,
            vga_console_enabled: Optional[pulumi.Input[bool]] = None) -> 'VirtualMachine':
        """
    ...
    @property
    @pulumi.getter(name="availabilityZoneReference")
    def availability_zone_reference(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - (Optional) The reference to a availability_zone.
        """
        return pulumi.get(self, "availability_zone_reference")
    ...
    @property
    @pulumi.getter(name="bootDeviceDiskAddress")
    def boot_device_disk_address(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - (Optional) Address of disk to boot from.
        """
        return pulumi.get(self, "boot_device_disk_address")
    ...
    @property
    @pulumi.getter(name="bootDeviceMacAddress")
    def boot_device_mac_address(self) -> pulumi.Output[str]:
        """
        - (Optional) MAC address of nic to boot from.
        """
        return pulumi.get(self, "boot_device_mac_address")
    ...
    @property
    @pulumi.getter(name="bootDeviceOrderLists")
    def boot_device_order_lists(self) -> pulumi.Output[Sequence[str]]:
        """
        - (Optional) Indicates the order of device types in which VM should try to boot from. If boot device order is not provided the system will decide appropriate boot device order.
        """
        return pulumi.get(self, "boot_device_order_lists")
    ...
    @property
    @pulumi.getter(name="cloudInitCdromUuid")
    def cloud_init_cdrom_uuid(self) -> pulumi.Output[str]:
        return pulumi.get(self, "cloud_init_cdrom_uuid")
    ...
    @property
    @pulumi.getter(name="enableCpuPassthrough")
    def enable_cpu_passthrough(self) -> pulumi.Output[Optional[bool]]:
        """
        - (Optional) Add true to enable CPU passthrough.
        """
        return pulumi.get(self, "enable_cpu_passthrough")
    ...
    @property
    @pulumi.getter(name="enableScriptExec")
    def enable_script_exec(self) -> pulumi.Output[bool]:
        """
        - (Optional) Extra configs related to power state transition. Indicates whether to execute set script before ngt shutdown/reboot.
        """
        return pulumi.get(self, "enable_script_exec")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitCustomKeyValues")
    def guest_customization_cloud_init_custom_key_values(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - (Optional) Generic key value pair used for custom attributes in cloud init.
        """
        return pulumi.get(self, "guest_customization_cloud_init_custom_key_values")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitMetaData")
    def guest_customization_cloud_init_meta_data(self) -> pulumi.Output[str]:
        """
        The contents of the meta_data configuration for cloud-init. This can be formatted as YAML or JSON. The value must be base64 encoded.
        """
        return pulumi.get(self, "guest_customization_cloud_init_meta_data")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitUserData")
    def guest_customization_cloud_init_user_data(self) -> pulumi.Output[str]:
        """
        - (Optional) The contents of the user_data configuration for cloud-init. This can be formatted as YAML, JSON, or could be a shell script. The value must be base64 encoded.
        """
        return pulumi.get(self, "guest_customization_cloud_init_user_data")
    ...
    @property
    @pulumi.getter(name="guestCustomizationIsOverridable")
    def guest_customization_is_overridable(self) -> pulumi.Output[bool]:
        """
        - (Optional) Flag to allow override of customization by deployer.
        """
        return pulumi.get(self, "guest_customization_is_overridable")
    ...
    @property
    @pulumi.getter(name="guestCustomizationSysprep")
    def guest_customization_sysprep(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - (Optional) VM guests may be customized at boot time using one of several different methods. Currently, cloud-init w/ ConfigDriveV2 (for Linux VMs) and Sysprep (for Windows VMs) are supported. Only ONE OF sysprep or cloud_init should be provided. Note that guest customization can currently only be set during VM creation. Attempting to change it after creation will result in an error. Additional properties can be specified. For example - in the context of VM template creation if \\"override_script\\" is set to \\"True\\" then the deployer can upload their own custom script.
        """
        return pulumi.get(self, "guest_customization_sysprep")
    ...
    @property
    @pulumi.getter(name="hardwareClockTimezone")
    def hardware_clock_timezone(self) -> pulumi.Output[str]:
        """
        - (Optional) VM's hardware clock timezone in IANA TZDB format (America/Los_Angeles).
        """
        return pulumi.get(self, "hardware_clock_timezone")
    ...
    @property
    @pulumi.getter(name="hostReference")
    def host_reference(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - Reference to a host.
        """
        return pulumi.get(self, "host_reference")
    ...
    @property
    @pulumi.getter(name="hypervisorType")
    def hypervisor_type(self) -> pulumi.Output[str]:
        """
        - The hypervisor type for the hypervisor the VM is hosted on.
        """
        return pulumi.get(self, "hypervisor_type")
    ...
    @property
    @pulumi.getter(name="isVcpuHardPinned")
    def is_vcpu_hard_pinned(self) -> pulumi.Output[Optional[bool]]:
        """
        - (Optional) Add true to enable CPU pinning.
        """
        return pulumi.get(self, "is_vcpu_hard_pinned")
    ...
    @property
    @pulumi.getter(name="ngtCredentials")
    def ngt_credentials(self) -> pulumi.Output[Mapping[str, Any]]:
        """
        - (Ooptional) Credentials to login server.
        """
        return pulumi.get(self, "ngt_credentials")
    ...
    @property
    @pulumi.getter(name="ngtEnabledCapabilityLists")
    def ngt_enabled_capability_lists(self) -> pulumi.Output[Sequence[str]]:
        """
        Application names that are enabled.
        """
        return pulumi.get(self, "ngt_enabled_capability_lists")
    ...
    @property
    @pulumi.getter(name="numSockets")
    def num_sockets(self) -> pulumi.Output[int]:
        """
        - (Optional) Number of vCPU sockets.
        """
        return pulumi.get(self, "num_sockets")
    ...
    @property
    @pulumi.getter(name="numVcpusPerSocket")
    def num_vcpus_per_socket(self) -> pulumi.Output[int]:
        """
        - (Optional) Number of vCPUs per socket.
        """
        return pulumi.get(self, "num_vcpus_per_socket")
    ...
    @property
    @pulumi.getter(name="numVnumaNodes")
    def num_vnuma_nodes(self) -> pulumi.Output[int]:
        """
        - (Optional) Number of vNUMA nodes. 0 means vNUMA is disabled.
        """
        return pulumi.get(self, "num_vnuma_nodes")
    ...
    @property
    @pulumi.getter(name="nutanixGuestTools")
    def nutanix_guest_tools(self) -> pulumi.Output[Mapping[str, str]]:
        """
        - (Optional) Information regarding Nutanix Guest Tools.
        """
        return pulumi.get(self, "nutanix_guest_tools")
    ...
    @property
    @pulumi.getter(name="powerStateMechanism")
    def power_state_mechanism(self) -> pulumi.Output[str]:
        """
        - (Optional) Indicates the mechanism guiding the VM power state transition. Currently used for the transition to \\"OFF\\" state. Power state mechanism (ACPI/GUEST/HARD).
        """
        return pulumi.get(self, "power_state_mechanism")
    ...
    @property
    @pulumi.getter(name="shouldFailOnScriptFailure")
    def should_fail_on_script_failure(self) -> pulumi.Output[bool]:
        """
        - (Optional)  Extra configs related to power state transition. Indicates whether to abort ngt shutdown/reboot if script fails.
        """
        return pulumi.get(self, "should_fail_on_script_failure")
    ...
    @property
    @pulumi.getter(name="vgaConsoleEnabled")
    def vga_console_enabled(self) -> pulumi.Output[bool]:
        """
        - (Optional) Indicates whether VGA console should be enabled or not.
        """
        return pulumi.get(self, "vga_console_enabled")
