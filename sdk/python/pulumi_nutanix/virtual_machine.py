...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 cluster_uuid: pulumi.Input[builtins.str],
                 availability_zone_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 boot_device_disk_address: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 boot_device_mac_address: Optional[pulumi.Input[builtins.str]] = None,
                 boot_device_order_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 cloud_init_cdrom_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disk_lists: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineDiskListArgs']]]] = None,
                 enable_cpu_passthrough: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_script_exec: Optional[pulumi.Input[builtins.bool]] = None,
                 gpu_lists: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineGpuListArgs']]]] = None,
                 guest_customization_cloud_init_custom_key_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 guest_customization_cloud_init_meta_data: Optional[pulumi.Input[builtins.str]] = None,
                 guest_customization_cloud_init_user_data: Optional[pulumi.Input[builtins.str]] = None,
                 guest_customization_is_overridable: Optional[pulumi.Input[builtins.bool]] = None,
                 guest_customization_sysprep: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 guest_customization_sysprep_custom_key_values: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 guest_os_id: Optional[pulumi.Input[builtins.str]] = None,
                 hardware_clock_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 is_vcpu_hard_pinned: Optional[pulumi.Input[builtins.bool]] = None,
                 machine_type: Optional[pulumi.Input[builtins.str]] = None,
                 memory_size_mib: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ngt_credentials: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ngt_enabled_capability_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 nic_lists: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualMachineNicListArgs']]]] = None,
                 num_sockets: Optional[pulumi.Input[builtins.int]] = None,
                 num_vcpus_per_socket: Optional[pulumi.Input[builtins.int]] = None,
                 num_vnuma_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 should_fail_on_script_failure: Optional[pulumi.Input[builtins.bool]] = None,
                 use_hot_add: Optional[pulumi.Input[builtins.bool]] = None,
                 vga_console_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] boot_device_disk_address: - (Optional) Address of disk to boot from.
        :param pulumi.Input[builtins.str] boot_device_mac_address: - (Optional) MAC address of nic to boot from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] boot_device_order_lists: - (Optional) Indicates the order of device types in which VM should try to boot from. If boot device order is not provided the system will decide appropriate boot device order.
        :param pulumi.Input[builtins.str] boot_type: - (Optional) Indicates whether the VM should use Secure boot, UEFI boot or Legacy boot.If UEFI or; Secure boot is enabled then other legacy boot options (like boot_device and; boot_device_order_list) are ignored. Secure boot depends on UEFI boot, i.e. enabling; Secure boot means that UEFI boot is also enabled. The possible value are: UEFI", "LEGACY", "SECURE_BOOT".
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineCategoryArgs']]] categories: - (Optional) Categories for the vm.
        :param pulumi.Input[builtins.str] description: - (Optional) A description for vm.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineDiskListArgs']]] disk_lists: Disks attached to the VM.
        :param pulumi.Input[builtins.bool] enable_cpu_passthrough: - (Optional) Add true to enable CPU passthrough.
        :param pulumi.Input[builtins.bool] enable_script_exec: - (Optional) Extra configs related to power state transition. Indicates whether to execute set script before ngt shutdown/reboot.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineGpuListArgs']]] gpu_lists: - (Optional) GPUs attached to the VM.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] guest_customization_cloud_init_custom_key_values: - (Optional) Generic key value pair used for custom attributes in cloud init.
        :param pulumi.Input[builtins.str] guest_customization_cloud_init_meta_data: The contents of the meta_data configuration for cloud-init. This can be formatted as YAML or JSON. The value must be base64 encoded.
        :param pulumi.Input[builtins.str] guest_customization_cloud_init_user_data: - (Optional) The contents of the user_data configuration for cloud-init. This can be formatted as YAML, JSON, or could be a shell script. The value must be base64 encoded.
        :param pulumi.Input[builtins.bool] guest_customization_is_overridable: - (Optional) Flag to allow override of customization by deployer.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] guest_customization_sysprep: - (Optional) VM guests may be customized at boot time using one of several different methods. Currently, cloud-init w/ ConfigDriveV2 (for Linux VMs) and Sysprep (for Windows VMs) are supported. Only ONE OF sysprep or cloud_init should be provided. Note that guest customization can currently only be set during VM creation. Attempting to change it after creation will result in an error. Additional properties can be specified. For example - in the context of VM template creation if \\"override_script\\" is set to \\"True\\" then the deployer can upload their own custom script.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] guest_customization_sysprep_custom_key_values: - (Optional) Generic key value pair used for custom attributes in sysprep.
        :param pulumi.Input[builtins.str] guest_os_id: - (Optional) Guest OS Identifier. For ESX, refer to VMware documentation [link](https://www.vmware.com/support/developer/converter-sdk/conv43_apireference/vim.vm.GuestOsDescriptor.GuestOsIdentifier.html) for the list of guest OS identifiers.
        :param pulumi.Input[builtins.str] hardware_clock_timezone: - (Optional) VM's hardware clock timezone in IANA TZDB format (America/Los_Angeles).
        :param pulumi.Input[builtins.bool] is_vcpu_hard_pinned: - (Optional) Add true to enable CPU pinning.
        :param pulumi.Input[builtins.str] machine_type: - Machine type for the VM. Machine type Q35 is required for secure boot and does not support IDE disks.
        :param pulumi.Input[builtins.int] memory_size_mib: - (Optional) Memory size in MiB. On updating memory to powered ON VMs should only be done in 1GB increments.
        :param pulumi.Input[builtins.str] name: - (Required) The name for the vm.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] ngt_credentials: - (Ooptional) Credentials to login server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ngt_enabled_capability_lists: Application names that are enabled.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineNicListArgs']]] nic_lists: - (Optional) Spec NICs attached to the VM.
        :param pulumi.Input[builtins.int] num_sockets: - (Optional) Number of vCPU sockets.
        :param pulumi.Input[builtins.int] num_vcpus_per_socket: - (Optional) Number of vCPUs per socket.
        :param pulumi.Input[builtins.int] num_vnuma_nodes: - (Optional) Number of vNUMA nodes. 0 means vNUMA is disabled.
        ...
        :param pulumi.Input[builtins.bool] should_fail_on_script_failure: - (Optional)  Extra configs related to power state transition. Indicates whether to abort ngt shutdown/reboot if script fails.
        :param pulumi.Input[builtins.bool] use_hot_add: - (Optional) Use Hot Add when modifying VM resources. Passing value false will result in VM reboots. Default value is `true`.
        :param pulumi.Input[builtins.bool] vga_console_enabled: - (Optional) Indicates whether VGA console should be enabled or not.
        """
    ...
    def cluster_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @cluster_uuid.setter
    def cluster_uuid(self, value: pulumi.Input[builtins.str]):
    ...
    def boot_device_disk_address(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def boot_device_disk_address(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "boot_device_disk_address", value)

    @property
    @pulumi.getter(name="bootDeviceMacAddress")
    def boot_device_mac_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def boot_device_mac_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "boot_device_mac_address", value)

    @property
    @pulumi.getter(name="bootDeviceOrderLists")
    def boot_device_order_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def boot_device_order_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def cloud_init_cdrom_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "cloud_init_cdrom_uuid")

    @cloud_init_cdrom_uuid.setter
    def cloud_init_cdrom_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_cpu_passthrough(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_cpu_passthrough(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_cpu_passthrough", value)

    @property
    @pulumi.getter(name="enableScriptExec")
    def enable_script_exec(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_script_exec(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def guest_customization_cloud_init_custom_key_values(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def guest_customization_cloud_init_custom_key_values(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def guest_customization_cloud_init_meta_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def guest_customization_cloud_init_meta_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guest_customization_cloud_init_meta_data", value)

    @property
    @pulumi.getter(name="guestCustomizationCloudInitUserData")
    def guest_customization_cloud_init_user_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def guest_customization_cloud_init_user_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guest_customization_cloud_init_user_data", value)

    @property
    @pulumi.getter(name="guestCustomizationIsOverridable")
    def guest_customization_is_overridable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def guest_customization_is_overridable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "guest_customization_is_overridable", value)

    @property
    @pulumi.getter(name="guestCustomizationSysprep")
    def guest_customization_sysprep(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        - (Optional) VM guests may be customized at boot time using one of several different methods. Currently, cloud-init w/ ConfigDriveV2 (for Linux VMs) and Sysprep (for Windows VMs) are supported. Only ONE OF sysprep or cloud_init should be provided. Note that guest customization can currently only be set during VM creation. Attempting to change it after creation will result in an error. Additional properties can be specified. For example - in the context of VM template creation if \\"override_script\\" is set to \\"True\\" then the deployer can upload their own custom script.
        """
    ...
    def guest_customization_sysprep(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "guest_customization_sysprep", value)

    @property
    @pulumi.getter(name="guestCustomizationSysprepCustomKeyValues")
    def guest_customization_sysprep_custom_key_values(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def guest_customization_sysprep_custom_key_values(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "guest_customization_sysprep_custom_key_values", value)

    @property
    @pulumi.getter(name="guestOsId")
    def guest_os_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @guest_os_id.setter
    def guest_os_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guest_os_id", value)

    @property
    @pulumi.getter(name="hardwareClockTimezone")
    def hardware_clock_timezone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hardware_clock_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hardware_clock_timezone", value)

    @property
    @pulumi.getter(name="isVcpuHardPinned")
    def is_vcpu_hard_pinned(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vcpu_hard_pinned(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def memory_size_mib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def memory_size_mib(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ngt_credentials(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def ngt_credentials(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ngt_credentials", value)

    @property
    @pulumi.getter(name="ngtEnabledCapabilityLists")
    def ngt_enabled_capability_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ngt_enabled_capability_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def num_sockets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @num_sockets.setter
    def num_sockets(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_sockets", value)

    @property
    @pulumi.getter(name="numVcpusPerSocket")
    def num_vcpus_per_socket(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_vcpus_per_socket(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_vcpus_per_socket", value)

    @property
    @pulumi.getter(name="numVnumaNodes")
    def num_vnuma_nodes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_vnuma_nodes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_vnuma_nodes", value)

    @property
    @pulumi.getter(name="nutanixGuestTools")
    def nutanix_guest_tools(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def nutanix_guest_tools(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def parent_reference(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def power_state_mechanism(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def power_state_mechanism(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def should_fail_on_script_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def should_fail_on_script_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "should_fail_on_script_failure", value)

    @property
    @pulumi.getter(name="useHotAdd")
    def use_hot_add(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_hot_add.setter
    def use_hot_add(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_hot_add", value)

    @property
    @pulumi.getter(name="vgaConsoleEnabled")
    def vga_console_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def vga_console_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VirtualMachineState:
    def __init__(__self__, *,
                 ...
                 guest_os_id: Optional[pulumi.Input[builtins.str]] = None,
                 hardware_clock_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 host_reference: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 hypervisor_type: Optional[pulumi.Input[builtins.str]] = None,
                 is_vcpu_hard_pinned: Optional[pulumi.Input[builtins.bool]] = None,
                 machine_type: Optional[pulumi.Input[builtins.str]] = None,
                 memory_size_mib: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] guest_os_id: - (Optional) Guest OS Identifier. For ESX, refer to VMware documentation [link](https://www.vmware.com/support/developer/converter-sdk/conv43_apireference/vim.vm.GuestOsDescriptor.GuestOsIdentifier.html) for the list of guest OS identifiers.
        :param pulumi.Input[builtins.str] hardware_clock_timezone: - (Optional) VM's hardware clock timezone in IANA TZDB format (America/Los_Angeles).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] host_reference: - Reference to a host.
        :param pulumi.Input[builtins.str] hypervisor_type: - The hypervisor type for the hypervisor the VM is hosted on.
        :param pulumi.Input[builtins.bool] is_vcpu_hard_pinned: - (Optional) Add true to enable CPU pinning.
        :param pulumi.Input[builtins.str] machine_type: - Machine type for the VM. Machine type Q35 is required for secure boot and does not support IDE disks.
        :param pulumi.Input[builtins.int] memory_size_mib: - (Optional) Memory size in MiB. On updating memory to powered ON VMs should only be done in 1GB increments.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: - The vm kind metadata.
        :param pulumi.Input[builtins.str] name: - (Required) The name for the vm.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] ngt_credentials: - (Ooptional) Credentials to login server.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ngt_enabled_capability_lists: Application names that are enabled.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineSerialPortListArgs']]] serial_port_lists: - (Optional) Serial Ports configured on the VM.
        :param pulumi.Input[builtins.bool] should_fail_on_script_failure: - (Optional)  Extra configs related to power state transition. Indicates whether to abort ngt shutdown/reboot if script fails.
        :param pulumi.Input[builtins.str] state: - The state of the vm.
        :param pulumi.Input[builtins.bool] use_hot_add: - (Optional) Use Hot Add when modifying VM resources. Passing value false will result in VM reboots. Default value is `true`.
        :param pulumi.Input[builtins.bool] vga_console_enabled: - (Optional) Indicates whether VGA console should be enabled or not.
        """
    ...
    def host_reference(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        - Reference to a host.
        """
    ...
    def host_reference(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "host_reference", value)

    @property
    @pulumi.getter(name="hypervisorType")
    def hypervisor_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hypervisor_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            use_hot_add: Optional[pulumi.Input[builtins.bool]] = None,
            vga_console_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'VirtualMachine':
        """
    ...
    @property
    @pulumi.getter(name="bootDeviceDiskAddress")
    def boot_device_disk_address(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) Address of disk to boot from.
        """
        return pulumi.get(self, "boot_device_disk_address")
    ...
    @property
    @pulumi.getter(name="bootDeviceMacAddress")
    def boot_device_mac_address(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) MAC address of nic to boot from.
        """
        return pulumi.get(self, "boot_device_mac_address")
    ...
    @property
    @pulumi.getter(name="bootDeviceOrderLists")
    def boot_device_order_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        - (Optional) Indicates the order of device types in which VM should try to boot from. If boot device order is not provided the system will decide appropriate boot device order.
        """
        return pulumi.get(self, "boot_device_order_lists")
    ...
    @property
    @pulumi.getter(name="bootType")
    def boot_type(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) Indicates whether the VM should use Secure boot, UEFI boot or Legacy boot.If UEFI or; Secure boot is enabled then other legacy boot options (like boot_device and; boot_device_order_list) are ignored. Secure boot depends on UEFI boot, i.e. enabling; Secure boot means that UEFI boot is also enabled. The possible value are: UEFI", "LEGACY", "SECURE_BOOT".
        """
        return pulumi.get(self, "boot_type")
    ...
    @property
    @pulumi.getter(name="cloudInitCdromUuid")
    def cloud_init_cdrom_uuid(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "cloud_init_cdrom_uuid")
    ...
    @property
    @pulumi.getter(name="enableCpuPassthrough")
    def enable_cpu_passthrough(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional) Add true to enable CPU passthrough.
        """
        return pulumi.get(self, "enable_cpu_passthrough")
    ...
    @property
    @pulumi.getter(name="enableScriptExec")
    def enable_script_exec(self) -> pulumi.Output[builtins.bool]:
        """
        - (Optional) Extra configs related to power state transition. Indicates whether to execute set script before ngt shutdown/reboot.
        """
        return pulumi.get(self, "enable_script_exec")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitCustomKeyValues")
    def guest_customization_cloud_init_custom_key_values(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) Generic key value pair used for custom attributes in cloud init.
        """
        return pulumi.get(self, "guest_customization_cloud_init_custom_key_values")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitMetaData")
    def guest_customization_cloud_init_meta_data(self) -> pulumi.Output[builtins.str]:
        """
        The contents of the meta_data configuration for cloud-init. This can be formatted as YAML or JSON. The value must be base64 encoded.
        """
        return pulumi.get(self, "guest_customization_cloud_init_meta_data")
    ...
    @property
    @pulumi.getter(name="guestCustomizationCloudInitUserData")
    def guest_customization_cloud_init_user_data(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) The contents of the user_data configuration for cloud-init. This can be formatted as YAML, JSON, or could be a shell script. The value must be base64 encoded.
        """
        return pulumi.get(self, "guest_customization_cloud_init_user_data")
    ...
    @property
    @pulumi.getter(name="guestCustomizationIsOverridable")
    def guest_customization_is_overridable(self) -> pulumi.Output[builtins.bool]:
        """
        - (Optional) Flag to allow override of customization by deployer.
        """
        return pulumi.get(self, "guest_customization_is_overridable")
    ...
    @property
    @pulumi.getter(name="guestCustomizationSysprep")
    def guest_customization_sysprep(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) VM guests may be customized at boot time using one of several different methods. Currently, cloud-init w/ ConfigDriveV2 (for Linux VMs) and Sysprep (for Windows VMs) are supported. Only ONE OF sysprep or cloud_init should be provided. Note that guest customization can currently only be set during VM creation. Attempting to change it after creation will result in an error. Additional properties can be specified. For example - in the context of VM template creation if \\"override_script\\" is set to \\"True\\" then the deployer can upload their own custom script.
        """
        return pulumi.get(self, "guest_customization_sysprep")
    ...
    @property
    @pulumi.getter(name="guestCustomizationSysprepCustomKeyValues")
    def guest_customization_sysprep_custom_key_values(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) Generic key value pair used for custom attributes in sysprep.
        """
        return pulumi.get(self, "guest_customization_sysprep_custom_key_values")
    ...
    @property
    @pulumi.getter(name="guestOsId")
    def guest_os_id(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) Guest OS Identifier. For ESX, refer to VMware documentation [link](https://www.vmware.com/support/developer/converter-sdk/conv43_apireference/vim.vm.GuestOsDescriptor.GuestOsIdentifier.html) for the list of guest OS identifiers.
        """
        return pulumi.get(self, "guest_os_id")
    ...
    @property
    @pulumi.getter(name="hardwareClockTimezone")
    def hardware_clock_timezone(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) VM's hardware clock timezone in IANA TZDB format (America/Los_Angeles).
        """
        return pulumi.get(self, "hardware_clock_timezone")
    ...
    @property
    @pulumi.getter(name="hostReference")
    def host_reference(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - Reference to a host.
        """
        return pulumi.get(self, "host_reference")
    ...
    @property
    @pulumi.getter(name="hypervisorType")
    def hypervisor_type(self) -> pulumi.Output[builtins.str]:
        """
        - The hypervisor type for the hypervisor the VM is hosted on.
        """
        return pulumi.get(self, "hypervisor_type")
    ...
    @property
    @pulumi.getter(name="isVcpuHardPinned")
    def is_vcpu_hard_pinned(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional) Add true to enable CPU pinning.
        """
        return pulumi.get(self, "is_vcpu_hard_pinned")
    ...
    @property
    @pulumi.getter(name="memorySizeMib")
    def memory_size_mib(self) -> pulumi.Output[builtins.int]:
        """
        - (Optional) Memory size in MiB. On updating memory to powered ON VMs should only be done in 1GB increments.
        """
        return pulumi.get(self, "memory_size_mib")
    ...
    @property
    @pulumi.getter(name="ngtCredentials")
    def ngt_credentials(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Ooptional) Credentials to login server.
        """
        return pulumi.get(self, "ngt_credentials")
    ...
    @property
    @pulumi.getter(name="ngtEnabledCapabilityLists")
    def ngt_enabled_capability_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Application names that are enabled.
        """
        return pulumi.get(self, "ngt_enabled_capability_lists")
    ...
    @property
    @pulumi.getter(name="numSockets")
    def num_sockets(self) -> pulumi.Output[builtins.int]:
        """
        - (Optional) Number of vCPU sockets.
        """
        return pulumi.get(self, "num_sockets")
    ...
    @property
    @pulumi.getter(name="numVcpusPerSocket")
    def num_vcpus_per_socket(self) -> pulumi.Output[builtins.int]:
        """
        - (Optional) Number of vCPUs per socket.
        """
        return pulumi.get(self, "num_vcpus_per_socket")
    ...
    @property
    @pulumi.getter(name="numVnumaNodes")
    def num_vnuma_nodes(self) -> pulumi.Output[builtins.int]:
        """
        - (Optional) Number of vNUMA nodes. 0 means vNUMA is disabled.
        """
        return pulumi.get(self, "num_vnuma_nodes")
    ...
    @property
    @pulumi.getter(name="nutanixGuestTools")
    def nutanix_guest_tools(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) Information regarding Nutanix Guest Tools.
        """
        return pulumi.get(self, "nutanix_guest_tools")
    ...
    @property
    @pulumi.getter(name="parentReference")
    def parent_reference(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        - (Optional) Reference to an entity that the VM cloned from.
        """
        return pulumi.get(self, "parent_reference")
    ...
    @property
    @pulumi.getter(name="powerStateMechanism")
    def power_state_mechanism(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) Indicates the mechanism guiding the VM power state transition. Currently used for the transition to \\"OFF\\" state. Power state mechanism (ACPI/GUEST/HARD).
        """
        return pulumi.get(self, "power_state_mechanism")
    ...
    @property
    @pulumi.getter(name="shouldFailOnScriptFailure")
    def should_fail_on_script_failure(self) -> pulumi.Output[builtins.bool]:
        """
        - (Optional)  Extra configs related to power state transition. Indicates whether to abort ngt shutdown/reboot if script fails.
        """
        return pulumi.get(self, "should_fail_on_script_failure")
    ...
    @property
    @pulumi.getter(name="useHotAdd")
    def use_hot_add(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional) Use Hot Add when modifying VM resources. Passing value false will result in VM reboots. Default value is `true`.
        """
        return pulumi.get(self, "use_hot_add")
    ...
    @property
    @pulumi.getter(name="vgaConsoleEnabled")
    def vga_console_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        - (Optional) Indicates whether VGA console should be enabled or not.
        """
        return pulumi.get(self, "vga_console_enabled")
