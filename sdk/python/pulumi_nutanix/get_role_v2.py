...
class GetRoleV2Result:
    ...
    def accessible_clients(self) -> Sequence[builtins.str]:
        """
    ...
    def accessible_entity_types(self) -> Sequence[builtins.str]:
        """
    ...
    def assigned_users_count(self) -> builtins.int:
        """
    ...
    def assigned_users_groups_count(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter
    def operations(self) -> Sequence[builtins.str]:
        """
...
def get_role_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: - (Required) ExtId for the Role.
    """
    __args__ = dict()
...
def get_role_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
