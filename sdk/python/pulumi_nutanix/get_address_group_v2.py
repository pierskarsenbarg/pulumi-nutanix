...
class GetAddressGroupV2Result:
    ...
    def policy_references(self) -> Sequence[builtins.str]:
        """
...
def get_address_group_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: Address group UUID.
...
def get_address_group_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
