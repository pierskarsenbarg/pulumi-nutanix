...
class GetSubnetResult:
    ...
    def default_gateway_ip(self) -> builtins.str:
        """
    ...
    def dhcp_domain_name_server_lists(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "dhcp_domain_name_server_lists")

    @property
    @pulumi.getter(name="dhcpDomainSearchLists")
    def dhcp_domain_search_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def dhcp_options(self) -> Mapping[str, builtins.str]:
        """
    ...
    def dhcp_server_address(self) -> Mapping[str, builtins.str]:
        """
        Host address.
        """
    ...
    def dhcp_server_address_port(self) -> builtins.int:
        """
        Port Number.
        """
    ...
    def enable_nat(self) -> builtins.bool:
    ...
    def ip_config_pool_list_ranges(self) -> Sequence[builtins.str]:
    ...
    def network_function_chain_reference(self) -> Mapping[str, builtins.str]:
        """
    ...
    def subnet_type(self) -> builtins.str:
        """
    ...
    def vpc_reference(self) -> Mapping[str, builtins.str]:
        return pulumi.get(self, "vpc_reference")

    @property
    @pulumi.getter(name="vswitchName")
    def vswitch_name(self) -> builtins.str:
        """
...
def get_subnet(additional_filters: Optional[Sequence[Union['GetSubnetAdditionalFilterArgs', 'GetSubnetAdditionalFilterArgsDict']]] = None,
    ...
    :param builtins.str subnet_id: - (Optional) The ID for the subnet.
    :param builtins.str subnet_name: - (Optional) The name for the subnet
    """
    __args__ = dict()
