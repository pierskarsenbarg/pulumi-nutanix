...
def get_karbon_cluster(karbon_cluster_id: Optional[builtins.str] = None,
                       karbon_cluster_name: Optional[builtins.str] = None,
    ...
    :param builtins.str karbon_cluster_id: Represents karbon cluster uuid
    :param builtins.str karbon_cluster_name: Represents the name of karbon cluster
    """
    __args__ = dict()
...
def get_karbon_cluster_output(karbon_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              karbon_cluster_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
