...
class SamlIdentityProvidersV2Args:
    def __init__(__self__, *,
                 custom_attributes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 email_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 entity_issuer: Optional[pulumi.Input[builtins.str]] = None,
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 groups_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 groups_delim: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_signed_authn_req_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 username_attribute: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def custom_attributes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "custom_attributes")

    @custom_attributes.setter
    def custom_attributes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "custom_attributes", value)

    @property
    @pulumi.getter(name="emailAttribute")
    def email_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "email_attribute")

    @email_attribute.setter
    def email_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_attribute", value)

    @property
    @pulumi.getter(name="entityIssuer")
    def entity_issuer(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "entity_issuer")

    @entity_issuer.setter
    def entity_issuer(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def groups_delim(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "groups_delim")

    @groups_delim.setter
    def groups_delim(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_signed_authn_req_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "is_signed_authn_req_enabled")

    @is_signed_authn_req_enabled.setter
    def is_signed_authn_req_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def username_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "username_attribute")

    @username_attribute.setter
    def username_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SamlIdentityProvidersV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            last_updated_time: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            username_attribute: Optional[pulumi.Input[builtins.str]] = None) -> 'SamlIdentityProvidersV2':
        """
    ...
    @property
    @pulumi.getter(name="customAttributes")
    def custom_attributes(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "custom_attributes")

    @property
    @pulumi.getter(name="emailAttribute")
    def email_attribute(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "email_attribute")

    @property
    @pulumi.getter(name="entityIssuer")
    def entity_issuer(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "entity_issuer")
    ...
    @property
    @pulumi.getter(name="groupsDelim")
    def groups_delim(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "groups_delim")

    @property
    @pulumi.getter(name="idpMetadataUrl")
    def idp_metadata_url(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "idp_metadata_url")

    @property
    @pulumi.getter(name="idpMetadataXml")
    def idp_metadata_xml(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "idp_metadata_xml")
    ...
    @property
    @pulumi.getter(name="isSignedAuthnReqEnabled")
    def is_signed_authn_req_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "is_signed_authn_req_enabled")
    ...
    @property
    @pulumi.getter(name="usernameAttribute")
    def username_attribute(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "username_attribute")
