...
class VmNetworkDeviceMigrateV2Args:
    def __init__(__self__, *,
                 ...
                 migrate_type: pulumi.Input[builtins.str],
    ...
    def migrate_type(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "migrate_type")

    @migrate_type.setter
    def migrate_type(self, value: pulumi.Input[builtins.str]):
...
class _VmNetworkDeviceMigrateV2State:
    def __init__(__self__, *,
                 ...
                 ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input['VmNetworkDeviceMigrateV2IpAddressArgs']]]] = None,
                 migrate_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="migrateType")
    def migrate_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "migrate_type")

    @migrate_type.setter
    def migrate_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "migrate_type", value)
...
class VmNetworkDeviceMigrateV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            migrate_type: Optional[pulumi.Input[builtins.str]] = None,
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VmNetworkDeviceMigrateV2SubnetArgs', 'VmNetworkDeviceMigrateV2SubnetArgsDict']]]]] = None,
            vm_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VmNetworkDeviceMigrateV2':
        """
    ...
    @property
    @pulumi.getter(name="migrateType")
    def migrate_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "migrate_type")
