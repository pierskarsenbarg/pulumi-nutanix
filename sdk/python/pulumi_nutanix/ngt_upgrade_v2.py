...
__all__ = ['NgtUpgradeV2Args', 'NgtUpgradeV2']

@pulumi.input_type
class NgtUpgradeV2Args:
    def __init__(__self__, *,
                 ext_id: pulumi.Input[builtins.str],
    ...
    def ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ext_id.setter
    def ext_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ext_id", value)

    @property
    @pulumi.getter(name="rebootPreference")
    def reboot_preference(self) -> Optional[pulumi.Input['NgtUpgradeV2RebootPreferenceArgs']]:
        """
    ...
    def reboot_preference(self, value: Optional[pulumi.Input['NgtUpgradeV2RebootPreferenceArgs']]):
        pulumi.set(self, "reboot_preference", value)


@pulumi.input_type
class _NgtUpgradeV2State:
    def __init__(__self__, *,
                 available_version: Optional[pulumi.Input[builtins.str]] = None,
                 capablities: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 guest_os_version: Optional[pulumi.Input[builtins.str]] = None,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_installed: Optional[pulumi.Input[builtins.bool]] = None,
                 is_iso_inserted: Optional[pulumi.Input[builtins.bool]] = None,
                 is_reachable: Optional[pulumi.Input[builtins.bool]] = None,
                 is_vm_mobility_drivers_installed: Optional[pulumi.Input[builtins.bool]] = None,
                 is_vss_snapshot_capable: Optional[pulumi.Input[builtins.bool]] = None,
                 reboot_preference: Optional[pulumi.Input['NgtUpgradeV2RebootPreferenceArgs']] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering NgtUpgradeV2 resources.
        :param pulumi.Input[builtins.str] available_version: Version of Nutanix Guest Tools available on the cluster.
        ...
        :param pulumi.Input[builtins.str] ext_id: uuid of the Virtual Machine.
        :param pulumi.Input[builtins.str] guest_os_version: Version of the operating system on the VM.
        :param pulumi.Input[builtins.bool] is_enabled: Indicates whether Nutanix Guest Tools is enabled or not.
        :param pulumi.Input[builtins.bool] is_installed: Indicates whether Nutanix Guest Tools is installed on the VM or not.
        :param pulumi.Input[builtins.bool] is_iso_inserted: Indicates whether Nutanix Guest Tools ISO is inserted or not.
        :param pulumi.Input[builtins.bool] is_reachable: Indicates whether the communication from VM to CVM is active or not.
        :param pulumi.Input[builtins.bool] is_vm_mobility_drivers_installed: Indicates whether the VM mobility drivers are installed on the VM or not.
        :param pulumi.Input[builtins.bool] is_vss_snapshot_capable: Indicates whether the VM is configured to take VSS snapshots through NGT or not.
        :param pulumi.Input['NgtUpgradeV2RebootPreferenceArgs'] reboot_preference: The restart schedule after installing or upgrading Nutanix Guest Tools.
        :param pulumi.Input[builtins.str] version: Version of Nutanix Guest Tools installed on the VM.
        """
    ...
    def available_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def available_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "available_version", value)

    @property
    @pulumi.getter
    def capablities(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @capablities.setter
    def capablities(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def guest_os_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def guest_os_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_installed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_installed.setter
    def is_installed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_installed", value)

    @property
    @pulumi.getter(name="isIsoInserted")
    def is_iso_inserted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_iso_inserted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_iso_inserted", value)

    @property
    @pulumi.getter(name="isReachable")
    def is_reachable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_reachable.setter
    def is_reachable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_reachable", value)

    @property
    @pulumi.getter(name="isVmMobilityDriversInstalled")
    def is_vm_mobility_drivers_installed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vm_mobility_drivers_installed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_vm_mobility_drivers_installed", value)

    @property
    @pulumi.getter(name="isVssSnapshotCapable")
    def is_vss_snapshot_capable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vss_snapshot_capable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class NgtUpgradeV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 reboot_preference: Optional[pulumi.Input[Union['NgtUpgradeV2RebootPreferenceArgs', 'NgtUpgradeV2RebootPreferenceArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NgtUpgradeV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NgtUpgradeV2Args.__new__(NgtUpgradeV2Args)
            ...
            __props__.__dict__["capablities"] = None
        ...
        super(NgtUpgradeV2, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            is_vss_snapshot_capable: Optional[pulumi.Input[builtins.bool]] = None,
            reboot_preference: Optional[pulumi.Input[Union['NgtUpgradeV2RebootPreferenceArgs', 'NgtUpgradeV2RebootPreferenceArgsDict']]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'NgtUpgradeV2':
        """
        ...
        __props__ = _NgtUpgradeV2State.__new__(_NgtUpgradeV2State)
        ...
        return NgtUpgradeV2(resource_name, opts=opts, __props__=__props__)

    @property
    @pulumi.getter(name="availableVersion")
    def available_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of Nutanix Guest Tools available on the cluster.
        """
        return pulumi.get(self, "available_version")
    ...
    @property
    @pulumi.getter
    def capablities(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of the application names that are enabled on the guest VM. [`SELF_SERVICE_RESTORE`, `VSS_SNAPSHOT`]
        """
        return pulumi.get(self, "capablities")
    ...
    @property
    @pulumi.getter(name="guestOsVersion")
    def guest_os_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the operating system on the VM.
        """
        return pulumi.get(self, "guest_os_version")
    ...
    @property
    @pulumi.getter(name="isInstalled")
    def is_installed(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether Nutanix Guest Tools is installed on the VM or not.
        """
        return pulumi.get(self, "is_installed")
    ...
    @property
    @pulumi.getter(name="isIsoInserted")
    def is_iso_inserted(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether Nutanix Guest Tools ISO is inserted or not.
        """
        return pulumi.get(self, "is_iso_inserted")
    ...
    @property
    @pulumi.getter(name="isReachable")
    def is_reachable(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the communication from VM to CVM is active or not.
        """
        return pulumi.get(self, "is_reachable")
    ...
    @property
    @pulumi.getter(name="isVmMobilityDriversInstalled")
    def is_vm_mobility_drivers_installed(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VM mobility drivers are installed on the VM or not.
        """
        return pulumi.get(self, "is_vm_mobility_drivers_installed")
    ...
    @property
    @pulumi.getter(name="isVssSnapshotCapable")
    def is_vss_snapshot_capable(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VM is configured to take VSS snapshots through NGT or not.
        """
        return pulumi.get(self, "is_vss_snapshot_capable")
    ...
    @property
    @pulumi.getter(name="rebootPreference")
    def reboot_preference(self) -> pulumi.Output[Optional['outputs.NgtUpgradeV2RebootPreference']]:
        """
        The restart schedule after installing or upgrading Nutanix Guest Tools.
        """
        return pulumi.get(self, "reboot_preference")
