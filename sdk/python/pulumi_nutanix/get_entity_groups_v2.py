...
__all__ = [
    'GetEntityGroupsV2Result',
    'AwaitableGetEntityGroupsV2Result',
    'get_entity_groups_v2',
    'get_entity_groups_v2_output',
]

@pulumi.output_type
class GetEntityGroupsV2Result:
    """
    A collection of values returned by getEntityGroupsV2.
    """
    def __init__(__self__, entity_groups=None, filter=None, id=None, limit=None, order_by=None, page=None, select=None):
    ...
    def entity_groups(self) -> Sequence['outputs.GetEntityGroupsV2EntityGroupResult']:
        """
...
class AwaitableGetEntityGroupsV2Result(GetEntityGroupsV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetEntityGroupsV2Result(
...
def get_entity_groups_v2(filter: Optional[_builtins.str] = None,
                         limit: Optional[_builtins.int] = None,
                         order_by: Optional[_builtins.str] = None,
                         page: Optional[_builtins.int] = None,
                         select: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEntityGroupsV2Result:
    """
    Retrieves a list of entity groups. Use this data source when you need to list or filter entity groups rather than fetch a single group by `ext_id` (use the `EntityGroupV2` data source for that).
    ...
    :param _builtins.str filter: A URL query parameter that allows clients to filter a collection of resources. The expression must conform to OData V4.01 URL conventions. The filter can be applied to the following fields:
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getEntityGroupsV2:getEntityGroupsV2', __args__, opts=opts, typ=GetEntityGroupsV2Result).value

    return AwaitableGetEntityGroupsV2Result(
...
def get_entity_groups_v2_output(filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEntityGroupsV2Result]:
    """
    Retrieves a list of entity groups. Use this data source when you need to list or filter entity groups rather than fetch a single group by `ext_id` (use the `EntityGroupV2` data source for that).
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getEntityGroupsV2:getEntityGroupsV2', __args__, opts=opts, typ=GetEntityGroupsV2Result)
    return __ret__.apply(lambda __response__: GetEntityGroupsV2Result(
