...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 foundation_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 foundation_port: Optional[pulumi.Input[builtins.str]] = None,
                 insecure: Optional[pulumi.Input[builtins.bool]] = None,
                 ndb_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ndb_password: Optional[pulumi.Input[builtins.str]] = None,
                 ndb_username: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 port: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_url: Optional[pulumi.Input[builtins.str]] = None,
                 session_auth: Optional[pulumi.Input[builtins.bool]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None,
                 wait_timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[builtins.str] endpoint: URL for Nutanix Prism (e.g IP or FQDN for cluster VIP note, this is never the data services VIP, and should not be an
               individual CVM address, as this would cause calls to fail during cluster lifecycle management operations, such as AOS
               upgrades.
        :param pulumi.Input[builtins.str] foundation_endpoint: endpoint for foundation VM (eg. Foundation VM IP)
        :param pulumi.Input[builtins.str] foundation_port: Port for foundation VM
        ...
        :param pulumi.Input[builtins.str] ndb_endpoint: endpoint for Era VM (era ip)
        :param pulumi.Input[builtins.str] password: Password for provided user name.
        :param pulumi.Input[builtins.str] port: Port for Nutanix Prism.
        :param pulumi.Input[builtins.bool] session_auth: Use session authentification instead of basic auth for each request
        :param pulumi.Input[builtins.str] username: User name for Nutanix Prism. Could be local cluster auth (e.g. 'admin') or directory auth.
        :param pulumi.Input[builtins.int] wait_timeout: Set if you know that the creation o update of a resource may take long time (minutes)
        """
    ...
    def foundation_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def foundation_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "foundation_endpoint", value)

    @property
    @pulumi.getter(name="foundationPort")
    def foundation_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def foundation_port(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ndb_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ndb_endpoint.setter
    def ndb_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ndb_endpoint", value)

    @property
    @pulumi.getter(name="ndbPassword")
    def ndb_password(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ndb_password")

    @ndb_password.setter
    def ndb_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ndb_password", value)

    @property
    @pulumi.getter(name="ndbUsername")
    def ndb_username(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ndb_username")

    @ndb_username.setter
    def ndb_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def session_auth(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @session_auth.setter
    def session_auth(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="foundationEndpoint")
    def foundation_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        endpoint for foundation VM (eg. Foundation VM IP)
        """
        return pulumi.get(self, "foundation_endpoint")
    ...
    @property
    @pulumi.getter(name="foundationPort")
    def foundation_port(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Port for foundation VM
        """
        return pulumi.get(self, "foundation_port")
    ...
    @property
    @pulumi.getter(name="ndbEndpoint")
    def ndb_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        endpoint for Era VM (era ip)
        """
        return pulumi.get(self, "ndb_endpoint")
    ...
    @property
    @pulumi.getter(name="ndbPassword")
    def ndb_password(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "ndb_password")

    @property
    @pulumi.getter(name="ndbUsername")
    def ndb_username(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "ndb_username")
