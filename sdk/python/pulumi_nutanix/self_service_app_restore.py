...
class SelfServiceAppRestoreArgs:
    def __init__(__self__, *,
                 restore_action_name: pulumi.Input[builtins.str],
                 snapshot_uuid: pulumi.Input[builtins.str],
                 app_name: Optional[pulumi.Input[builtins.str]] = None,
                 app_uuid: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SelfServiceAppRestore resource.
        :param pulumi.Input[builtins.str] restore_action_name: - (Required) The name of the restore action to be performed.
        :param pulumi.Input[builtins.str] snapshot_uuid: - (Required) The UUID of the snapshot to which the application will be restored.
               
               Both (`app_name` and `app_uuid`) are optional but atleast one of them should be provided for resource to work.
        :param pulumi.Input[builtins.str] app_name: - (Optional) The name of the application
        :param pulumi.Input[builtins.str] app_uuid: - (Optional) The UUID of the application.
        """
    ...
    def restore_action_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def restore_action_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "restore_action_name", value)

    @property
    @pulumi.getter(name="snapshotUuid")
    def snapshot_uuid(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def snapshot_uuid(self, value: pulumi.Input[builtins.str]):
    ...
    def app_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @app_uuid.setter
    def app_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SelfServiceAppRestoreState:
    def __init__(__self__, *,
                 app_name: Optional[pulumi.Input[builtins.str]] = None,
                 app_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 restore_action_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] snapshot_uuid: - (Required) The UUID of the snapshot to which the application will be restored.
               ...
               Both (`app_name` and `app_uuid`) are optional but atleast one of them should be provided for resource to work.
        :param pulumi.Input[builtins.str] state: - (Computed) This will be set after the restore action has been processed.
        """
        if app_name is not None:
            pulumi.set(__self__, "app_name", app_name)
        if app_uuid is not None:
    ...
    @property
    @pulumi.getter(name="restoreActionName")
    def restore_action_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        - (Required) The name of the restore action to be performed.
        """
        return pulumi.get(self, "restore_action_name")
    ...
    @restore_action_name.setter
    def restore_action_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_action_name", value)
...
class SelfServiceAppRestore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            restore_action_name: Optional[pulumi.Input[builtins.str]] = None,
            snapshot_uuid: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'SelfServiceAppRestore':
        """
    ...
    @property
    @pulumi.getter(name="appUuid")
    def app_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        - (Optional) The UUID of the application.
        """
        return pulumi.get(self, "app_uuid")
    ...
    @property
    @pulumi.getter(name="restoreActionName")
    def restore_action_name(self) -> pulumi.Output[builtins.str]:
        """
        - (Required) The name of the restore action to be performed.
        """
        return pulumi.get(self, "restore_action_name")
