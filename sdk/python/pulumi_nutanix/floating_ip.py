...
class FloatingIpArgs:
    def __init__(__self__, *,
                 ...
                 external_subnet_reference_name: Optional[pulumi.Input[builtins.str]] = None,
                 external_subnet_reference_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 private_ip: Optional[pulumi.Input[builtins.str]] = None,
                 vm_nic_reference_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_reference_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] external_subnet_reference_name: The reference to a subnet. Should not be used with 
               {external_subnet_reference_uuid} .
        :param pulumi.Input[builtins.str] external_subnet_reference_uuid: The reference to a subnet. Should not be used with {external_subnet_reference_name} .
        :param pulumi.Input[builtins.str] private_ip: Private IP with which floating IP is associated. Should be used with vpc_reference .
        :param pulumi.Input[builtins.str] vm_nic_reference_uuid: The reference to a vm_nic .
        :param pulumi.Input[builtins.str] vpc_reference_name: The reference to a vpc. Should not be used with {vpc_reference_uuid}.
        :param pulumi.Input[builtins.str] vpc_reference_uuid: The reference to a vpc. Should not be used with {vpc_reference_name}.
        """
    ...
    def external_subnet_reference_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_subnet_reference_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_subnet_reference_name", value)

    @property
    @pulumi.getter(name="externalSubnetReferenceUuid")
    def external_subnet_reference_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_subnet_reference_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vm_nic_reference_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vm_nic_reference_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vm_nic_reference_uuid", value)

    @property
    @pulumi.getter(name="vpcReferenceName")
    def vpc_reference_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpc_reference_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FloatingIpState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] external_subnet_reference_name: The reference to a subnet. Should not be used with 
               {external_subnet_reference_uuid} .
        :param pulumi.Input[builtins.str] external_subnet_reference_uuid: The reference to a subnet. Should not be used with {external_subnet_reference_name} .
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The floating_ips kind metadata.
        :param pulumi.Input[builtins.str] private_ip: Private IP with which floating IP is associated. Should be used with vpc_reference .
        :param pulumi.Input[builtins.str] vm_nic_reference_uuid: The reference to a vm_nic .
        :param pulumi.Input[builtins.str] vpc_reference_name: The reference to a vpc. Should not be used with {vpc_reference_uuid}.
        :param pulumi.Input[builtins.str] vpc_reference_uuid: The reference to a vpc. Should not be used with {vpc_reference_name}.
...
class FloatingIp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vm_nic_reference_uuid: Optional[pulumi.Input[builtins.str]] = None,
            vpc_reference_name: Optional[pulumi.Input[builtins.str]] = None,
            vpc_reference_uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'FloatingIp':
        """
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceName")
    def external_subnet_reference_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The reference to a subnet. Should not be used with 
        {external_subnet_reference_uuid} .
        """
    ...
    @property
    @pulumi.getter(name="externalSubnetReferenceUuid")
    def external_subnet_reference_uuid(self) -> pulumi.Output[builtins.str]:
        """
        The reference to a subnet. Should not be used with {external_subnet_reference_name} .
        """
        return pulumi.get(self, "external_subnet_reference_uuid")
    ...
    @property
    @pulumi.getter(name="vmNicReferenceUuid")
    def vm_nic_reference_uuid(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The reference to a vm_nic .
        """
        return pulumi.get(self, "vm_nic_reference_uuid")
    ...
    @property
    @pulumi.getter(name="vpcReferenceName")
    def vpc_reference_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The reference to a vpc. Should not be used with {vpc_reference_uuid}.
        """
        return pulumi.get(self, "vpc_reference_name")
