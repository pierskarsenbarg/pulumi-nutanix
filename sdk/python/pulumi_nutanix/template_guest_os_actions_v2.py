...
class TemplateGuestOsActionsV2Args:
    def __init__(__self__, *,
                 ...
                 is_active_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ext_id: The identifier of a Template.
    ...
    def is_active_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def is_active_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TemplateGuestOsActionsV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version_description: Optional[pulumi.Input[builtins.str]] = None,
            version_id: Optional[pulumi.Input[builtins.str]] = None,
            version_name: Optional[pulumi.Input[builtins.str]] = None) -> 'TemplateGuestOsActionsV2':
        """
    ...
    @property
    @pulumi.getter(name="isActiveVersion")
    def is_active_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specify whether to mark the Template Version as active or not. The newly created Version during Template Creation, Updating or Guest OS Updating is set to Active by default unless specified otherwise. Default is true. Only applicable with `complete` action.
