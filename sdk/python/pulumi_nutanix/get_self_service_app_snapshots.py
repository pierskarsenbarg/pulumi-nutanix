...
class GetSelfServiceAppSnapshotsResult:
    ...
    def app_uuid(self) -> Optional[builtins.str]:
    ...
    def total_matches(self) -> builtins.int:
        """
...
def get_self_service_app_snapshots(app_name: Optional[builtins.str] = None,
                                   app_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str app_name: - (Optional) The name of the application.
    :param builtins.str app_uuid: - (Optional) The UUID of the application.
           
           Both (`app_name` and `app_uuid`) are optional but atleast one of them to be provided for this data source to work.
    :param builtins.int length: - (Required) The number of snapshots to retrieve.
    :param builtins.int offset: - (Required) The index of the first snapshot to return (for pagination). Default value: 0
    """
    __args__ = dict()
...
def get_self_service_app_snapshots_output(app_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          app_uuid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
