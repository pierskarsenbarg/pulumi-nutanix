...
class GetFoundationCentralApiKeysResult:
    ...
    def key_uuid(self) -> builtins.str:
        """
        UUID of the api key.
        """
...
def get_foundation_central_api_keys(key_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str key_uuid: UUID of the key which needs to be fetched.
    """
    __args__ = dict()
...
def get_foundation_central_api_keys_output(key_uuid: Optional[pulumi.Input[builtins.str]] = None,
