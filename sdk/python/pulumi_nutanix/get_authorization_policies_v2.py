...
def get_authorization_policies_v2(expand: Optional[builtins.str] = None,
...
def get_authorization_policies_v2_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
