...
class GetRolesResult:
    ...
    @property
    @pulumi.getter
    def entities(self) -> Sequence['outputs.GetRolesEntityResult']:
        """
        List of Roles
        """
    ...
    @property
    @pulumi.getter
    def metadatas(self) -> Sequence['outputs.GetRolesMetadataResult']:
        """
...
def get_roles(metadatas: Optional[Sequence[Union['GetRolesMetadataArgs', 'GetRolesMetadataArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getRoles:getRoles', __args__, opts=opts, typ=GetRolesResult).value
...
def get_roles_output(metadatas: Optional[pulumi.Input[Optional[Sequence[Union['GetRolesMetadataArgs', 'GetRolesMetadataArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getRoles:getRoles', __args__, opts=opts, typ=GetRolesResult)
