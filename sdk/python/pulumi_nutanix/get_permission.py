...
class GetPermissionResult:
    ...
    def permission_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "permission_id")

    @property
    @pulumi.getter(name="permissionName")
    def permission_name(self) -> Optional[builtins.str]:
...
def get_permission(categories: Optional[Sequence[Union['GetPermissionCategoryArgs', 'GetPermissionCategoryArgsDict']]] = None,
                   permission_id: Optional[builtins.str] = None,
                   permission_name: Optional[builtins.str] = None,
    ...
    :param builtins.str permission_id: The `id` of the permission.
    :param builtins.str permission_name: The `name` of the permission.
    """
    __args__ = dict()
...
def get_permission_output(categories: Optional[pulumi.Input[Optional[Sequence[Union['GetPermissionCategoryArgs', 'GetPermissionCategoryArgsDict']]]]] = None,
                          permission_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          permission_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
