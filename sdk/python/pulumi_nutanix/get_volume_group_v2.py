...
class GetVolumeGroupV2Result:
    ...
    def enabled_authentications(self) -> builtins.str:
        """
    ...
    def sharing_status(self) -> builtins.str:
        """
    ...
    def should_load_balance_vm_attachments(self) -> builtins.bool:
        """
...
def get_volume_group_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: - A globally unique identifier of an instance that is suitable for external consumption.
    """
    __args__ = dict()
...
def get_volume_group_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
