...
class GetClusterV2Result:
    ...
    def backup_eligibility_score(self) -> builtins.int:
        """
    ...
    def cluster_profile_ext_id(self) -> builtins.str:
        """
    ...
    def inefficient_vm_count(self) -> builtins.int:
        """
...
def get_cluster_v2(expand: Optional[builtins.str] = None,
    ...
    :param builtins.str expand: -(Optional) A URL query parameter that allows clients to request related resources when a resource that satisfies a particular request is retrieved. Each expanded item is evaluated relative to the entity containing the property being expanded. Other query options can be applied to an expanded property by appending a semicolon-separated list of query options, enclosed in parentheses, to the property name.
           ...
           - "clusterProfile".
           - "storageSummary".
    :param builtins.str ext_id: -(Required) Represents clusters uuid
    """
    __args__ = dict()
...
def get_cluster_v2_output(expand: Optional[pulumi.Input[Optional[builtins.str]]] = None,
