...
class NdbAuthorizeDbserverArgs:
    def __init__(__self__, *,
                 dbservers_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] time_machine_name: * `dbservers_id `: (Required)
        """
    ...
    def dbservers_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "dbservers_ids")

    @dbservers_ids.setter
    def dbservers_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class NdbAuthorizeDbserver(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dbservers_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_machine_id: Optional[pulumi.Input[builtins.str]] = None,
            time_machine_name: Optional[pulumi.Input[builtins.str]] = None) -> 'NdbAuthorizeDbserver':
        """
    ...
    @property
    @pulumi.getter(name="dbserversIds")
    def dbservers_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "dbservers_ids")
