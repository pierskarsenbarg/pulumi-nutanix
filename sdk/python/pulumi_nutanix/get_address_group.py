...
class GetAddressGroupResult:
    ...
    def address_group_string(self) -> builtins.str:
        """
...
def get_address_group(uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str uuid: - (Required) UUID of the address group
    """
    __args__ = dict()
    __args__['uuid'] = uuid
...
def get_address_group_output(uuid: Optional[pulumi.Input[builtins.str]] = None,
