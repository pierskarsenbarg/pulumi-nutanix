...
class PbrV2Args:
    def __init__(__self__, *,
                 ...
                 vpc_ext_id: pulumi.Input[builtins.str],
    ...
    def vpc_ext_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "vpc_ext_id")

    @vpc_ext_id.setter
    def vpc_ext_id(self, value: pulumi.Input[builtins.str]):
...
class _PbrV2State:
    def __init__(__self__, *,
                 ...
                 vpc_ext_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="vpcExtId")
    def vpc_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "vpc_ext_id")

    @vpc_ext_id.setter
    def vpc_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_ext_id", value)
...
class PbrV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcExtId")
    def vpc_ext_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "vpc_ext_id")
