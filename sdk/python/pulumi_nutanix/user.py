...
class _UserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['UserCategoryArgs']]] categories: - (Optional) Categories for the Access Control Policy.
        :param pulumi.Input['UserDirectoryServiceUserArgs'] directory_service_user: - (Optional) The directory service user configuration. See below for more information.
        :param pulumi.Input[builtins.str] display_name: - The display name of the user (common name) provided by the directory service.
        :param pulumi.Input['UserIdentityProviderUserArgs'] identity_provider_user: - (Optional) (Optional) The identity provider user configuration. See below for more information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: - The vm kind metadata.
        :param pulumi.Input[builtins.str] name: - the name(Optional).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] owner_reference: - (Optional) The reference to a user.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] project_reference: - (Optional) The reference to a project.
        ...
        :param pulumi.Input[builtins.str] state: - The state of the entity.
        :param pulumi.Input[builtins.str] user_type: - The name of the user.
        """
