...
class GetAuthorizationPolicyV2Result:
    ...
    def authorization_policy_type(self) -> builtins.str:
...
def get_authorization_policy_v2(ext_id: Optional[builtins.str] = None,
...
def get_authorization_policy_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
