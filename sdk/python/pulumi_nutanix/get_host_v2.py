...
class GetHostV2Result:
    ...
    def block_model(self) -> builtins.str:
        """
    ...
    def boot_time_usecs(self) -> builtins.int:
        """
        - Boot time in secs.
        """
    ...
    def cluster_ext_id(self) -> builtins.str:
    ...
    def cpu_capacity_hz(self) -> builtins.int:
        """
        - CPU capacity in Hz.
        """
    ...
    def cpu_frequency_hz(self) -> builtins.int:
        """
        - CPU frequency in Hz.
        """
    ...
    def default_vhd_container_uuid(self) -> builtins.str:
        """
    ...
    def default_vhd_location(self) -> builtins.str:
        """
    ...
    def default_vm_container_uuid(self) -> builtins.str:
        """
    ...
    def default_vm_location(self) -> builtins.str:
        """
        - Default VM location.
        """
    ...
    def failover_cluster_fqdn(self) -> builtins.str:
        """
    ...
    def failover_cluster_node_status(self) -> builtins.str:
        """
    ...
    def gpu_lists(self) -> Sequence[builtins.str]:
        """
        - GPU attached list.
        """
    ...
    def has_csr(self) -> builtins.bool:
        """
    ...
    def is_degraded(self) -> builtins.bool:
        """
    ...
    def is_hardware_virtualized(self) -> builtins.bool:
        """
    ...
    def is_reboot_pending(self) -> builtins.bool:
        return pulumi.get(self, "is_reboot_pending")

    @property
    @pulumi.getter(name="isSecureBooted")
    def is_secure_booted(self) -> builtins.bool:
        """
        - Secure boot status.
        """
    ...
    def maintenance_state(self) -> builtins.str:
        """
    ...
    def memory_size_bytes(self) -> builtins.int:
        """
    ...
    def number_of_cpu_cores(self) -> builtins.int:
        """
        - Number of CPU cores.
        """
    ...
    def number_of_cpu_sockets(self) -> builtins.int:
        """
    ...
    def number_of_cpu_threads(self) -> builtins.int:
        """
    ...
    def rackable_unit_uuid(self) -> builtins.str:
        """
        - Rackable unit UUID.
        """
...
def get_host_v2(cluster_ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_ext_id: - (Required) cluster uuid
    :param builtins.str ext_id: - (Required) host uuid
    """
    __args__ = dict()
...
def get_host_v2_output(cluster_ext_id: Optional[pulumi.Input[builtins.str]] = None,
