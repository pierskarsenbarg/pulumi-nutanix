...
def get_category_key(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: - (Required) The name for the category key.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_category_key_output(name: Optional[pulumi.Input[builtins.str]] = None,
