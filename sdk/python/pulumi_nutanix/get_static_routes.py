...
class GetStaticRoutesResult:
    ...
    def vpc_reference_uuid(self) -> Optional[builtins.str]:
...
def get_static_routes(vpc_name: Optional[builtins.str] = None,
                      vpc_reference_uuid: Optional[builtins.str] = None,
    ...
    :param builtins.str vpc_reference_uuid: vpc UUID
    """
    __args__ = dict()
...
def get_static_routes_output(vpc_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             vpc_reference_uuid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
