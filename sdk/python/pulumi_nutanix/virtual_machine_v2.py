...
class VirtualMachineV2Args:
    def __init__(__self__, *,
                 ...
                 bios_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 enabled_cpu_features: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 generation_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_agent_vm: Optional[pulumi.Input[builtins.bool]] = None,
                 is_branding_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_cpu_hotplug_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_cpu_passthrough_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_gpu_console_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_memory_overcommit_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_scsi_controller_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_vcpu_hard_pinning_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_vga_console_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 machine_type: Optional[pulumi.Input[builtins.str]] = None,
                 memory_size_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 num_numa_nodes: Optional[pulumi.Input[builtins.int]] = None,
                 num_sockets: Optional[pulumi.Input[builtins.int]] = None,
                 num_threads_per_core: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 protection_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bios_uuid: BIOS UUID of the VM. It should be of type UUID.
        ...
        :param pulumi.Input[builtins.str] description: VM description
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2DiskArgs']]] disks: Disks attached to the VM.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_cpu_features: The list of additional CPU features to be enabled. HardwareVirtualization: Indicates whether hardware assisted virtualization should be enabled for the Guest OS or not. Once enabled, the Guest OS can deploy a nested hypervisor. Valid values are "HARDWARE_VIRTUALIZATION".
        :param pulumi.Input[builtins.str] generation_uuid: Generation UUID of the VM. It should be of type UUID.
        ...
        :param pulumi.Input[builtins.str] hardware_clock_timezone: VM hardware clock timezone in IANA TZDB format (America/Los_Angeles).
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2HostArgs']]] hosts: Reference to the host, the VM is running on.
        :param pulumi.Input[builtins.bool] is_agent_vm: Indicates whether the VM is an agent VM or not. When their host enters maintenance mode, once the normal VMs are evacuated, the agent VMs are powered off. When the host is restored, agent VMs are powered on before the normal VMs are restored. In other words, agent VMs cannot be HA-protected or live migrated.
        :param pulumi.Input[builtins.bool] is_branding_enabled: Indicates whether to remove AHV branding from VM firmware tables or not.
        :param pulumi.Input[builtins.bool] is_cpu_hotplug_enabled: Indicates whether the VM CPU hotplug is enabled.
        :param pulumi.Input[builtins.bool] is_cpu_passthrough_enabled: Indicates whether to passthrough the host CPU features to the guest or not. Enabling this will make VM incapable of live migration.
        :param pulumi.Input[builtins.bool] is_gpu_console_enabled: Indicates whether the vGPU console is enabled or not.
        :param pulumi.Input[builtins.bool] is_memory_overcommit_enabled: Indicates whether the memory overcommit feature should be enabled for the VM or not. If enabled, parts of the VM memory may reside outside of the hypervisor physical memory. Once enabled, it should be expected that the VM may suffer performance degradation.
        :param pulumi.Input[builtins.bool] is_scsi_controller_enabled: Indicates whether the VM SCSI controller is enabled.
        :param pulumi.Input[builtins.bool] is_vcpu_hard_pinning_enabled: Indicates whether the vCPUs should be hard pinned to specific pCPUs or not.
        :param pulumi.Input[builtins.bool] is_vga_console_enabled: Indicates whether the VGA console should be disabled or not.
        :param pulumi.Input[builtins.str] machine_type: Machine type for the VM. Machine type Q35 is required for secure boot and does not support IDE disks. Valid values are "PSERIES", "Q35", "PC" .
        :param pulumi.Input[builtins.int] memory_size_bytes: Memory size in bytes.
        :param pulumi.Input[builtins.str] name: VM name.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2NicArgs']]] nics: NICs attached to the VM.
        :param pulumi.Input[builtins.int] num_cores_per_socket: Number of cores per socket. Value should be at least 1.
        :param pulumi.Input[builtins.int] num_numa_nodes: Number of NUMA nodes. 0 means NUMA is disabled.
        :param pulumi.Input[builtins.int] num_sockets: Number of vCPU sockets. Value should be at least 1.
        :param pulumi.Input[builtins.int] num_threads_per_core: Number of threads per core. Value should be at least 1.
        ...
        :param pulumi.Input[builtins.str] protection_type: The type of protection applied on a VM. Valid values "PD_PROTECTED", "UNPROTECTED", "RULE_PROTECTED".
    ...
    def bios_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bios_uuid.setter
    def bios_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enabled_cpu_features(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def enabled_cpu_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "enabled_cpu_features", value)

    @property
    @pulumi.getter(name="generationUuid")
    def generation_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def generation_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_agent_vm(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_agent_vm.setter
    def is_agent_vm(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_agent_vm", value)

    @property
    @pulumi.getter(name="isBrandingEnabled")
    def is_branding_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_branding_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_branding_enabled", value)

    @property
    @pulumi.getter(name="isCpuHotplugEnabled")
    def is_cpu_hotplug_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_cpu_hotplug_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_cpu_hotplug_enabled", value)

    @property
    @pulumi.getter(name="isCpuPassthroughEnabled")
    def is_cpu_passthrough_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_cpu_passthrough_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_cpu_passthrough_enabled", value)

    @property
    @pulumi.getter(name="isGpuConsoleEnabled")
    def is_gpu_console_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_gpu_console_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_gpu_console_enabled", value)

    @property
    @pulumi.getter(name="isMemoryOvercommitEnabled")
    def is_memory_overcommit_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_memory_overcommit_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_memory_overcommit_enabled", value)

    @property
    @pulumi.getter(name="isScsiControllerEnabled")
    def is_scsi_controller_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_scsi_controller_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_scsi_controller_enabled", value)

    @property
    @pulumi.getter(name="isVcpuHardPinningEnabled")
    def is_vcpu_hard_pinning_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vcpu_hard_pinning_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_vcpu_hard_pinning_enabled", value)

    @property
    @pulumi.getter(name="isVgaConsoleEnabled")
    def is_vga_console_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vga_console_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def memory_size_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def memory_size_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def num_numa_nodes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_numa_nodes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def num_threads_per_core(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_threads_per_core(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def protection_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def protection_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VirtualMachineV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2CdRomArgs']]] cd_roms: CD-ROMs attached to the VM.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2ClusterArgs']]] clusters: Reference to a cluster.
        :param pulumi.Input[builtins.str] create_time: VM creation time
        :param pulumi.Input[builtins.str] description: VM description
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2DiskArgs']]] disks: Disks attached to the VM.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_cpu_features: The list of additional CPU features to be enabled. HardwareVirtualization: Indicates whether hardware assisted virtualization should be enabled for the Guest OS or not. Once enabled, the Guest OS can deploy a nested hypervisor. Valid values are "HARDWARE_VIRTUALIZATION".
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2SourceArgs']]] sources: Reference to an entity that the VM should be cloned or created from. Valid values are "VM", "VM_RECOVERY_POINT".
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2StorageConfigArgs']]] storage_configs: Storage configuration for VM.
        :param pulumi.Input[builtins.str] update_time: VM last updated time.
        :param pulumi.Input[Sequence[pulumi.Input['VirtualMachineV2VtpmConfigArgs']]] vtpm_configs: Indicates how the vTPM for the VM should be configured.
        """
        if apc_configs is not None:
            pulumi.set(__self__, "apc_configs", apc_configs)
...
class VirtualMachineV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="biosUuid")
    def bios_uuid(self) -> pulumi.Output[builtins.str]:
        """
        BIOS UUID of the VM. It should be of type UUID.
        """
        return pulumi.get(self, "bios_uuid")
    ...
    @property
    @pulumi.getter(name="enabledCpuFeatures")
    def enabled_cpu_features(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of additional CPU features to be enabled. HardwareVirtualization: Indicates whether hardware assisted virtualization should be enabled for the Guest OS or not. Once enabled, the Guest OS can deploy a nested hypervisor. Valid values are "HARDWARE_VIRTUALIZATION".
        """
        return pulumi.get(self, "enabled_cpu_features")
    ...
    @property
    @pulumi.getter(name="generationUuid")
    def generation_uuid(self) -> pulumi.Output[builtins.str]:
        """
        Generation UUID of the VM. It should be of type UUID.
        """
        return pulumi.get(self, "generation_uuid")
    ...
    @property
    @pulumi.getter(name="isAgentVm")
    def is_agent_vm(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VM is an agent VM or not. When their host enters maintenance mode, once the normal VMs are evacuated, the agent VMs are powered off. When the host is restored, agent VMs are powered on before the normal VMs are restored. In other words, agent VMs cannot be HA-protected or live migrated.
        """
        return pulumi.get(self, "is_agent_vm")
    ...
    @property
    @pulumi.getter(name="isBrandingEnabled")
    def is_branding_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether to remove AHV branding from VM firmware tables or not.
        """
        return pulumi.get(self, "is_branding_enabled")
    ...
    @property
    @pulumi.getter(name="isCpuHotplugEnabled")
    def is_cpu_hotplug_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VM CPU hotplug is enabled.
        """
        return pulumi.get(self, "is_cpu_hotplug_enabled")
    ...
    @property
    @pulumi.getter(name="isCpuPassthroughEnabled")
    def is_cpu_passthrough_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether to passthrough the host CPU features to the guest or not. Enabling this will make VM incapable of live migration.
        """
        return pulumi.get(self, "is_cpu_passthrough_enabled")
    ...
    @property
    @pulumi.getter(name="isGpuConsoleEnabled")
    def is_gpu_console_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the vGPU console is enabled or not.
        """
        return pulumi.get(self, "is_gpu_console_enabled")
    ...
    @property
    @pulumi.getter(name="isMemoryOvercommitEnabled")
    def is_memory_overcommit_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the memory overcommit feature should be enabled for the VM or not. If enabled, parts of the VM memory may reside outside of the hypervisor physical memory. Once enabled, it should be expected that the VM may suffer performance degradation.
        """
        return pulumi.get(self, "is_memory_overcommit_enabled")
    ...
    @property
    @pulumi.getter(name="isScsiControllerEnabled")
    def is_scsi_controller_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VM SCSI controller is enabled.
        """
        return pulumi.get(self, "is_scsi_controller_enabled")
    ...
    @property
    @pulumi.getter(name="isVcpuHardPinningEnabled")
    def is_vcpu_hard_pinning_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the vCPUs should be hard pinned to specific pCPUs or not.
        """
        return pulumi.get(self, "is_vcpu_hard_pinning_enabled")
    ...
    @property
    @pulumi.getter(name="isVgaConsoleEnabled")
    def is_vga_console_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the VGA console should be disabled or not.
        """
        return pulumi.get(self, "is_vga_console_enabled")
    ...
    @property
    @pulumi.getter(name="memorySizeBytes")
    def memory_size_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Memory size in bytes.
        """
        return pulumi.get(self, "memory_size_bytes")
    ...
    @property
    @pulumi.getter(name="numNumaNodes")
    def num_numa_nodes(self) -> pulumi.Output[builtins.int]:
        """
        Number of NUMA nodes. 0 means NUMA is disabled.
        """
        return pulumi.get(self, "num_numa_nodes")
    ...
    @property
    @pulumi.getter(name="numThreadsPerCore")
    def num_threads_per_core(self) -> pulumi.Output[builtins.int]:
        """
        Number of threads per core. Value should be at least 1.
        """
        return pulumi.get(self, "num_threads_per_core")
    ...
    @property
    @pulumi.getter(name="protectionType")
    def protection_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of protection applied on a VM. Valid values "PD_PROTECTED", "UNPROTECTED", "RULE_PROTECTED".
        """
        return pulumi.get(self, "protection_type")
