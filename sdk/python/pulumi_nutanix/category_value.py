...
class CategoryValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: The value for the category value.
        :param pulumi.Input[builtins.str] description: - (Optional) A description for category value.
        :param pulumi.Input[builtins.str] name: - (Required) The category_key name for the category value.
        """
...
class _CategoryValueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_version: (Optional) The version of the API.
        :param pulumi.Input[builtins.str] description: - (Optional) A description for category value.
        :param pulumi.Input[builtins.str] name: - (Required) The category_key name for the category value.
        :param pulumi.Input[builtins.bool] system_defined: - Specifying whether its a system defined category.
        :param pulumi.Input[builtins.str] value: The value for the category value.
        """
...
class CategoryValue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            system_defined: Optional[pulumi.Input[builtins.bool]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'CategoryValue':
        """
    ...
    @property
    @pulumi.getter(name="systemDefined")
    def system_defined(self) -> pulumi.Output[builtins.bool]:
        """
        - Specifying whether its a system defined category.
        """
        return pulumi.get(self, "system_defined")
