...
class GetProtectedResourceV2Result:
    ...
    def category_fq_names(self) -> Sequence[builtins.str]:
        """
    ...
    def consistency_group_ext_id(self) -> builtins.str:
        """
    ...
    def entity_ext_id(self) -> builtins.str:
        """
...
def get_protected_resource_v2(ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: -(Required) The external identifier of a protected VM or volume group that can be used to retrieve the protected resource.
    """
    __args__ = dict()
...
def get_protected_resource_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
