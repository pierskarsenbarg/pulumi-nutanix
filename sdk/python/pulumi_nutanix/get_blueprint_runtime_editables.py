...
def get_blueprint_runtime_editables(bp_name: Optional[builtins.str] = None,
    ...
    :param builtins.str bp_name: - (Optional) The name of the blueprint for which runtime editables will be listed. If this is provided, it will return runtime editables for the specified blueprint.
           
           Both (`bp_uuid` and `bp_name`) are optional but atleast one of them to be provided for this data source to work.
    :param builtins.str bp_uuid: - (Optional) The UUID of the blueprint for which runtime editables will be listed. If this is provided, it will return runtime editables for the specified blueprint.
    """
    __args__ = dict()
...
def get_blueprint_runtime_editables_output(bp_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
