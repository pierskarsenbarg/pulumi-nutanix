...
def get_ndb_tags(entity_type: Optional[builtins.str] = None,
    ...
    :param builtins.str entity_type: entity for the tag to be associated with.
    """
    __args__ = dict()
...
def get_ndb_tags_output(entity_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
