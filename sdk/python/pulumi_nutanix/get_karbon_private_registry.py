...
class GetKarbonPrivateRegistryResult:
    ...
    def private_registry_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "private_registry_id")

    @property
    @pulumi.getter(name="privateRegistryName")
    def private_registry_name(self) -> Optional[builtins.str]:
...
def get_karbon_private_registry(private_registry_id: Optional[builtins.str] = None,
                                private_registry_name: Optional[builtins.str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKarbonPrivateRegistryResult:
    """
    Describes Karbon private registry entry


    :param builtins.str private_registry_id: Represents karbon private registry uuid
    :param builtins.str private_registry_name: Represents the name of karbon private registry
    """
    __args__ = dict()
...
def get_karbon_private_registry_output(private_registry_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       private_registry_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
