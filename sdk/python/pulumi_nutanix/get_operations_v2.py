...
__all__ = [
    'GetOperationsV2Result',
    'AwaitableGetOperationsV2Result',
    'get_operations_v2',
    'get_operations_v2_output',
]

@pulumi.output_type
class GetOperationsV2Result:
    """
    A collection of values returned by getOperationsV2.
    """
    def __init__(__self__, filter=None, id=None, limit=None, operations=None, order_by=None, page=None, select=None):
    ...
    @property
    @pulumi.getter
    def operations(self) -> Sequence['outputs.GetOperationsV2OperationResult']:
        """
...
class AwaitableGetOperationsV2Result(GetOperationsV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOperationsV2Result(
            filter=self.filter,
            id=self.id,
            limit=self.limit,
...
def get_operations_v2(filter: Optional[builtins.str] = None,
                      ...
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOperationsV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nutanix:index/getOperationsV2:getOperationsV2', __args__, opts=opts, typ=GetOperationsV2Result).value

    return AwaitableGetOperationsV2Result(
...
def get_operations_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('nutanix:index/getOperationsV2:getOperationsV2', __args__, opts=opts, typ=GetOperationsV2Result)
    return __ret__.apply(lambda __response__: GetOperationsV2Result(
