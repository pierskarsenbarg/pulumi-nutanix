...
__all__ = ['NdbScaleDatabaseArgs', 'NdbScaleDatabase']

@pulumi.input_type
class NdbScaleDatabaseArgs:
    def __init__(__self__, *,
                 application_type: pulumi.Input[builtins.str],
                 data_storage_size: pulumi.Input[builtins.int],
                 database_uuid: pulumi.Input[builtins.str],
                 post_script_cmd: Optional[pulumi.Input[builtins.str]] = None,
                 pre_script_cmd: Optional[pulumi.Input[builtins.str]] = None,
                 scale_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] application_type: type of instance. eg: postgres_database
        :param pulumi.Input[builtins.int] data_storage_size: data area (in GiB) to be added to the existing database.
        :param pulumi.Input[builtins.str] database_uuid: Database id
        :param pulumi.Input[builtins.str] post_script_cmd: post script command
        :param pulumi.Input[builtins.str] pre_script_cmd: pre script command
        :param pulumi.Input[builtins.int] scale_count: scale count helps to scale the same instance with same config
    ...
    def data_storage_size(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_storage_size(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_storage_size", value)

    @property
    @pulumi.getter(name="databaseUuid")
    def database_uuid(self) -> pulumi.Input[builtins.str]:
        """
        Database id
        """
    ...
    def database_uuid(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "database_uuid", value)

    @property
    @pulumi.getter(name="postScriptCmd")
    def post_script_cmd(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        post script command
        """
    ...
    def post_script_cmd(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "post_script_cmd", value)

    @property
    @pulumi.getter(name="preScriptCmd")
    def pre_script_cmd(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        pre script command
        """
    ...
    def pre_script_cmd(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pre_script_cmd", value)

    @property
    @pulumi.getter(name="scaleCount")
    def scale_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @scale_count.setter
    def scale_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _NdbScaleDatabaseState:
    def __init__(__self__, *,
                 ...
                 data_storage_size: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 database_uuid: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_uuid: Database id
        :param pulumi.Input[builtins.str] databasetype: type of database
    ...
    @property
    @pulumi.getter(name="dataStorageSize")
    def data_storage_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        data area (in GiB) to be added to the existing database.
        """
        return pulumi.get(self, "data_storage_size")
    ...
    @data_storage_size.setter
    def data_storage_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_storage_size", value)
    ...
    @property
    @pulumi.getter(name="databaseUuid")
    def database_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database id
        """
        return pulumi.get(self, "database_uuid")
    ...
    @database_uuid.setter
    def database_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_uuid", value)
...
@pulumi.type_token("nutanix:index/ndbScaleDatabase:NdbScaleDatabase")
class NdbScaleDatabase(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NdbScaleDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NdbScaleDatabaseArgs.__new__(NdbScaleDatabaseArgs)
        ...
        super(NdbScaleDatabase, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NdbScaleDatabase':
        """
        ...
        __props__ = _NdbScaleDatabaseState.__new__(_NdbScaleDatabaseState)
        ...
        return NdbScaleDatabase(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="dataStorageSize")
    def data_storage_size(self) -> pulumi.Output[builtins.int]:
        """
        data area (in GiB) to be added to the existing database.
        """
        return pulumi.get(self, "data_storage_size")
    ...
    @property
    @pulumi.getter(name="databaseUuid")
    def database_uuid(self) -> pulumi.Output[builtins.str]:
        """
        Database id
        """
        return pulumi.get(self, "database_uuid")
    ...
    @property
    @pulumi.getter
    def databasetype(self) -> pulumi.Output[builtins.str]:
        """
        type of database
        """
        return pulumi.get(self, "databasetype")
    ...
    @property
    @pulumi.getter(name="postScriptCmd")
    def post_script_cmd(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        post script command
        """
        return pulumi.get(self, "post_script_cmd")
    ...
    @property
    @pulumi.getter(name="preScriptCmd")
    def pre_script_cmd(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        pre script command
        """
        return pulumi.get(self, "pre_script_cmd")
    ...
    @property
    @pulumi.getter(name="scaleCount")
    def scale_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        scale count helps to scale the same instance with same config
        """
        return pulumi.get(self, "scale_count")
