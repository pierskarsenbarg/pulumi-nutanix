...
class NdbStretchedVlanArgs:
    def __init__(__self__, *,
                 ...
                 vlan_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] type: type of vlan. static VLANs that are managed in NDB can be added to a stretched VLAN.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vlan_ids: list of vlan ids to be added in NDB
        :param pulumi.Input[builtins.str] description: Description of stretched vlan
        ...
        :param pulumi.Input[builtins.str] name: name for the stretched VLAN
        """
    ...
    def vlan_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @vlan_ids.setter
    def vlan_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
