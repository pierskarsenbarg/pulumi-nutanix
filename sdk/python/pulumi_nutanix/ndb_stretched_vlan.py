...
class NdbStretchedVlanArgs:
    def __init__(__self__, *,
                 ...
                 vlan_ids: pulumi.Input[Sequence[pulumi.Input[str]]],
    ...
    def vlan_ids(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        return pulumi.get(self, "vlan_ids")

    @vlan_ids.setter
    def vlan_ids(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
...
class NdbStretchedVlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a NdbStretchedVlan resource with the given unique name, props, and options.
