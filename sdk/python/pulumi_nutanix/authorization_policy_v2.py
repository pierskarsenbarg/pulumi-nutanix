...
class AuthorizationPolicyV2Args:
    def __init__(__self__, *,
                 ...
                 authorization_policy_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: Name of the Authorization Policy.
        ...
        :param pulumi.Input[builtins.str] role: The Role associated with the Authorization Policy.
        ...
        :param pulumi.Input[builtins.str] description: Description of the Authorization Policy.
        :param pulumi.Input[builtins.str] ext_id: ext_id of Authorization policy.
        """
    ...
    def authorization_policy_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authorization_policy_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AuthorizationPolicyV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_by: User or Service Name that created the Authorization Policy.
        :param pulumi.Input[builtins.str] created_time: The creation time of the Authorization Policy.
        :param pulumi.Input[builtins.str] description: Description of the Authorization Policy.
        :param pulumi.Input[builtins.str] display_name: Name of the Authorization Policy.
        :param pulumi.Input[Sequence[pulumi.Input['AuthorizationPolicyV2EntityArgs']]] entities: The entities being qualified by the Authorization Policy.
        :param pulumi.Input[builtins.str] ext_id: ext_id of Authorization policy.
        :param pulumi.Input[Sequence[pulumi.Input['AuthorizationPolicyV2IdentityArgs']]] identities: The identities for which the Authorization Policy is created.
        :param pulumi.Input[builtins.bool] is_system_defined: Flag identifying if the Authorization Policy is system defined or not.
        :param pulumi.Input[builtins.str] last_updated_time: The time when the Authorization Policy was last updated.
        :param pulumi.Input[builtins.str] role: The Role associated with the Authorization Policy.
        """
        if authorization_policy_type is not None:
            pulumi.set(__self__, "authorization_policy_type", authorization_policy_type)
...
class AuthorizationPolicyV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_system_defined: Optional[pulumi.Input[builtins.bool]] = None,
            last_updated_time: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthorizationPolicyV2':
        """
    ...
    @property
    @pulumi.getter(name="authorizationPolicyType")
    def authorization_policy_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of Authorization Policy.
        * `PREDEFINED_READ_ONLY` : System-defined read-only ACP, i.e. no modifications allowed.
        * `SERVICE_DEFINED_READ_ONLY` : Read-only ACP defined by a service.
