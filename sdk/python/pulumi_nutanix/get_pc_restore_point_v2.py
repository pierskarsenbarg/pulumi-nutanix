...
class GetPcRestorePointV2Result:
    ...
    def restorable_domain_manager_ext_id(self) -> builtins.str:
        return pulumi.get(self, "restorable_domain_manager_ext_id")

    @property
    @pulumi.getter(name="restoreSourceExtId")
    def restore_source_ext_id(self) -> builtins.str:
...
def get_pc_restore_point_v2(ext_id: Optional[builtins.str] = None,
                            restorable_domain_manager_ext_id: Optional[builtins.str] = None,
                            restore_source_ext_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ext_id: Restore point ID for the backup created in cluster/object store.
    :param builtins.str restorable_domain_manager_ext_id: A unique identifier for the domain manager.
    :param builtins.str restore_source_ext_id: A unique identifier obtained from the restore source API that corresponds to the details provided for the restore source.
    """
    __args__ = dict()
...
def get_pc_restore_point_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
