...
class NdbNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: Select the Nutanix cluster on which you want to add the VLAN.
        :param pulumi.Input[builtins.str] type: Vlan type. Supports [DHCP, Static]
        :param pulumi.Input[builtins.str] dns_domain: dns domain for vlan. (Static IP address assignment only)
        :param pulumi.Input[builtins.str] gateway: Gateway for vlan. Supports in Static IP address assignment only
        ...
        :param pulumi.Input[builtins.str] name: Name of the vlan to be attached in NDB
        :param pulumi.Input[builtins.str] primary_dns: primary dns for vlan. (Static IP address assignment only)
        :param pulumi.Input[builtins.str] secondary_dns: secondary dns for vlan. (Static IP address assignment only)
        :param pulumi.Input[builtins.str] subnet_mask: Subnet mask for vlan. (Static IP address assignment only)
        """
...
class _NdbNetworkState:
    def __init__(__self__, *,
                 ...
                 secondary_dns: Optional[pulumi.Input[builtins.str]] = None,
                 stretched_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_mask: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] gateway: Gateway for vlan. Supports in Static IP address assignment only
        :param pulumi.Input[Sequence[pulumi.Input['NdbNetworkIpPoolArgs']]] ip_pools: Manage IP Address Pool in NDB option if you want to assign static IP addresses to your database server VMs
        :param pulumi.Input[builtins.bool] managed: Managed by NDB or not
        :param pulumi.Input[builtins.str] name: Name of the vlan to be attached in NDB
        :param pulumi.Input[builtins.str] primary_dns: primary dns for vlan. (Static IP address assignment only)
        ...
        :param pulumi.Input[builtins.str] secondary_dns: secondary dns for vlan. (Static IP address assignment only)
        :param pulumi.Input[builtins.str] stretched_vlan_id: stretched vlan id
        :param pulumi.Input[builtins.str] subnet_mask: Subnet mask for vlan. (Static IP address assignment only)
        :param pulumi.Input[builtins.str] type: Vlan type. Supports [DHCP, Static]
        """
    ...
    def stretched_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        stretched vlan id
        """
    ...
    def stretched_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NdbNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stretched_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
            subnet_mask: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NdbNetwork':
        """
    ...
    @property
    @pulumi.getter(name="primaryDns")
    def primary_dns(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        primary dns for vlan. (Static IP address assignment only)
        """
        return pulumi.get(self, "primary_dns")
    ...
    @property
    @pulumi.getter(name="secondaryDns")
    def secondary_dns(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        secondary dns for vlan. (Static IP address assignment only)
        """
        return pulumi.get(self, "secondary_dns")
    ...
    @property
    @pulumi.getter(name="stretchedVlanId")
    def stretched_vlan_id(self) -> pulumi.Output[builtins.str]:
        """
        stretched vlan id
        """
        return pulumi.get(self, "stretched_vlan_id")
