...
class NdbLogCatchupsArgs:
    def __init__(__self__, *,
                 ...
                 for_restore: Optional[pulumi.Input[builtins.bool]] = None,
                 log_catchup_version: Optional[pulumi.Input[builtins.int]] = None,
                 time_machine_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NdbLogCatchups resource.
        :param pulumi.Input[builtins.bool] for_restore: Logs to Backup. The database may contain additional logs. Backup any remaining logs before restore or they will be lost.
        :param pulumi.Input[builtins.int] log_catchup_version: it helps to perform same operation with same config.
        ...
        :param pulumi.Input[builtins.str] time_machine_id: Time machine id of
        """
    ...
    def for_restore(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @for_restore.setter
    def for_restore(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "for_restore", value)

    @property
    @pulumi.getter(name="logCatchupVersion")
    def log_catchup_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def log_catchup_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NdbLogCatchups(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            for_restore: Optional[pulumi.Input[builtins.bool]] = None,
            log_catchup_version: Optional[pulumi.Input[builtins.int]] = None,
            time_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NdbLogCatchups':
        """
    ...
    @property
    @pulumi.getter(name="databaseId")
    def database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "database_id")

    @property
    @pulumi.getter(name="forRestore")
    def for_restore(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Logs to Backup. The database may contain additional logs. Backup any remaining logs before restore or they will be lost.
        """
        return pulumi.get(self, "for_restore")
    ...
    @property
    @pulumi.getter(name="logCatchupVersion")
    def log_catchup_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        it helps to perform same operation with same config.
