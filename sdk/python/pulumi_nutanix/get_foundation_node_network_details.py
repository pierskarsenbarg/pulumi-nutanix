...
def get_foundation_node_network_details(ipv6_addresses: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] ipv6_addresses: list of ipv6 addresses
    :param builtins.str timeout: timeout in seconds
    """
    __args__ = dict()
...
def get_foundation_node_network_details_output(ipv6_addresses: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                               timeout: Optional[pulumi.Input[Optional[builtins.str]]] = None,
