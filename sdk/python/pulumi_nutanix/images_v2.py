...
class _ImagesV2State:
    def __init__(__self__, *,
                 ...
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['ImagesV2LinkArgs']]]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def links(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ImagesV2LinkArgs']]]]:
        return pulumi.get(self, "links")

    @links.setter
    def links(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ImagesV2LinkArgs']]]]):
...
class ImagesV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ext_id: Optional[pulumi.Input[_builtins.str]] = None,
            last_update_time: Optional[pulumi.Input[_builtins.str]] = None,
            links: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ImagesV2LinkArgs', 'ImagesV2LinkArgsDict']]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            owner_ext_id: Optional[pulumi.Input[_builtins.str]] = None,
