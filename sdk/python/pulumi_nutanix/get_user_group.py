...
class GetUserGroupResult:
    ...
    def project_reference(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def user_group_distinguished_name(self) -> Optional[builtins.str]:
    ...
    def user_group_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "user_group_name")

    @property
    @pulumi.getter(name="userGroupType")
    def user_group_type(self) -> builtins.str:
        """
...
def get_user_group(categories: Optional[Sequence[Union['GetUserGroupCategoryArgs', 'GetUserGroupCategoryArgsDict']]] = None,
                   owner_reference: Optional[Mapping[str, builtins.str]] = None,
                   project_reference: Optional[Mapping[str, builtins.str]] = None,
                   user_group_distinguished_name: Optional[builtins.str] = None,
                   user_group_id: Optional[builtins.str] = None,
                   user_group_name: Optional[builtins.str] = None,
    ...
    :param Mapping[str, builtins.str] owner_reference: - The reference to a user.
    :param Mapping[str, builtins.str] project_reference: - The Distinguished The reference to a project.
    :param builtins.str user_group_distinguished_name: The distinguished name for the user group
    :param builtins.str user_group_id: - (Optional) The UUID for the user group
    :param builtins.str user_group_name: - (Optional) The name for the user group
    """
    __args__ = dict()
...
def get_user_group_output(categories: Optional[pulumi.Input[Optional[Sequence[Union['GetUserGroupCategoryArgs', 'GetUserGroupCategoryArgsDict']]]]] = None,
                          owner_reference: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                          project_reference: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                          user_group_distinguished_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          user_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          user_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
