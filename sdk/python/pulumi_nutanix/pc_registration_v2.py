...
class PcRegistrationV2Args:
    def __init__(__self__, *,
                 pc_ext_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] pc_ext_id: -(Required) The display name for the Role.
    ...
    def pc_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @pc_ext_id.setter
    def pc_ext_id(self, value: pulumi.Input[builtins.str]):
...
class _PcRegistrationV2State:
    def __init__(__self__, *,
                 ...
                 hosting_cluster_ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_registered_with_hosting_cluster: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 node_ext_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 pc_ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 remote_cluster: Optional[pulumi.Input['PcRegistrationV2RemoteClusterArgs']] = None,
                 should_enable_high_availability: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def hosting_cluster_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hosting_cluster_ext_id")

    @hosting_cluster_ext_id.setter
    def hosting_cluster_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hosting_cluster_ext_id", value)

    @property
    @pulumi.getter(name="isRegisteredWithHostingCluster")
    def is_registered_with_hosting_cluster(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "is_registered_with_hosting_cluster")

    @is_registered_with_hosting_cluster.setter
    def is_registered_with_hosting_cluster(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_ext_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "node_ext_ids")

    @node_ext_ids.setter
    def node_ext_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "node_ext_ids", value)

    @property
    @pulumi.getter(name="pcExtId")
    def pc_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) The display name for the Role.
        """
        return pulumi.get(self, "pc_ext_id")
    ...
    @pc_ext_id.setter
    def pc_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pc_ext_id", value)
    ...
    def should_enable_high_availability(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "should_enable_high_availability")

    @should_enable_high_availability.setter
    def should_enable_high_availability(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PcRegistrationV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remote_cluster: Optional[pulumi.Input[Union['PcRegistrationV2RemoteClusterArgs', 'PcRegistrationV2RemoteClusterArgsDict']]] = None,
            should_enable_high_availability: Optional[pulumi.Input[builtins.bool]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PcRegistrationV2':
        """
    ...
    @property
    @pulumi.getter(name="hostingClusterExtId")
    def hosting_cluster_ext_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "hosting_cluster_ext_id")

    @property
    @pulumi.getter(name="isRegisteredWithHostingCluster")
    def is_registered_with_hosting_cluster(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "is_registered_with_hosting_cluster")
    ...
    @property
    @pulumi.getter(name="nodeExtIds")
    def node_ext_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "node_ext_ids")

    @property
    @pulumi.getter(name="pcExtId")
    def pc_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) The display name for the Role.
        """
        return pulumi.get(self, "pc_ext_id")
    ...
    @property
    @pulumi.getter(name="shouldEnableHighAvailability")
    def should_enable_high_availability(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "should_enable_high_availability")
