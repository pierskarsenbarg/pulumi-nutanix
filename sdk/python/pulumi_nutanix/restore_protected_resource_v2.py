...
class RestoreProtectedResourceV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_ext_id: -(Required) The external identifier of the cluster on which the entity has valid restorable time ranges. The restored entity will be created on the same cluster.
        :param pulumi.Input[builtins.str] ext_id: -(Required) The external identifier of a protected VM or volume group that can be used to retrieve the protected resource.
        :param pulumi.Input[builtins.str] restore_time: -(Optional) UTC date and time in ISO 8601 format representing the time from when the state of the entity should be restored. This needs to be a valid time within the restorable time range(s) for the protected resource.
...
class RestoreProtectedResourceV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cluster_ext_id: Optional[pulumi.Input[builtins.str]] = None,
            ext_id: Optional[pulumi.Input[builtins.str]] = None,
            restore_time: Optional[pulumi.Input[builtins.str]] = None) -> 'RestoreProtectedResourceV2':
        """
