...
class ClusterV2Args:
    def __init__(__self__, *,
                 ...
                 dryrun: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter
    def dryrun(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @dryrun.setter
    def dryrun(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterV2State:
    def __init__(__self__, *,
                 backup_eligibility_score: Optional[pulumi.Input[builtins.int]] = None,
                 categories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cluster_profile_ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 configs: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV2ConfigArgs']]]] = None,
                 container_name: Optional[pulumi.Input[builtins.str]] = None,
                 dryrun: Optional[pulumi.Input[builtins.bool]] = None,
                 expand: Optional[pulumi.Input[builtins.str]] = None,
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 inefficient_vm_count: Optional[pulumi.Input[builtins.int]] = None,
                 links: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV2LinkArgs']]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV2NetworkArgs']]]] = None,
                 nodes: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterV2NodeArgs']]]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterV2NetworkArgs']]] networks: - (Optional) Network details of a cluster.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterV2NodeArgs']]] nodes: - (Optional) The reference to a node.
        :param pulumi.Input[builtins.str] upgrade_status: - (Optional) The reference to a project.
               Valid values are:
    ...
    def backup_eligibility_score(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "backup_eligibility_score")

    @backup_eligibility_score.setter
    def backup_eligibility_score(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def cluster_profile_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "cluster_profile_ext_id")

    @cluster_profile_ext_id.setter
    def cluster_profile_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def inefficient_vm_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "inefficient_vm_count")

    @inefficient_vm_count.setter
    def inefficient_vm_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def upgrade_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        - (Optional) The reference to a project.
        Valid values are:
        - "CANCELLED"	The cluster upgrade is cancelled.
    ...
    def upgrade_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            upgrade_status: Optional[pulumi.Input[builtins.str]] = None,
            vm_count: Optional[pulumi.Input[builtins.int]] = None) -> 'ClusterV2':
        """
    ...
    @property
    @pulumi.getter(name="backupEligibilityScore")
    def backup_eligibility_score(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "backup_eligibility_score")
    ...
    @property
    @pulumi.getter(name="clusterProfileExtId")
    def cluster_profile_ext_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "cluster_profile_ext_id")
    ...
    @property
    @pulumi.getter
    def dryrun(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        - (Optional) parameter that allows long-running operations to execute in a dry-run mode providing ability to identify trouble spots and system failures without performing the actual operation. Additionally this mode also offers a summary snapshot of the resultant system in order to better understand how things fit together. The operation runs in dry-run mode only if the provided value is true.
        """
        return pulumi.get(self, "dryrun")
    ...
    @property
    @pulumi.getter
    def expand(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "expand")
    ...
    @property
    @pulumi.getter(name="inefficientVmCount")
    def inefficient_vm_count(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "inefficient_vm_count")
    ...
    @property
    @pulumi.getter(name="upgradeStatus")
    def upgrade_status(self) -> pulumi.Output[builtins.str]:
        """
        - (Optional) The reference to a project.
        Valid values are:
        - "CANCELLED"	The cluster upgrade is cancelled.
    ...
    @property
    @pulumi.getter(name="vmCount")
    def vm_count(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "vm_count")
