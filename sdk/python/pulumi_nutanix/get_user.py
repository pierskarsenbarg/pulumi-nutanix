...
def get_user(categories: Optional[Sequence[Union['GetUserCategoryArgs', 'GetUserCategoryArgsDict']]] = None,
    ...
    :param Mapping[str, builtins.str] owner_reference: - (Optional) The reference to a user.
    :param Mapping[str, builtins.str] project_reference: - (Optional) The reference to a project.
    """
    __args__ = dict()
