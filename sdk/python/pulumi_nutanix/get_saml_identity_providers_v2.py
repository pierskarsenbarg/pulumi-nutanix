...
def get_saml_identity_providers_v2(filter: Optional[builtins.str] = None,
...
def get_saml_identity_providers_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
