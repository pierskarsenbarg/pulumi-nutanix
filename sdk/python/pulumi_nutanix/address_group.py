...
class AddressGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: - (Optional) Description of the service group
        :param pulumi.Input[builtins.str] name: - (Required) Name of the service group
        """
...
class _AddressGroupState:
    def __init__(__self__, *,
                 address_group_string: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] address_group_string: - (ReadOnly) Address Group string
        :param pulumi.Input[builtins.str] description: - (Optional) Description of the service group
        :param pulumi.Input[Sequence[pulumi.Input['AddressGroupIpAddressBlockListArgs']]] ip_address_block_lists: - (Required) list of IP address blocks with their prefix length
        :param pulumi.Input[builtins.str] name: - (Required) Name of the service group
        """
    ...
    def address_group_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def address_group_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AddressGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            ip_address_block_lists: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AddressGroupIpAddressBlockListArgs', 'AddressGroupIpAddressBlockListArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressGroup':
        """
    ...
    @property
    @pulumi.getter(name="addressGroupString")
    def address_group_string(self) -> pulumi.Output[builtins.str]:
        """
        - (ReadOnly) Address Group string
        """
        return pulumi.get(self, "address_group_string")
