...
class LcmUpgradeV2Args:
    def __init__(__self__, *,
                 auto_handle_flags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 max_wait_time_in_secs: Optional[pulumi.Input[builtins.int]] = None,
                 skipped_precheck_flags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 x_cluster_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LcmUpgradeV2 resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] auto_handle_flags: List of automated system operations to perform, to avoid precheck failure and let the system restore state after an update is complete. The allowed flag is: - 'powerOffUvms': This allows the system to automatically power off user VMs which cannot be migrated to other hosts and power them on when the update is done. This option can avoid pinned VM precheck failure on the host which needs to enter maintenance mode during the update and allow the update to go through. Items Enum: `POWER_OFF_UVMS`
        ...
        :param pulumi.Input[builtins.int] max_wait_time_in_secs: Number of seconds LCM waits for the VMs to come up after exiting host maintenance mode. Value in Range [ 60 .. 86400]
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] skipped_precheck_flags: List of prechecks to skip. The allowed value is 'powerOffUvms' that skips the pinned VM prechecks. Items Enum: `POWER_OFF_UVMS`
        :param pulumi.Input[builtins.str] x_cluster_id: Cluster uuid on which the resource is present or operation is being performed.
        """
    ...
    def auto_handle_flags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def auto_handle_flags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_wait_time_in_secs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_wait_time_in_secs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_wait_time_in_secs", value)

    @property
    @pulumi.getter(name="skippedPrecheckFlags")
    def skipped_precheck_flags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def skipped_precheck_flags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "skipped_precheck_flags", value)

    @property
    @pulumi.getter(name="xClusterId")
    def x_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @x_cluster_id.setter
    def x_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LcmUpgradeV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_wait_time_in_secs: Optional[pulumi.Input[builtins.int]] = None,
            skipped_precheck_flags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            x_cluster_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LcmUpgradeV2':
        """
    ...
    @property
    @pulumi.getter(name="autoHandleFlags")
    def auto_handle_flags(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of automated system operations to perform, to avoid precheck failure and let the system restore state after an update is complete. The allowed flag is: - 'powerOffUvms': This allows the system to automatically power off user VMs which cannot be migrated to other hosts and power them on when the update is done. This option can avoid pinned VM precheck failure on the host which needs to enter maintenance mode during the update and allow the update to go through. Items Enum: `POWER_OFF_UVMS`
        """
        return pulumi.get(self, "auto_handle_flags")
    ...
    @property
    @pulumi.getter(name="maxWaitTimeInSecs")
    def max_wait_time_in_secs(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of seconds LCM waits for the VMs to come up after exiting host maintenance mode. Value in Range [ 60 .. 86400]
        """
        return pulumi.get(self, "max_wait_time_in_secs")
    ...
    @property
    @pulumi.getter(name="skippedPrecheckFlags")
    def skipped_precheck_flags(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of prechecks to skip. The allowed value is 'powerOffUvms' that skips the pinned VM prechecks. Items Enum: `POWER_OFF_UVMS`
        """
        return pulumi.get(self, "skipped_precheck_flags")
    ...
    @property
    @pulumi.getter(name="xClusterId")
    def x_cluster_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Cluster uuid on which the resource is present or operation is being performed.
        """
        return pulumi.get(self, "x_cluster_id")
