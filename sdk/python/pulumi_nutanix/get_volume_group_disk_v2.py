...
class GetVolumeGroupDiskV2Result:
    ...
    def disk_size_bytes(self) -> builtins.int:
        """
...
def get_volume_group_disk_v2(ext_id: Optional[builtins.str] = None,
...
def get_volume_group_disk_v2_output(ext_id: Optional[pulumi.Input[builtins.str]] = None,
