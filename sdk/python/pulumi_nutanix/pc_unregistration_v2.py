...
class PcUnregistrationV2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ext_id: -(Required) Cluster UUID of a remote cluster.
        ...
        :param pulumi.Input[builtins.str] pc_ext_id: -(Required) The external identifier of the domain manager (Prism Central) resource
        """
...
class PcUnregistrationV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            ext_id: Optional[pulumi.Input[builtins.str]] = None,
            pc_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PcUnregistrationV2':
        """
