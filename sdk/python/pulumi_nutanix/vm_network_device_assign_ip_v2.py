...
__all__ = ['VmNetworkDeviceAssignIpV2Args', 'VmNetworkDeviceAssignIpV2']

@pulumi.input_type
class VmNetworkDeviceAssignIpV2Args:
...
class VmNetworkDeviceAssignIpV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a VmNetworkDeviceAssignIpV2 resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a VmNetworkDeviceAssignIpV2 resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param VmNetworkDeviceAssignIpV2Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VmNetworkDeviceAssignIpV2Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VmNetworkDeviceAssignIpV2Args.__new__(VmNetworkDeviceAssignIpV2Args)
        ...
        super(VmNetworkDeviceAssignIpV2, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            ext_id: Optional[pulumi.Input[builtins.str]] = None,
            ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VmNetworkDeviceAssignIpV2IpAddressArgs', 'VmNetworkDeviceAssignIpV2IpAddressArgsDict']]]]] = None,
            vm_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VmNetworkDeviceAssignIpV2':
        """
        ...
        __props__ = _VmNetworkDeviceAssignIpV2State.__new__(_VmNetworkDeviceAssignIpV2State)

        __props__.__dict__["ext_id"] = ext_id
        __props__.__dict__["ip_addresses"] = ip_addresses
        __props__.__dict__["vm_ext_id"] = vm_ext_id
        return VmNetworkDeviceAssignIpV2(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="ipAddresses")
    def ip_addresses(self) -> pulumi.Output[Sequence['outputs.VmNetworkDeviceAssignIpV2IpAddress']]:
        return pulumi.get(self, "ip_addresses")
