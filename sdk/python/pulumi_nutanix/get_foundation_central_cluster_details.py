...
class GetFoundationCentralClusterDetailsResult:
    ...
    def cluster_external_ip(self) -> builtins.str:
        """
    ...
    def foundation_init_node_uuid(self) -> builtins.str:
        """
    ...
    def imaged_node_uuid_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def redundancy_factor(self) -> Optional[builtins.int]:
        """
    ...
    def storage_node_count(self) -> builtins.int:
        """
...
def get_foundation_central_cluster_details(cluster_external_ip: Optional[builtins.str] = None,
                                           ...
                                           imaged_cluster_uuid: Optional[builtins.str] = None,
                                           redundancy_factor: Optional[builtins.int] = None,
                                           storage_node_count: Optional[builtins.int] = None,
    ...
    :param builtins.str cluster_external_ip: External management ip of the cluster.
    :param builtins.str cluster_name: Cluster name.
    :param builtins.int cluster_size: Number of nodes in the cluster.
    ...
    :param builtins.str imaged_cluster_uuid: UUID of the cluster whose details need to be fetched.
    :param builtins.int redundancy_factor: Redundancy factor of the cluster.
    :param builtins.int storage_node_count: Number of storage only nodes in the cluster. AHV iso for storage node will be taken from aos package.
    """
    __args__ = dict()
...
def get_foundation_central_cluster_details_output(cluster_external_ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  cluster_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  cluster_size: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                  ...
                                                  redundancy_factor: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                  storage_node_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
