...
class PcBackupTargetV2Args:
    def __init__(__self__, *,
                 domain_manager_ext_id: pulumi.Input[builtins.str],
                 location: pulumi.Input['PcBackupTargetV2LocationArgs']):
        """
        The set of arguments for constructing a PcBackupTargetV2 resource.
        :param pulumi.Input[builtins.str] domain_manager_ext_id: -(Required) A unique identifier for the domain manager.
    ...
    def domain_manager_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def domain_manager_ext_id(self, value: pulumi.Input[builtins.str]):
...
class _PcBackupTargetV2State:
    def __init__(__self__, *,
                 backup_pause_reason: Optional[pulumi.Input[builtins.str]] = None,
                 domain_manager_ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_backup_paused: Optional[pulumi.Input[builtins.bool]] = None,
                 last_sync_time: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def backup_pause_reason(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "backup_pause_reason")

    @backup_pause_reason.setter
    def backup_pause_reason(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backup_pause_reason", value)

    @property
    @pulumi.getter(name="domainManagerExtId")
    def domain_manager_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) A unique identifier for the domain manager.
        """
        return pulumi.get(self, "domain_manager_ext_id")
    ...
    @domain_manager_ext_id.setter
    def domain_manager_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_manager_ext_id", value)
    ...
    def is_backup_paused(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "is_backup_paused")

    @is_backup_paused.setter
    def is_backup_paused(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_backup_paused", value)

    @property
    @pulumi.getter(name="lastSyncTime")
    def last_sync_time(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "last_sync_time")

    @last_sync_time.setter
    def last_sync_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PcBackupTargetV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[Union['PcBackupTargetV2LocationArgs', 'PcBackupTargetV2LocationArgsDict']]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PcBackupTargetV2':
        """
    ...
    @property
    @pulumi.getter(name="backupPauseReason")
    def backup_pause_reason(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "backup_pause_reason")

    @property
    @pulumi.getter(name="domainManagerExtId")
    def domain_manager_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) A unique identifier for the domain manager.
        """
        return pulumi.get(self, "domain_manager_ext_id")
    ...
    @property
    @pulumi.getter(name="isBackupPaused")
    def is_backup_paused(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "is_backup_paused")
