...
class KarbonPrivateRegistryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] url: - (Optional) URL of the private registry. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.str] cert: - (Optional) Certificate of the private registry in format of base64-encoded byte array. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.str] name: - (Required) Name of the private registry configuration. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.str] password: - (Optional) Password for authentication to the private registry. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.int] port: - (Optional) Port of the private registry.
        :param pulumi.Input[builtins.str] username: - (Optional) Username for authentication to the private registry. **Note:** Updates to this attribute forces new resource creation.
        """
...
class _KarbonPrivateRegistryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cert: - (Optional) Certificate of the private registry in format of base64-encoded byte array. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.str] endpoint: - Endpoint of the private in format `url:port`.
        :param pulumi.Input[builtins.str] name: - (Required) Name of the private registry configuration. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.str] password: - (Optional) Password for authentication to the private registry. **Note:** Updates to this attribute forces new resource creation.
        :param pulumi.Input[builtins.int] port: - (Optional) Port of the private registry.
        :param pulumi.Input[builtins.str] url: - (Optional) URL of the private registry. **Note:** Updates to this attribute forces new resource creation.
...
class KarbonPrivateRegistry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.int]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'KarbonPrivateRegistry':
        """
