...
class VolumeGroupIscsiClientV2Args:
    def __init__(__self__, *,
                 vg_ext_id: pulumi.Input[builtins.str],
                 attachment_site: Optional[pulumi.Input[builtins.str]] = None,
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 enabled_authentications: Optional[pulumi.Input[builtins.str]] = None,
                 ext_id: Optional[pulumi.Input[builtins.str]] = None,
                 iscsi_initiator_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 num_virtual_targets: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a VolumeGroupIscsiClientV2 resource.
        :param pulumi.Input[builtins.str] vg_ext_id: -(Required) The external identifier of the volume group.
        :param pulumi.Input[builtins.str] attachment_site: -(Optional) The site where the Volume Group attach operation should be processed. This is an optional field. This field may only be set if Metro DR has been configured for this Volume Group. Valid values are SECONDARY, PRIMARY.
        :param pulumi.Input[builtins.str] client_secret: -(Optional) iSCSI initiator client secret in case of CHAP authentication. This field should not be provided in case the authentication type is not set to CHAP.
        :param pulumi.Input[builtins.str] enabled_authentications: -(Optional) (Optional) The authentication type enabled for the Volume Group. This is an optional field. If omitted, authentication is not configured for the Volume Group. If this is set to CHAP, the target/client secret must be provided. Valid values are CHAP, NONE
        :param pulumi.Input[builtins.str] ext_id: -(Required) A globally unique identifier of an instance that is suitable for external consumption.
        :param pulumi.Input[builtins.str] iscsi_initiator_name: -iSCSI initiator name. During the attach operation, exactly one of iscsiInitiatorName and iscsiInitiatorNetworkId must be specified. This field is immutable.
        ...
        :param pulumi.Input[builtins.int] num_virtual_targets: -(Optional) Number of virtual targets generated for the iSCSI target. This field is immutable.
        """
    ...
    def vg_ext_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @vg_ext_id.setter
    def vg_ext_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vg_ext_id", value)

    @property
    @pulumi.getter(name="attachmentSite")
    def attachment_site(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attachment_site(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def iscsi_initiator_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def iscsi_initiator_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def num_virtual_targets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_virtual_targets(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VolumeGroupIscsiClientV2State:
    def __init__(__self__, *,
                 ...
                 iscsi_initiator_network_ids: Optional[pulumi.Input[Sequence[pulumi.Input['VolumeGroupIscsiClientV2IscsiInitiatorNetworkIdArgs']]]] = None,
                 num_virtual_targets: Optional[pulumi.Input[builtins.int]] = None,
                 vg_ext_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="vgExtId")
    def vg_ext_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        -(Required) The external identifier of the volume group.
        """
        return pulumi.get(self, "vg_ext_id")
    ...
    @vg_ext_id.setter
    def vg_ext_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vg_ext_id", value)
...
class VolumeGroupIscsiClientV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            iscsi_initiator_network_ids: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VolumeGroupIscsiClientV2IscsiInitiatorNetworkIdArgs', 'VolumeGroupIscsiClientV2IscsiInitiatorNetworkIdArgsDict']]]]] = None,
            num_virtual_targets: Optional[pulumi.Input[builtins.int]] = None,
            vg_ext_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeGroupIscsiClientV2':
        """
    ...
    @property
    @pulumi.getter(name="attachmentSite")
    def attachment_site(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        -(Optional) The site where the Volume Group attach operation should be processed. This is an optional field. This field may only be set if Metro DR has been configured for this Volume Group. Valid values are SECONDARY, PRIMARY.
        """
        return pulumi.get(self, "attachment_site")
    ...
    @property
    @pulumi.getter(name="iscsiInitiatorName")
    def iscsi_initiator_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        -iSCSI initiator name. During the attach operation, exactly one of iscsiInitiatorName and iscsiInitiatorNetworkId must be specified. This field is immutable.
        """
        return pulumi.get(self, "iscsi_initiator_name")
    ...
    @property
    @pulumi.getter(name="numVirtualTargets")
    def num_virtual_targets(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        -(Optional) Number of virtual targets generated for the iSCSI target. This field is immutable.
        """
        return pulumi.get(self, "num_virtual_targets")
    ...
    @property
    @pulumi.getter(name="vgExtId")
    def vg_ext_id(self) -> pulumi.Output[builtins.str]:
        """
        -(Required) The external identifier of the volume group.
        """
        return pulumi.get(self, "vg_ext_id")
