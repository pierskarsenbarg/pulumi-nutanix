...
class GetNdbSlaResult:
    ...
    def continuous_retention(self) -> builtins.int:
        """
    ...
    def current_active_frequency(self) -> builtins.str:
        """
    ...
    def daily_retention(self) -> builtins.int:
        """
    ...
    def monthly_retention(self) -> builtins.int:
        """
    ...
    def pitr_enabled(self) -> builtins.bool:
        """
    ...
    def quartely_retention(self) -> builtins.int:
        """
        - Daily snapshots retention limit
        """
    ...
    def reference_count(self) -> builtins.int:
        """
        - Reference count
        """
    ...
    def weekly_retention(self) -> builtins.int:
        """
    ...
    def yearly_retention(self) -> builtins.int:
        """
...
def get_ndb_sla(sla_id: Optional[builtins.str] = None,
                sla_name: Optional[builtins.str] = None,
    ...
    :param builtins.str sla_id: and `sla_name` are mutually exclusive.
    :param builtins.str sla_name: SLA Name for query
    """
    __args__ = dict()
...
def get_ndb_sla_output(sla_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       sla_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
