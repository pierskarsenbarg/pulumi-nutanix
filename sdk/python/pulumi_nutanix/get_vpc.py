...
def get_vpc(vpc_name: Optional[builtins.str] = None,
    ...
    :param builtins.str vpc_uuid: vpc UUID
    """
    __args__ = dict()
...
def get_vpc_output(vpc_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                   vpc_uuid: Optional[pulumi.Input[Optional[builtins.str]]] = None,
