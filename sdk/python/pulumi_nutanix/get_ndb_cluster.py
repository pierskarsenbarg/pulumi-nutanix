...
class GetNdbClusterResult:
    ...
    def cloud_info(self) -> builtins.str:
        """
        - cloud info
        """
    ...
    def management_server_info(self) -> builtins.str:
        """
        - NA
        """
    ...
    def nx_cluster_uuid(self) -> builtins.str:
        """
...
def get_ndb_cluster(cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_id: ID of cluster
    :param builtins.str cluster_name: and `cluster_id` are mutually exclusive.
    """
    __args__ = dict()
...
def get_ndb_cluster_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
