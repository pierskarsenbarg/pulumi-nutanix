...
def get_karbon_cluster_ssh(karbon_cluster_id: Optional[builtins.str] = None,
...
def get_karbon_cluster_ssh_output(karbon_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
