...
def get_templates_v2(filter: Optional[builtins.str] = None,
    ...
    :param builtins.int page: A URL query parameter that specifies the page number of the result set. It must be a positive integer between 0 and the maximum number of pages that are available for that resource. Any number out of this range might lead to no results. Default is 0.
    """
    __args__ = dict()
...
def get_templates_v2_output(filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
