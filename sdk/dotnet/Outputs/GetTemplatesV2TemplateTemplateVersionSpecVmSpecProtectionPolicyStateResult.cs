...
namespace PiersKarsenbarg.Nutanix.Outputs
{
    ...
    public sealed class GetTemplatesV2TemplateTemplateVersionSpecVmSpecProtectionPolicyStateResult
    {
        ...
        [OutputConstructor]
        private GetTemplatesV2TemplateTemplateVersionSpecVmSpecProtectionPolicyStateResult(ImmutableArray<Outputs.GetTemplatesV2TemplateTemplateVersionSpecVmSpecProtectionPolicyStatePolicyResult> policies)
        {
            Policies = policies;
        }
    }
