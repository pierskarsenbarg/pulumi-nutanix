...
namespace PiersKarsenbarg.Nutanix.Outputs
{
    ...
    [OutputType]
    public sealed class GetNetworkSecurityPolicyRulesV2NetworkSecurityPolicyRuleSpecIntraEntityGroupRuleSpecResult
    {
        public readonly string SecuredGroupAction;
        public readonly ImmutableArray<string> SecuredGroupCategoryReferences;

        [OutputConstructor]
        private GetNetworkSecurityPolicyRulesV2NetworkSecurityPolicyRuleSpecIntraEntityGroupRuleSpecResult(
