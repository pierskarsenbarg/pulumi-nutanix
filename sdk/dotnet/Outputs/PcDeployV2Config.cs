...
namespace PiersKarsenbarg.Nutanix.Outputs
{
    ...
    [OutputType]
    public sealed class PcDeployV2Config
    {
        /// <summary>
        /// - (Optional) Bootstrap configuration details for the domain manager (Prism Central).
        /// </summary>
        public readonly Outputs.PcDeployV2ConfigBootstrapConfig? BootstrapConfig;
        /// <summary>
        /// -(Required) Currently representing the build information to be used for the cluster creation.
        /// </summary>
        public readonly Outputs.PcDeployV2ConfigBuildInfo BuildInfo;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PcDeployV2ConfigCredential> Credentials;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PcDeployV2ConfigResourceConfig> ResourceConfigs;
        /// <summary>
        ...
        [OutputConstructor]
        private PcDeployV2Config(
            Outputs.PcDeployV2ConfigBootstrapConfig? bootstrapConfig,

            Outputs.PcDeployV2ConfigBuildInfo buildInfo,

            ImmutableArray<Outputs.PcDeployV2ConfigCredential> credentials,

            string name,

            ImmutableArray<Outputs.PcDeployV2ConfigResourceConfig> resourceConfigs,
