...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class NdbClusterNetworksInfoArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessTypes")]
        ...
        [Input("networkInfos")]
        private InputList<Inputs.NdbClusterNetworksInfoNetworkInfoArgs>? _networkInfos;

        /// <summary>
        /// network segmentation to segment the network traffic
        /// </summary>
        public InputList<Inputs.NdbClusterNetworksInfoNetworkInfoArgs> NetworkInfos
        {
            get => _networkInfos ?? (_networkInfos = new InputList<Inputs.NdbClusterNetworksInfoNetworkInfoArgs>());
        ...
        public NdbClusterNetworksInfoArgs()
        {
        }
        public static new NdbClusterNetworksInfoArgs Empty => new NdbClusterNetworksInfoArgs();
    }
}
