...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class NdbRegisterDatabaseTimeMachineArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessLevel")]
        ...
        [Input("properties")]
        private InputList<Inputs.NdbRegisterDatabaseTimeMachinePropertyArgs>? _properties;

        /// <summary>
        /// properties of database created
        /// </summary>
        public InputList<Inputs.NdbRegisterDatabaseTimeMachinePropertyArgs> Properties
        {
            get => _properties ?? (_properties = new InputList<Inputs.NdbRegisterDatabaseTimeMachinePropertyArgs>());
        ...
        [Input("slas")]
        private InputList<Inputs.NdbRegisterDatabaseTimeMachineSlaArgs>? _slas;
        public InputList<Inputs.NdbRegisterDatabaseTimeMachineSlaArgs> Slas
        {
            get => _slas ?? (_slas = new InputList<Inputs.NdbRegisterDatabaseTimeMachineSlaArgs>());
            set => _slas = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.NdbRegisterDatabaseTimeMachineTagArgs>? _tags;

        /// <summary>
        /// tags
        /// </summary>
        public InputList<Inputs.NdbRegisterDatabaseTimeMachineTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.NdbRegisterDatabaseTimeMachineTagArgs>());
            set => _tags = value;
        }
        ...
        public NdbRegisterDatabaseTimeMachineArgs()
        {
        }
        public static new NdbRegisterDatabaseTimeMachineArgs Empty => new NdbRegisterDatabaseTimeMachineArgs();
    }
}
