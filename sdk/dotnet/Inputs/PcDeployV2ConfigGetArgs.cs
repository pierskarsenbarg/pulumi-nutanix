...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class PcDeployV2ConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// - (Optional) Bootstrap configuration details for the domain manager (Prism Central).
        /// </summary>
        [Input("bootstrapConfig")]
        public Input<Inputs.PcDeployV2ConfigBootstrapConfigGetArgs>? BootstrapConfig { get; set; }

        /// <summary>
        /// -(Required) Currently representing the build information to be used for the cluster creation.
        /// </summary>
        [Input("buildInfo", required: true)]
        public Input<Inputs.PcDeployV2ConfigBuildInfoGetArgs> BuildInfo { get; set; } = null!;

        [Input("credentials")]
        private InputList<Inputs.PcDeployV2ConfigCredentialGetArgs>? _credentials;
        ...
        /// </summary>
        public InputList<Inputs.PcDeployV2ConfigCredentialGetArgs> Credentials
        {
            get => _credentials ?? (_credentials = new InputList<Inputs.PcDeployV2ConfigCredentialGetArgs>());
        ...
        private InputList<Inputs.PcDeployV2ConfigResourceConfigGetArgs>? _resourceConfigs;
        ...
        /// </summary>
        public InputList<Inputs.PcDeployV2ConfigResourceConfigGetArgs> ResourceConfigs
        {
            get => _resourceConfigs ?? (_resourceConfigs = new InputList<Inputs.PcDeployV2ConfigResourceConfigGetArgs>());
        ...
        public PcDeployV2ConfigGetArgs()
        {
        }
        public static new PcDeployV2ConfigGetArgs Empty => new PcDeployV2ConfigGetArgs();
    }
}
