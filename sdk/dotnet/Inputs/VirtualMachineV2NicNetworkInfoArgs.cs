...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class VirtualMachineV2NicNetworkInfoArgs : global::Pulumi.ResourceArgs
    {
        [Input("ipv4Configs")]
        private InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4ConfigArgs>? _ipv4Configs;

        /// <summary>
        /// The IP address configurations.
        /// </summary>
        public InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4ConfigArgs> Ipv4Configs
        {
            get => _ipv4Configs ?? (_ipv4Configs = new InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4ConfigArgs>());
            set => _ipv4Configs = value;
        }

        [Input("ipv4Infos")]
        private InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4InfoArgs>? _ipv4Infos;
        public InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4InfoArgs> Ipv4Infos
        {
            get => _ipv4Infos ?? (_ipv4Infos = new InputList<Inputs.VirtualMachineV2NicNetworkInfoIpv4InfoArgs>());
            set => _ipv4Infos = value;
        }

        [Input("networkFunctionChains")]
        private InputList<Inputs.VirtualMachineV2NicNetworkInfoNetworkFunctionChainArgs>? _networkFunctionChains;

        /// <summary>
        /// The network function chain associates with the NIC. Only valid if nic_type is NORMAL_NIC.
        /// </summary>
        public InputList<Inputs.VirtualMachineV2NicNetworkInfoNetworkFunctionChainArgs> NetworkFunctionChains
        {
            get => _networkFunctionChains ?? (_networkFunctionChains = new InputList<Inputs.VirtualMachineV2NicNetworkInfoNetworkFunctionChainArgs>());
        ...
        [Input("subnets")]
        private InputList<Inputs.VirtualMachineV2NicNetworkInfoSubnetArgs>? _subnets;
        ...
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.VirtualMachineV2NicNetworkInfoSubnetArgs>());
            set => _subnets = value;
        }
        ...
        public VirtualMachineV2NicNetworkInfoArgs()
        {
        }
        public static new VirtualMachineV2NicNetworkInfoArgs Empty => new VirtualMachineV2NicNetworkInfoArgs();
    }
}
