...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class ClusterV2NetworkHttpProxyListGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("ipAddresses")]
        private InputList<Inputs.ClusterV2NetworkHttpProxyListIpAddressGetArgs>? _ipAddresses;

        /// <summary>
        /// - (Optional) An unique address that identifies a device on the internet or a local network in IPv4 or IPv6 format.
        /// </summary>
        public InputList<Inputs.ClusterV2NetworkHttpProxyListIpAddressGetArgs> IpAddresses
        {
            get => _ipAddresses ?? (_ipAddresses = new InputList<Inputs.ClusterV2NetworkHttpProxyListIpAddressGetArgs>());
        ...
        public ClusterV2NetworkHttpProxyListGetArgs()
        {
        }
        public static new ClusterV2NetworkHttpProxyListGetArgs Empty => new ClusterV2NetworkHttpProxyListGetArgs();
    }
}
