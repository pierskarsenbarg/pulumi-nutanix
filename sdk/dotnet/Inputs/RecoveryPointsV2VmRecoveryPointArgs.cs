...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class RecoveryPointsV2VmRecoveryPointArgs : global::Pulumi.ResourceArgs
    {
        [Input("applicationConsistentProperties")]
        private InputList<Inputs.RecoveryPointsV2VmRecoveryPointApplicationConsistentPropertyArgs>? _applicationConsistentProperties;

        /// <summary>
        /// User-defined application-consistent properties for the recovery point.
        /// </summary>
        public InputList<Inputs.RecoveryPointsV2VmRecoveryPointApplicationConsistentPropertyArgs> ApplicationConsistentProperties
        {
            get => _applicationConsistentProperties ?? (_applicationConsistentProperties = new InputList<Inputs.RecoveryPointsV2VmRecoveryPointApplicationConsistentPropertyArgs>());
        ...
        private InputList<Inputs.RecoveryPointsV2VmRecoveryPointDiskRecoveryPointArgs>? _diskRecoveryPoints;

        /// <summary>
        /// array of disk recovery points.
        /// </summary>
        public InputList<Inputs.RecoveryPointsV2VmRecoveryPointDiskRecoveryPointArgs> DiskRecoveryPoints
        {
            get => _diskRecoveryPoints ?? (_diskRecoveryPoints = new InputList<Inputs.RecoveryPointsV2VmRecoveryPointDiskRecoveryPointArgs>());
        ...
        [Input("links")]
        private InputList<Inputs.RecoveryPointsV2VmRecoveryPointLinkArgs>? _links;

        /// <summary>
        /// A HATEOAS style link for the response. Each link contains a user-friendly name identifying the link and an address for retrieving the particular resource.
        /// </summary>
        public InputList<Inputs.RecoveryPointsV2VmRecoveryPointLinkArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.RecoveryPointsV2VmRecoveryPointLinkArgs>());
            set => _links = value;
        }
        ...
        public RecoveryPointsV2VmRecoveryPointArgs()
        {
        }
        public static new RecoveryPointsV2VmRecoveryPointArgs Empty => new RecoveryPointsV2VmRecoveryPointArgs();
    }
}
