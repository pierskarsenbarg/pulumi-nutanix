...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("destSubnets")]
        private InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecDestSubnetArgs>? _destSubnets;

        /// <summary>
        /// destination subnet value
        /// </summary>
        public InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecDestSubnetArgs> DestSubnets
        {
            get => _destSubnets ?? (_destSubnets = new InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecDestSubnetArgs>());
            set => _destSubnets = value;
        }

        [Input("icmpServices")]
        private InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecIcmpServiceArgs>? _icmpServices;

        /// <summary>
        /// icmp services
        /// </summary>
        public InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecIcmpServiceArgs> IcmpServices
        {
            get => _icmpServices ?? (_icmpServices = new InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecIcmpServiceArgs>());
        ...
        [Input("srcSubnets")]
        private InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecSrcSubnetArgs>? _srcSubnets;

        /// <summary>
        /// source subnet value
        /// </summary>
        public InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecSrcSubnetArgs> SrcSubnets
        {
            get => _srcSubnets ?? (_srcSubnets = new InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecSrcSubnetArgs>());
            set => _srcSubnets = value;
        }

        [Input("tcpServices")]
        private InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecTcpServiceArgs>? _tcpServices;

        /// <summary>
        /// tcp services
        /// </summary>
        public InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecTcpServiceArgs> TcpServices
        {
            get => _tcpServices ?? (_tcpServices = new InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecTcpServiceArgs>());
            set => _tcpServices = value;
        }

        [Input("udpServices")]
        private InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecUdpServiceArgs>? _udpServices;

        /// <summary>
        /// udp services
        /// </summary>
        public InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecUdpServiceArgs> UdpServices
        {
            get => _udpServices ?? (_udpServices = new InputList<Inputs.NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecUdpServiceArgs>());
            set => _udpServices = value;
        }

        public NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecArgs()
        {
        }
        public static new NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecArgs Empty => new NetworkSecurityPolicyV2RuleSpecApplicationRuleSpecArgs();
    }
}
