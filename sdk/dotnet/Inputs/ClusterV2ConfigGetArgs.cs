...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class ClusterV2ConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("authorizedPublicKeyLists")]
        private InputList<Inputs.ClusterV2ConfigAuthorizedPublicKeyListGetArgs>? _authorizedPublicKeyLists;

        /// <summary>
        /// - (Optional) Public ssh key details. This is part of payload for cluster update operation only.
        /// </summary>
        public InputList<Inputs.ClusterV2ConfigAuthorizedPublicKeyListGetArgs> AuthorizedPublicKeyLists
        {
            get => _authorizedPublicKeyLists ?? (_authorizedPublicKeyLists = new InputList<Inputs.ClusterV2ConfigAuthorizedPublicKeyListGetArgs>());
            set => _authorizedPublicKeyLists = value;
        }

        [Input("buildInfos")]
        private InputList<Inputs.ClusterV2ConfigBuildInfoGetArgs>? _buildInfos;

        /// <summary>
        /// - (Optional) Build information details.
        /// </summary>
        public InputList<Inputs.ClusterV2ConfigBuildInfoGetArgs> BuildInfos
        {
            get => _buildInfos ?? (_buildInfos = new InputList<Inputs.ClusterV2ConfigBuildInfoGetArgs>());
        ...
        private InputList<Inputs.ClusterV2ConfigClusterSoftwareMapGetArgs>? _clusterSoftwareMaps;
        public InputList<Inputs.ClusterV2ConfigClusterSoftwareMapGetArgs> ClusterSoftwareMaps
        {
            get => _clusterSoftwareMaps ?? (_clusterSoftwareMaps = new InputList<Inputs.ClusterV2ConfigClusterSoftwareMapGetArgs>());
        ...
        private InputList<Inputs.ClusterV2ConfigFaultToleranceStateGetArgs>? _faultToleranceStates;

        /// <summary>
        /// - (Optional) Fault tolerant state of cluster.
        /// </summary>
        public InputList<Inputs.ClusterV2ConfigFaultToleranceStateGetArgs> FaultToleranceStates
        {
            get => _faultToleranceStates ?? (_faultToleranceStates = new InputList<Inputs.ClusterV2ConfigFaultToleranceStateGetArgs>());
        ...
        [Input("pulseStatuses")]
        private InputList<Inputs.ClusterV2ConfigPulseStatusGetArgs>? _pulseStatuses;

        /// <summary>
        /// - (Optional) Pulse status for a cluster. `supported only for update operations and not available during creation.`
        /// </summary>
        public InputList<Inputs.ClusterV2ConfigPulseStatusGetArgs> PulseStatuses
        {
            get => _pulseStatuses ?? (_pulseStatuses = new InputList<Inputs.ClusterV2ConfigPulseStatusGetArgs>());
        ...
        public ClusterV2ConfigGetArgs()
        {
        }
        public static new ClusterV2ConfigGetArgs Empty => new ClusterV2ConfigGetArgs();
    }
}
