...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class OvaV2VmConfigNicNetworkInfoArgs : global::Pulumi.ResourceArgs
    {
        [Input("ipv4Configs")]
        private InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4ConfigArgs>? _ipv4Configs;

        /// <summary>
        /// The IP address configurations.
        /// </summary>
        public InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4ConfigArgs> Ipv4Configs
        {
            get => _ipv4Configs ?? (_ipv4Configs = new InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4ConfigArgs>());
            set => _ipv4Configs = value;
        }

        [Input("ipv4Infos")]
        private InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4InfoArgs>? _ipv4Infos;
        public InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4InfoArgs> Ipv4Infos
        {
            get => _ipv4Infos ?? (_ipv4Infos = new InputList<Inputs.OvaV2VmConfigNicNetworkInfoIpv4InfoArgs>());
            set => _ipv4Infos = value;
        }

        [Input("networkFunctionChains")]
        private InputList<Inputs.OvaV2VmConfigNicNetworkInfoNetworkFunctionChainArgs>? _networkFunctionChains;
        ...
        /// </summary>
        public InputList<Inputs.OvaV2VmConfigNicNetworkInfoNetworkFunctionChainArgs> NetworkFunctionChains
        {
            get => _networkFunctionChains ?? (_networkFunctionChains = new InputList<Inputs.OvaV2VmConfigNicNetworkInfoNetworkFunctionChainArgs>());
        ...
        [Input("subnets")]
        private InputList<Inputs.OvaV2VmConfigNicNetworkInfoSubnetArgs>? _subnets;
        ...
        /// </summary>
        public InputList<Inputs.OvaV2VmConfigNicNetworkInfoSubnetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.OvaV2VmConfigNicNetworkInfoSubnetArgs>());
            set => _subnets = value;
        }
        ...
        public OvaV2VmConfigNicNetworkInfoArgs()
        {
        }
        public static new OvaV2VmConfigNicNetworkInfoArgs Empty => new OvaV2VmConfigNicNetworkInfoArgs();
    }
}
