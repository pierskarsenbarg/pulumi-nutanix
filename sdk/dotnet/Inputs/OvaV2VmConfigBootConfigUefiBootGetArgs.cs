...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class OvaV2VmConfigBootConfigUefiBootGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("bootDevices")]
        private InputList<Inputs.OvaV2VmConfigBootConfigUefiBootBootDeviceGetArgs>? _bootDevices;
        ...
        /// </summary>
        public InputList<Inputs.OvaV2VmConfigBootConfigUefiBootBootDeviceGetArgs> BootDevices
        {
            get => _bootDevices ?? (_bootDevices = new InputList<Inputs.OvaV2VmConfigBootConfigUefiBootBootDeviceGetArgs>());
        ...
        [Input("nvramDevices")]
        private InputList<Inputs.OvaV2VmConfigBootConfigUefiBootNvramDeviceGetArgs>? _nvramDevices;
        ...
        /// </summary>
        public InputList<Inputs.OvaV2VmConfigBootConfigUefiBootNvramDeviceGetArgs> NvramDevices
        {
            get => _nvramDevices ?? (_nvramDevices = new InputList<Inputs.OvaV2VmConfigBootConfigUefiBootNvramDeviceGetArgs>());
            set => _nvramDevices = value;
        }

        public OvaV2VmConfigBootConfigUefiBootGetArgs()
        {
        }
        public static new OvaV2VmConfigBootConfigUefiBootGetArgs Empty => new OvaV2VmConfigBootConfigUefiBootGetArgs();
    }
}
