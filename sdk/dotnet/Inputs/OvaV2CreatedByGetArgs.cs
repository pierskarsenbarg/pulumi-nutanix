...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class OvaV2CreatedByGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("additionalAttributes")]
        private InputList<Inputs.OvaV2CreatedByAdditionalAttributeGetArgs>? _additionalAttributes;

        /// <summary>
        /// -(Optional) Any additional attribute for the User.
        /// </summary>
        public InputList<Inputs.OvaV2CreatedByAdditionalAttributeGetArgs> AdditionalAttributes
        {
            get => _additionalAttributes ?? (_additionalAttributes = new InputList<Inputs.OvaV2CreatedByAdditionalAttributeGetArgs>());
        ...
        [Input("links")]
        private InputList<Inputs.OvaV2CreatedByLinkGetArgs>? _links;
        public InputList<Inputs.OvaV2CreatedByLinkGetArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.OvaV2CreatedByLinkGetArgs>());
            set => _links = value;
        }
        ...
        public OvaV2CreatedByGetArgs()
        {
        }
        public static new OvaV2CreatedByGetArgs Empty => new OvaV2CreatedByGetArgs();
    }
}
