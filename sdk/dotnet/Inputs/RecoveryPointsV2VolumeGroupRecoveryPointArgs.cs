...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class RecoveryPointsV2VolumeGroupRecoveryPointArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointDiskRecoveryPointArgs>? _diskRecoveryPoints;

        /// <summary>
        /// array of disk recovery points.
        /// </summary>
        public InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointDiskRecoveryPointArgs> DiskRecoveryPoints
        {
            get => _diskRecoveryPoints ?? (_diskRecoveryPoints = new InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointDiskRecoveryPointArgs>());
        ...
        [Input("links")]
        private InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointLinkArgs>? _links;

        /// <summary>
        /// A HATEOAS style link for the response. Each link contains a user-friendly name identifying the link and an address for retrieving the particular resource.
        /// </summary>
        public InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointLinkArgs> Links
        {
            get => _links ?? (_links = new InputList<Inputs.RecoveryPointsV2VolumeGroupRecoveryPointLinkArgs>());
            set => _links = value;
        }
        ...
        public RecoveryPointsV2VolumeGroupRecoveryPointArgs()
        {
        }
        public static new RecoveryPointsV2VolumeGroupRecoveryPointArgs Empty => new RecoveryPointsV2VolumeGroupRecoveryPointArgs();
    }
}
