...
namespace PiersKarsenbarg.Nutanix.Inputs
{
    ...
    public sealed class OvaVmDeployV2OverrideVmConfigNicNetworkInfoGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("ipv4Configs")]
        private InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4ConfigGetArgs>? _ipv4Configs;

        /// <summary>
        /// The IP address configurations.
        /// </summary>
        public InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4ConfigGetArgs> Ipv4Configs
        {
            get => _ipv4Configs ?? (_ipv4Configs = new InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4ConfigGetArgs>());
            set => _ipv4Configs = value;
        }

        [Input("ipv4Infos")]
        private InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4InfoGetArgs>? _ipv4Infos;
        public InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4InfoGetArgs> Ipv4Infos
        {
            get => _ipv4Infos ?? (_ipv4Infos = new InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoIpv4InfoGetArgs>());
            set => _ipv4Infos = value;
        }

        [Input("networkFunctionChains")]
        private InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoNetworkFunctionChainGetArgs>? _networkFunctionChains;
        ...
        /// </summary>
        public InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoNetworkFunctionChainGetArgs> NetworkFunctionChains
        {
            get => _networkFunctionChains ?? (_networkFunctionChains = new InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoNetworkFunctionChainGetArgs>());
        ...
        [Input("subnets")]
        private InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoSubnetGetArgs>? _subnets;
        ...
        /// </summary>
        public InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoSubnetGetArgs> Subnets
        {
            get => _subnets ?? (_subnets = new InputList<Inputs.OvaVmDeployV2OverrideVmConfigNicNetworkInfoSubnetGetArgs>());
            set => _subnets = value;
        }
        ...
        public OvaVmDeployV2OverrideVmConfigNicNetworkInfoGetArgs()
        {
        }
        public static new OvaVmDeployV2OverrideVmConfigNicNetworkInfoGetArgs Empty => new OvaVmDeployV2OverrideVmConfigNicNetworkInfoGetArgs();
    }
}
