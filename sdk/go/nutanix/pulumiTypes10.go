...
func (o GetVpcV2MetadataOutput) CategoryIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetVpcV2Metadata) []string { return v.CategoryIds }).(pulumi.StringArrayOutput)
}
...
func (o GetVpcsV2VpcMetadataOutput) CategoryIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetVpcsV2VpcMetadata) []string { return v.CategoryIds }).(pulumi.StringArrayOutput)
}
