...
//
// As a result, changing the `guestCustomization` block causes Terraform to destroy and recreate the `VirtualMachineV2` resource instead of performing an in-place update.
//
