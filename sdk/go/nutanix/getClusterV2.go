...
//			_, err := nutanix.GetClusterV2(ctx, &nutanix.LookupClusterV2Args{
...
func LookupClusterV2Output(ctx *pulumi.Context, args LookupClusterV2OutputArgs, opts ...pulumi.InvokeOption) LookupClusterV2ResultOutput {
	...
	return ctx.InvokeOutput("nutanix:index/getClusterV2:getClusterV2", args, LookupClusterV2ResultOutput{}, options).(LookupClusterV2ResultOutput)
}
